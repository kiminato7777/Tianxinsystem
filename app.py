...
_USAGE_INSTRUCTIONS_KM = (
    "**VoxCPM2 — របៀបបង្កើតសំឡេងចំនួន ៣៖**\n\n"
    "🎨 **ការរចនាសំឡេង (Voice Design)** — បង្កើតសំឡេងថ្មីស្រឡាង  \n"
    "មិនចាំបាច់មានសំឡេងគំរូឡើយ។ រៀបរាប់ពីលក្ខណៈសំឡេងដែលអ្នកចង់បាន "
    "(ភេទ អាយុ សម្លេង អារម្មណ៍ ល្បឿន ...) ក្នុងប្រអប់ **Control Instruction** រួច VoxCPM2 "
    "នឹងបង្កើតសំឡេងប្លែកមួយតាមការរៀបរាប់របស់អ្នក។\n\n"
    "🎛️ **ការចម្លងសំឡេងបែបបញ្ជា (Controllable Cloning)** — ចម្លងសំឡេង និងបញ្ជាស្ទីល  \n"
    "បញ្ចូលឯកសារសំឡេងគំរូ រួចប្រើ **Control Instruction** ដើម្បីបញ្ជា "
    "អារម្មណ៍ ល្បឿននិយាយ និងស្ទីលផ្សេងៗ ដោយរក្សាសំឡេងដើមនៅដដែល។\n\n"
    "🎙️ **ការចម្លងសំឡេងកម្រិតខ្ពស់ (Ultimate Cloning)** — ចម្លងសំឡេងឱ្យដូចបេះបិទបំផុត  \n"
    "បើកមុខងារ **Ultimate Cloning Mode** និងបញ្ចូលអត្ថបទនៃសំឡេងគំរូ។ "
    "ម៉ូដែលនឹងបន្តនិយាយពីសំឡេងគំរូនោះដោយរក្សាភាពដូចគ្នា ១០០%។ "
    "ចំណាំ៖ មុខងារនេះនឹងបិទ Control Instruction។"
)

_EXAMPLES_FOOTER_KM = (
    "---\n"
    "**💡 ឧទាហរណ៍នៃការពិពណ៌នាសំឡេង៖**  \n"
    "សាកល្បងប្រើការណែនាំខាងក្រោមដើម្បីស្វែងយល់ពីសំឡេងផ្សេងៗ៖  \n\n"
    "**ឧទាហរណ៍ ១ — ក្មេងស្រីទន់ភ្លន់ និងស្រងូតស្រងាត់**  \n"
    '`Control Instruction`: *"ក្មេងស្រីដែលមានសំឡេងទន់ផ្អែម។ និយាយយឺតៗ បែបស្រងូតស្រងាត់។"*  \n'
    '`Target Text`: *"ខ្ញុំមិនដែលសុំឱ្យអ្នកនៅទេ... មិនមែនថាខ្ញុំបារម្ភអីនោះដែរ។ ប៉ុន្តែ... ហេតុអ្វីបានជាវានៅតែឈឺចាប់ខ្លាំងម្ល៉េះពេលដែលអ្នកចាកចេញទៅ?"*  \n\n'
    "**ឧទាហរណ៍ ២ — បុរសវ័យក្មេងស្វាហាប់**  \n"
    '`Control Instruction`: *"សំឡេងបុរសវ័យក្មេង រឹងមាំ និយាយលឿន និងរំភើប។"*  \n'
    '`Target Text`: *"តោះ! យើងទៅជាមួយគ្នា! ថ្ងៃនេះគឺជាថ្ងៃដ៏អស្ចារ្យបំផុត!"*'
)
...
_I18N_TRANSLATIONS = {
    ...
    "km": {
        "reference_audio_label": "🎤 សំឡេងគំរូ (មិនបង្ខំ — បញ្ចូលសម្រាប់ចម្លងសំឡេង)",
        "show_prompt_text_label": "🎙️ របៀបចម្លងសំឡេងកម្រិតខ្ពស់ (Ultimate Cloning)",
        "show_prompt_text_info": "ស្វែងរកអត្ថបទសំឡេងគំរូដោយស្វ័យប្រវត្តិ។ មុខងារបញ្ជា (Control Instruction) នឹងត្រូវបិទនៅពេលប្រើមុខងារនេះ។",
        "prompt_text_label": "អត្ថបទនៃសំឡេងគំរូ (បំពេញដោយស្វ័យប្រវត្តិ អាចកែសម្រួលបាន)",
        "prompt_text_placeholder": "អត្ថបទនៃសំឡេងគំរូរបស់អ្នកនឹងបង្ហាញនៅទីនេះ...",
        "control_label": "🎛️ ការណែនាំបញ្ជា (Control Instruction - មិនបង្ខំ)",
        "control_placeholder": "ឧទាហរណ៍៖ សំឡេងក្មេងស្រីផ្អែមល្ហែម / សំឡេងបុរសរឹងមាំ / និយាយលឿនរំភើប...",
        "target_text_label": "✍️ អត្ថបទគោលដៅ — អត្ថបទដែលចង់ឱ្យនិយាយ",
        "generate_btn": "🔊 បង្កើតសំឡេង",
        "generated_audio_label": "សំឡេងដែលបានបង្កើត",
        "advanced_settings_title": "⚙️ ការកំណត់កម្រិតខ្ពស់",
        "ref_denoise_label": "បង្កើនគុណភាពសំឡេងគំរូ",
        "ref_denoise_info": "ប្រើ ZipEnhancer ដើម្បីកាត់បន្ថយសំឡេងរំខានពីសំឡេងគំរូ",
        "normalize_label": "រៀបចំអត្ថបទឱ្យមានលក្ខណៈស្តង់ដារ",
        "normalize_info": "រៀបចំលេខ កាលបរិច្ឆេទ និងពាក្យកាត់ឱ្យបានត្រឹមត្រូវ",
        "cfg_label": "កម្រិតនៃការណែនាំ (CFG)",
        "cfg_info": "ខ្ពស់ → ដូចសំឡេងគំរូខ្លាំង; ទាប → មានការប្រែប្រួលច្រើន",
        "dit_steps_label": "ចំនួនជំហាន LocDiT",
        "dit_steps_info": "ចំនួនជំហានកាន់តែច្រើន → សំឡេងកាន់តែច្បាស់ ប៉ុន្តែដំណើរការយឺត",
        "usage_instructions": _USAGE_INSTRUCTIONS_KM,
        "examples_footer": _EXAMPLES_FOOTER_KM,
    },
