...
// Firebase Storage is now exclusively utilized via storage-utils.js
const storage = null; // Replaced by centralized storage utility
...
const STUDY_TYPE_TRANSLATIONS = {
    'chinese-fulltime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä',
    'chinese-parttime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä',
    'three-languages': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà',
    'one-language': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒíß₧ùß₧╢ß₧ƒß₧╢)',
    'two-languages': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒóß₧ùß₧╢ß₧ƒß₧╢)',
    'cFullTime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä',
    'cPartTime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä',
    'chinese fulltime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä',
    'chinese parttime': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä'
};
...
function getCarrierName(phone) {
    if (!phone || phone === 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') return '';
    // Strip non-digits
...
function formatPhoneWithCarrier(phone) {
    if (!phone || phone === 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') return 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
    ...
    try {
        ...
        const teachers = staffArray
            .filter(s => {
                ...
                return name !== '' && (pos.includes('ß₧éßƒÆß₧Üß₧╝') || pos.includes('teacher') || pos === '' || pos === 'ß₧òßƒÆß₧ƒßƒüß₧äßƒù');
            })
...
const formatStudyTimeKhmer = (timeStr) => {
    if (!timeStr || ['N/A', '-', '', 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'].includes(timeStr)) return 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';

    const timeMap = {
        '7:00-9:00': 'ßƒº:ßƒáßƒá - ßƒ⌐:ßƒáßƒá ß₧ûßƒÆß₧Üß₧╣ß₧Ç',
        '9:00-11:00': 'ßƒ⌐:ßƒáßƒá - ßƒíßƒí:ßƒáßƒá ß₧ûßƒÆß₧Üß₧╣ß₧Ç',
        '13:00-15:00': 'ßƒí:ßƒáßƒá - ßƒú:ßƒáßƒá ß₧ÉßƒÆß₧äßƒâ',
        '14:00-16:00': 'ßƒó:ßƒáßƒá - ßƒñ:ßƒáßƒá ß₧ÉßƒÆß₧äßƒâ',
        '17:00-19:00': 'ßƒÑ:ßƒáßƒá - ßƒº:ßƒáßƒá ß₧Öß₧ößƒï',
        '18:00-20:00': 'ßƒª:ßƒáßƒá - ßƒ¿:ßƒáßƒá ß₧Öß₧ößƒï',
        '17:00-18:00': 'ßƒÑ:ßƒáßƒá - ßƒª:ßƒáßƒá ß₧Öß₧ößƒï',
        '18:00-19:00': 'ßƒª:ßƒáßƒá - ßƒº:ßƒáßƒá ß₧Öß₧ößƒï',
        '19:00-20:00': 'ßƒº:ßƒáßƒá - ßƒ¿:ßƒáßƒá ß₧Öß₧ößƒï'
    };
...
const isStudentChineseFullTime = (s) => {
    ...
    return type === 'cfulltime' ||
        ...
        type.includes('ß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä');
};
...
const isStudentTrilingual = (s) => {
    ...
    return type.includes('3_languages') ||
        ...
        type.includes('ßƒú ß₧ùß₧╢ß₧ƒß₧╢') ||
        type.includes('ßƒúß₧ùß₧╢ß₧ƒß₧╢') ||
        type.includes('one-language') ||
        type.includes('two-languages') ||
        type.includes('three-languages') ||
        type.includes('ßƒíß₧ùß₧╢ß₧ƒß₧╢') ||
        type.includes('ßƒóß₧ùß₧╢ß₧ƒß₧╢') ||
...
const getStudentCategoryLabel = (s) => {
    if (isStudentChineseFullTime(s)) return 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä chinese fulltime chinese-fulltime full-time chinese';
    if (isStudentTrilingual(s)) return 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà trilingual 3-languages 3 languages preschool';
    return 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä part-time chinese-parttime english-parttime part-time-total';
};
...
const getDateObject = (dateStr) => {
    if (!dateStr || ['ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', 'N/A', '', 'Completed', '01-01-100', 'undefined', 'null'].includes(dateStr)) return null;
    ...
    return studentsArray.filter(s => {
        ...
        if (currentFilters.status !== 'all') {
            ...
            if (!matches && currentFilters.status === 'delay') {
                if (['Delay', 'Postponed', 'ß₧ûß₧ôßƒÆß₧Öß₧╢'].includes(s.paymentStatus)) {
                    matches = true;
                }
            }
...
window.exportDropoutReport = (type) => {
    ...
    if (type === 'range') {
        ...
        if (!startDate || !endDate) {
            return showAlert("ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧àß₧╢ß₧ößƒïß₧òßƒÆß₧Åß₧╛ß₧ÿ ß₧ôß₧╖ß₧äß₧öß₧ëßƒÆß₧àß₧ößƒï (Please select start and end date)", 'warning');
        }

        if (startDate > endDate) {
            return showAlert("ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧àß₧╢ß₧ößƒïß₧òßƒÆß₧Åß₧╛ß₧ÿß₧ÿß₧╖ß₧ôß₧óß₧╢ß₧àß₧Æßƒåß₧çß₧╢ß₧äß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧öß₧ëßƒÆß₧àß₧ößƒïß₧æßƒü", 'warning');
        }
        ...
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢";
        subtitle = `ß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ÉßƒÆß₧äßƒâß₧æß₧╕ ${formatDate(startDate)} ß₧èß₧¢ßƒï ${formatDate(endDate)}`;

    } else if (type === 'monthly') {
        const currentYear = new Date().getFullYear();
        const promptMonth = prompt("ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧üßƒé (1-12):", new Date().getMonth() + 1);
        if (!promptMonth) return;
        const month = parseInt(promptMonth);

        const promptYear = prompt("ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧åßƒÆß₧ôß₧╢ßƒå:", currentYear);
        ...
        const khmerMonthsLocal = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧üßƒé ${khmerMonthsLocal[month - 1]} ß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
        ...
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
    }

    if (studentsToExport.length === 0) {
        return showAlert("ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ÇßƒÆß₧ôß₧╗ß₧äß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ôßƒüßƒçß₧æßƒü", 'info');
    }
...
window.exportPaidOffReport = (type) => {
    ...
    if (type === 'range') {
        ...
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï";
        subtitle = `ß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ÉßƒÆß₧äßƒâß₧æß₧╕ ${formatDate(startDate)} ß₧èß₧¢ßƒï ${formatDate(endDate)}`;
        ...
        const khmerMonthsLocal = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïß₧üßƒé ${khmerMonthsLocal[month - 1]} ß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
        ...
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
    }

    if (studentsToExport.length === 0) {
        return showAlert("ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ôßƒüßƒçß₧æßƒü", 'info');
    }
...
window.exportGraduatedReport = (type) => {
    ...
    if (type === 'range') {
        ...
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢";
        subtitle = `ß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ÉßƒÆß₧äßƒâß₧æß₧╕ ${formatDate(startDate)} ß₧èß₧¢ßƒï ${formatDate(endDate)}`;
        ...
        const khmerMonthsLocal = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧üßƒé ${khmerMonthsLocal[month - 1]} ß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
        ...
        title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
    }

    if (studentsToExport.length === 0) {
        return showAlert("ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ÇßƒÆß₧ôß₧╗ß₧äß₧àß₧ôßƒÆß₧¢ßƒäßƒçß₧ôßƒüßƒçß₧æßƒü", 'info');
    }
...
const khmerToEnglishDigits = (str) => {
    if (!str) return '';
    const khmerDigits = ['ßƒá', 'ßƒí', 'ßƒó', 'ßƒú', 'ßƒñ', 'ßƒÑ', 'ßƒª', 'ßƒº', 'ßƒ¿', 'ßƒ⌐'];
    return str.toString().replace(/[ßƒá-ßƒ⌐]/g, s => khmerDigits.indexOf(s));
};
...
/* ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧åßƒéß₧Çß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï - ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧ÇßƒÆß₧ôß₧╗ß₧ä Line 357 */
// ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧ƒß₧ÿß₧Çß₧╢ß₧¢ß₧Çß₧ÿßƒÆß₧ÿß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗ß₧Üß₧öß₧ƒßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Sync Student Financials)
...
// ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧åßƒéß₧Çß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï
const getPaymentStatus = (student) => {
    if (!student) return { text: 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', badge: 'badge-slate', status: 'pending', daysRemaining: 0 };

    // ßƒí. ß₧åßƒéß₧Çß₧Çß₧Üß₧Äß₧╕ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï (ßƒñßƒ¿ ß₧üßƒé ß₧¼ ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧òßƒÆß₧èß₧╢ß₧àßƒï)
    const isFullPaid = (parseInt(student.paymentMonths) || 0) === 48 ||
        (student.nextPaymentDate && (student.nextPaymentDate === 'Completed' || student.nextPaymentDate === '01-01-100' || student.nextPaymentDate.includes('ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï'))) ||
        (student.enrollmentStatus === 'paidOff' || student.enrollmentStatus === 'graduated');

    if (isFullPaid) {
        return { text: 'Γ£à ß₧öß₧äßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï', badge: 'badge-success', status: 'paid', daysRemaining: 0 };
    }
    ...
    if (nextDate && !['ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', ''].includes(nextDate)) {
    ...
    // ßƒó. ß₧åßƒéß₧Çß₧ÿß₧╛ß₧¢ "ß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧ûßƒüß₧¢" (Delay) ß₧çß₧╢ß₧óß₧╢ß₧æß₧╖ß₧ùß₧╢ß₧û
    if (student.paymentStatus === 'Delay' || student.paymentStatus === 'Postponed' || student.paymentStatus === 'ß₧ûß₧ôßƒÆß₧Öß₧╢' || student.paymentStatus === 'ß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧ûßƒüß₧¢') {
        return { text: 'ΓÅ│ ß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧ûßƒüß₧¢ß₧öß₧äßƒï', badge: 'badge-secondary', status: 'delay', daysRemaining: daysDiff };
    }

    // ßƒú. ß₧åßƒéß₧Çß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧Åßƒïß₧öß₧äßƒï
    if (hasValidDate) {
        // ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç
        if (daysDiff === 0) return { text: '≡ƒôà ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç', badge: 'badge-info', status: 'today', daysRemaining: 0 };
        // ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï (ß₧àß₧╢ß₧öß₧╢ßƒåß₧äß₧¢ß₧┐ß₧ä -1 ß₧àß₧╗ßƒç)
        if (daysDiff < 0) return { text: `Γ¥î ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï (${Math.abs(daysDiff)} ß₧ÉßƒÆß₧äßƒâ)`, badge: 'badge-danger', status: 'overdue', daysRemaining: daysDiff };
        // ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ (ß₧àß₧ôßƒÆß₧¢ßƒäßƒç 1 ß₧èß₧¢ßƒï 10 ß₧ÉßƒÆß₧äßƒâ)
        if (daysDiff > 0 && daysDiff <= 10) return { text: `ΓÅ│ ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ (${daysDiff} ß₧ÉßƒÆß₧äßƒâ)`, badge: 'badge-warning', status: 'warning', daysRemaining: daysDiff };
    }

    // ßƒñ. ß₧åßƒéß₧Çß₧Çß₧╢ß₧Üß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Debt / Installment / Pending) ß₧öß₧╛ß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒïß₧¢ß₧╛ß₧ƒß₧ûß₧╕ßƒíßƒáß₧ÉßƒÆß₧äßƒâ ß₧¼ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧Åßƒï
    const remaining = calculateRemainingAmount(student);
    if (remaining <= 0) return { text: 'Γ£à ß₧öß₧äßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï', badge: 'badge-success', status: 'paid', daysRemaining: daysDiff };

    const totalPaid = calculateTotalPaid(student);
    if (totalPaid > 0) {
        return { text: `ΓÜá∩╕Å ß₧çßƒåß₧ûß₧╢ß₧Çßƒï $${remaining.toFixed(2)}`, badge: 'badge-warning', status: 'installment', daysRemaining: daysDiff }; // ß₧æß₧╢ß₧ëß₧àß₧╝ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ Debt 
    }

    return { text: 'Γ¥î ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒï', badge: 'badge-danger', status: 'pending', daysRemaining: daysDiff };
};
...
const KHMER_MONTHS = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];


const convertToEnglishDate = (dateStr) => {
    if (!dateStr || ['ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', 'N/A', '', 'undefined', 'null'].includes(dateStr)) return null;

    if (typeof dateStr !== 'string') return null;

    // Standardize input
    let cleanStr = dateStr.replace(/ß₧ÉßƒÆß₧äßƒâß₧æß₧╕|ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ|ß₧ÉßƒÆß₧äßƒâ|ß₧üßƒé|ß₧åßƒÆß₧ôß₧╢ßƒå/g, ' ').replace(/\s+/g, ' ').trim();
    ...
    const KHMER_MONTHS_LOCAL = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
...
const formatKhmerMonthDate = (dateStr) => {
    if (!dateStr || ['N/A', '', 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'].includes(dateStr)) return '';
    try {
        const engDate = convertToEnglishDate(dateStr);
...
const getPaidSummaryHtml = (s) => {
        ...
        installs.forEach((inst, index) => {
            ...
            if (!isDuplicate) {
                allPayments.push({
                    date: inst.date,
                    amount: instAmt,
                    stage: inst.stage || 'ß₧öß₧äßƒïß₧öß₧ôßƒÆß₧Å',
                    months: inst.months,
    ...
    if (Object.keys(yearSummary).length === 0) return '<div class="alert alert-light text-center mt-3"><small>ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</small></div>';

    let html = `<div class="mt-4 pt-3 border-top">
        <h6 class="fw-bold small text-secondary mb-3"><i class="fi fi-rr-time-forward me-2"></i>ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Payment History)</h6>
    ...
    Object.keys(yearSummary).sort().reverse().forEach((year, idx) => {
                ...
                <h2 class="accordion-header">
                    <button class="accordion-button ${isLatest ? '' : 'collapsed'} py-2 bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#${accordionId}">
                        <div class="d-flex justify-content-between w-100 me-3">
                            <span class="fw-bold text-dark"><i class="fi fi-rr-calendar-lines me-2"></i>ß₧åßƒÆß₧ôß₧╢ßƒå ${year}</span>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm mb-0" style="font-size: 11px;">
                                <thead class="table-light">
                                    <tr>
                                        <th class="ps-2">ß₧£ß₧éßƒÆß₧é</th>
                                        <th>ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢</th>
                                        <th>ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ</th>
                                        <th>ß₧ößƒÆß₧Üß₧ùßƒüß₧æ</th>
                                        <th class="text-end">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</th>
                                        <th class="text-center">ß₧Üß₧Ößƒêß₧ûßƒüß₧¢</th>
                                        <th>ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢</th>
                                        <th class="text-center">ß₧ƒß₧Çß₧ÿßƒÆß₧ÿß₧ùß₧╢ß₧û</th>
                                    </tr>
                                </thead>
                                <tbody>`;
        ...
        yData.list.forEach(item => {
            ...
            if (!isNaN(displayStage)) displayStage = `ß₧¢ß₧╛ß₧Çß₧æß₧╕ ${displayStage}`;

            let displayType = '';
            if (isInitial) {
                if (yHasAdditional) {
                    displayType = '<span class="badge bg-info text-white" style="font-size: 10px;">ß₧öß₧äßƒïß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ô</span>';
                } else {
                    displayType = '';
                }
            } else {
                displayType = '<span class="badge bg-light text-dark border" style="font-size: 10px;">ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé</span>';
            }
            ...
            const durationVal = (item.months && item.months !== '-' && item.months != '0') ? `${item.months} ß₧üßƒé` : '-';
            ...
            html += `
                <tr class="align-middle">
                    <td class="px-2 fw-bold text-dark">${stageCellVal ? 'ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧æß₧╕ ' + stageCellVal : ''}</td>
    ...
    html += `</div>
        <div class="d-flex justify-content-between align-items-center mt-3 p-3 bg-primary bg-opacity-10 rounded-3 border border-primary border-opacity-25">
            <div>
                <div class="small text-primary fw-bold text-uppercase" style="letter-spacing: 0.5px;">ß₧ƒß₧Üß₧╗ß₧öß₧öß₧╢ß₧ôß₧öß₧äßƒï (Total Paid):</div>
                <div class="h4 mb-0 fw-bold text-primary" style="font-family: 'Poppins', sans-serif;">$${grandTotal.toFixed(2)}</div>
            </div>
            <div class="text-end">
                <div class="small text-danger fw-bold text-uppercase" style="letter-spacing: 0.5px;">ß₧ôßƒàß₧üßƒÆß₧£ßƒç (Outstanding):</div>
...
const convertToKhmerDate = (dateStr) => {
    if (!dateStr || ['ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', 'N/A', '', 'undefined', 'Completed', '01-01-100'].includes(dateStr)) {
        return dateStr === 'Completed' || dateStr === '01-01-100' ? 'ß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧àß₧ößƒï' : 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
    }
...
const formatDueDateWithColor = (student) => {
    if (!student) return '<span class="text-muted">ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô</span>';
    const status = getPaymentStatus(student);
    const dateStr = student.nextPaymentDate || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
    const khDate = convertToKhmerWordDate(dateStr);

    if (['ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', 'N/A', '', 'Completed', '01-01-100'].includes(dateStr)) {
        if (dateStr === 'Completed' || dateStr === '01-01-100') {
            ...
            return `
                <div class="due-date-premium premium-paid animate__animated animate__fadeIn" title="ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï 100%${dateDisplay ? ' ΓÇö ' + dateDisplay : ''}">
                    ...
                    <span style="font-family: 'Kantumruy Pro', sans-serif; letter-spacing: 0.3px; line-height: 1.4;">
                        ...
                        <small style="font-weight:700; font-size:0.72rem; opacity:0.85;">Γ£à ß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧àß₧ößƒï</small>
                    </span>
                </div>`;
        }
        return `<span class="text-muted small">ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô</span>`;
    }

    let premiumClass = 'premium-pending';
    let icon = 'fi-rr-calendar';
    let statusLabel = 'ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï';

    if (status.status === 'paid') {
        premiumClass = 'premium-paid';
        icon = 'fi-rr-check-circle';
        statusLabel = 'ß₧öß₧äßƒïß₧Üß₧╜ß₧à';
    } else if (status.status === 'today') {
        premiumClass = 'premium-today';
        icon = 'fi-rr-alarm-clock';
        statusLabel = 'ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç';
    } else if (status.status === 'warning') {
        premiumClass = 'premium-warning';
        icon = 'fi-rr-bell';
        statusLabel = 'ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒï';
    } else if (status.status === 'overdue') {
        premiumClass = 'premium-overdue';
        icon = 'fi-rr-triangle-warning';
        statusLabel = 'ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒïß₧öß₧äßƒï';
    }
...
const formatStudyType = (student) => {
    if (!student) return 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
    const type = student.studyType || student.courseType;
    return STUDY_TYPE_TRANSLATIONS[type] || type || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
};
...
const populateDynamicFilters = (students) => {
    const populateSelect = (elementId, attribute, defaultText, customSort) => {
        ...
        students.forEach(s => {
            ...
            if (val && !['N/A', 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', ''].includes(val)) values.add(val);
        });
    ...
    const levelSort = (a, b) => {
        const getNum = (l) => {
            if (l.includes('ß₧ÿß₧╝ß₧¢ß₧èßƒÆß₧ïß₧╢ß₧ô')) return 0;
            const m = l.match(/(\d+)/);
    ...
    populateSelect('filterTime', 'studyTime', '≡ƒöì ß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï (ß₧ÿßƒëßƒäß₧ä)', timeSort);
    populateSelect('filterLevel', 'studyLevel', '≡ƒÄô ß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï (ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å)', levelSort);
    populateSelect('filterClassTeacher', 'teacherName', '≡ƒæ¿ΓÇì≡ƒÅ½ ß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï (ß₧éßƒÆß₧Üß₧╝)');
};
...
function updateStatistics(sourceData) {
    ...
    sourceData.forEach(s => {
        ...
        if (s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' || s.gender === 'Male') {
            activeMaleCount++;
        } else if (s.gender === 'ß₧ƒßƒÆß₧Üß₧╕' || s.gender === 'Female') {
            activeFemaleCount++;
        }
        ...
        const isMale = (s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' || s.gender === 'Male');
        const isFemale = (s.gender === 'ß₧ƒßƒÆß₧Üß₧╕' || s.gender === 'Female');
    ...
    const updateCounter = (id, validCount) => {
        ...
        if (current !== validCount) {
            ...
            el.innerText = `${validCount} ß₧ôß₧╢ß₧Çßƒï`;
        }
    };
...
function renderTableData(studentsArray) {
    ...
    const maleCount = studentsArray.filter(s => s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' || (s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ')).length;
    const femaleCount = studentsArray.filter(s => s.gender === 'ß₧ƒßƒÆß₧Üß₧╕' || s.gender === 'Female').length;
    ...
    if (window.SHOW_PAID_OFF) {
        if (document.getElementById('statTotalPaidOff')) document.getElementById('statTotalPaidOff').textContent = count + ' ß₧ôß₧╢ß₧Çßƒï';
        ...
        if (document.getElementById('statTotalGraduated')) document.getElementById('statTotalGraduated').textContent = count + ' ß₧ôß₧╢ß₧Çßƒï';
    ...
    const buildRowContent = (s, i) => {
        ...
        if (key === 'graduated') {
            return `
                ...
                <td class="text-center fw-bold">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ΓÖÇ ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ΓÖÇ ß₧ƒßƒÆß₧Üß₧╕'}</td>
                ...
                <td class="text-center">
                    <div class="d-flex justify-content-center gap-1">
                        <button class="btn btn-sm btn-outline-success border-0 rounded-3 px-2 py-1" onclick="reEnrollStudent('${s.key}')" title="ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë"><i class="fi fi-rr-refresh"></i> ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë</button>
                        <button class="btn btn-sm btn-outline-danger border-0 rounded-3 px-2 py-1 delete-btn btn-premium-delete" data-key="${s.key}" data-display-id="${s.displayId}" title="ß₧¢ß₧╗ß₧ö"><i class="fi fi-rr-user-delete"></i> ß₧¢ß₧╗ß₧ö</button>
                    </div>
                </td>`;
        }
        ...
        if (key === 'paidOff') {
            return `
                ...
                <td class="text-center fw-bold" style="font-size: 0.85rem;">${s.teacherName || '-'}</td>
                <td class="text-start px-3 small text-muted">
                    <div class="fw-bold text-success">ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï ßƒíßƒáßƒá% (Paid Full)</div>
                    ${s.remark ? `<div class="mt-1 opacity-75">${s.remark}</div>` : ''}
                </td>
                <td class="text-center">
                    <div class="d-flex justify-content-center gap-1">
                        <button class="btn btn-sm btn-outline-success border-0 rounded-3 px-2 py-1" onclick="reEnrollStudent('${s.key}')" title="ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧öß₧ëßƒÆß₧çß₧╕ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧Æß₧ÿßƒÆß₧ÿß₧Åß₧╢ß₧£ß₧╖ß₧ë"><i class="fi fi-rr-refresh"></i> ß₧æß₧╢ß₧ëß₧ÅßƒÆß₧Üß₧íß₧ößƒï</button>
                        <button class="btn btn-sm btn-outline-danger border-0 rounded-3 px-2 py-1 delete-btn btn-premium-delete" data-key="${s.key}" data-display-id="${s.displayId}" title="ß₧¢ß₧╗ß₧ö"><i class="fi fi-rr-user-delete"></i> ß₧¢ß₧╗ß₧ö</button>
                    </div>
                </td>`;
        }
        ...
        return `
            ...
            <td class="text-center fw-bold" style="color: #0f172a;">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ΓÖé ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ΓÖÇ ß₧ƒßƒÆß₧Üß₧╕'}</td>
            ...
            <td class="text-center fw-bolder" style="font-family: 'Inter', sans-serif; color: #0f172a;">${s.paymentMonths || 1} <span class="text-muted fw-bold" style="font-size: 0.78rem;">ß₧üßƒé</span></td>
            ...
            <td class="text-center">
                <div class="d-flex justify-content-center gap-1">
                    ${!window.SHOW_DROPOUTS ? `<button class="btn btn-sm btn-outline-warning border-0 rounded-3 px-2 py-1 edit-btn" data-key="${s.key}" title="ß₧Çßƒéß₧ößƒÆß₧Üßƒé"><i class="fi fi-rr-edit"></i></button>` : ''}
                    ${(s.enrollmentStatus === 'dropout' || s.enrollmentStatus === 'graduated' || s.dropoutDate || s.graduatedDate) ?
                `<button class="btn btn-sm btn-outline-success border-0 rounded-3 px-2 py-1" onclick="reEnrollStudent('${s.key}')" title="ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë"><i class="fi fi-rr-refresh"></i> ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë</button>` :
                (remaining > 0 ? `<button class="btn btn-sm btn-outline-success border-0 rounded-3 px-2 py-1" onclick="showAdditionalPaymentModal('${s.key}')" title="ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï"><i class="fi fi-rr-receipt"></i></button>` : '')
            }
                    <button class="btn btn-sm btn-outline-primary border-0 rounded-3 px-2 py-1" onclick="openAddScoreModal('${s.key}')" title="ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ (Add Score)"><i class="fi fi-rr-journal-alt"></i></button>
                    <button class="btn btn-sm btn-outline-danger border-0 rounded-3 px-2 py-1 delete-btn btn-premium-delete" data-key="${s.key}" data-display-id="${s.displayId}" title="ß₧¢ß₧╗ß₧ö"><i class="fi fi-rr-user-delete"></i> ß₧¢ß₧╗ß₧ö</button>
                </div>
            </td>`;
    };
...
function initializeSpecificDataTable(tableId, key) {
    if (!$.fn.DataTable.isDataTable(tableId)) {
        dataTables[key] = $(tableId).DataTable({
            ...
            pageLength: 30,
            lengthMenu: [[10, 25, 30, 50, 100, -1], [10, 25, 30, 50, 100, "ß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï"]],
            dom: '<"row mb-3"<"col-md-12"l>>rt<"row mt-3 align-items-center"<"col-md-6"i><"col-md-6 d-flex justify-content-end"p>><"clear">',
            columnDefs: [{ orderable: false, targets: -1 }],
            order: [[1, 'desc']],
            language: {
                search: "ß₧ƒßƒÆß₧£ßƒéß₧äß₧Üß₧Ç:",
                lengthMenu: "ß₧öß₧äßƒÆß₧áß₧╢ß₧ë _MENU_ ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö",
                info: "ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ë <b>_START_</b> ß₧æßƒà <b>_END_</b> ß₧ôßƒâ <b>_TOTAL_</b> ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧Üß₧╗ß₧ö",
                infoEmpty: "ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ë 0 ß₧æßƒà 0 ß₧ôßƒâ 0 ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö",
                infoFiltered: "(ß₧àß₧ÿßƒÆß₧Üß₧╢ß₧ëßƒïß₧ûß₧╕ <b>_MAX_</b>)",
                emptyTable: '<div class="text-center text-muted py-5"><i class="fi fi-rr-database fa-3x mb-3 d-block animate__animated animate__pulse animate__infinite"></i>ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö</div>',
                zeroRecords: 'ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö',
                paginate: {
...
function renderOverdueReport(studentsArray) {
    ...
    if (reportData.length === 0) {
        container.innerHTML = '<div class="alert alert-success text-center p-5 shadow-sm rounded-3"><i class="fi fi-rr-check-circle fa-2x mb-3"></i><h4>ß₧¢ßƒÆß₧óß₧Äß₧╢ß₧ƒßƒï! ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒïß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧æßƒüßƒö</h4></div>';
        return;
    }

    // 2. Group by Section (Study Type)
    const sections = {
        'cFullTime': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä', data: [] },
        'cPartTime': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä', data: [] },
        'one-language': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒíß₧ùß₧╢ß₧ƒß₧╢)', data: [] },
        'two-languages': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒóß₧ùß₧╢ß₧ƒß₧╢)', data: [] },
        'three-languages': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà', data: [] },
        'other': { title: 'ß₧òßƒÆß₧ƒßƒüß₧äßƒù', data: [] }
    };
    ...
    data.forEach((s, idx) => {
        ...
        rows += `
            <tr class="align-middle border-bottom">
                ...
                <td class="text-center">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</td>
        ...
        <div class="card shadow-sm border-0 mb-4 animate__animated animate__fadeInUp">
            <div class="card-header bg-white border-bottom border-light py-3 px-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-3 text-secondary small fw-bold">
                    <span class="bg-light px-3 py-1 rounded-pill"><i class="fi fi-rr-users-alt me-2"></i>ß₧àßƒåß₧ôß₧╜ß₧ô: ${data.length} ß₧ôß₧╢ß₧Çßƒï</span>
                    <span class="bg-danger-subtle text-danger px-3 py-1 rounded-pill"><i class="fi fi-rr-money-bill-wave me-2"></i>ß₧ƒß₧Üß₧╗ß₧ö: $${totalAmount.toFixed(2)}</span>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0" style="font-size: 0.95rem;">
                        <thead class="bg-light text-secondary">
                            <tr>
                                <th class="text-center py-3" width="50">ß₧¢.ß₧Ü</th>
                                <th class="text-center py-3" width="100">ID</th>
                                <th class="py-3">ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                                <th class="text-center py-3" width="80">ß₧ùßƒüß₧æ</th>
                                <th class="text-center py-3">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</th>
                                <th class="text-center py-3">ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                                <th class="text-center py-3">ß₧ÉßƒÆß₧äßƒâß₧òß₧╗ß₧Åß₧Çßƒåß₧Äß₧Åßƒï</th>
                                <th class="text-center py-3">ß₧àßƒåß₧ôß₧╜ß₧ôß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</th>
                                <th class="text-center py-3">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${rows}
        ...
        <div class="card border-0 shadow-sm mb-4 bg-white" style="border-radius: 15px; overflow: hidden;">
            ...
            `<div id="mainProfilePlaceholder_${s.key}" class="rounded-circle shadow-sm border border-4 border-white bg-light d-flex align-items-center justify-content-center text-muted" style="width: 100px; height: 100px;">
                                ...
                                <div class="position-absolute bottom-0 end-0">
                                    <span class="badge rounded-circle bg-primary border border-2 border-white p-2 shadow-sm" title="ß₧ößƒÆß₧Åß₧╝ß₧Üß₧Üß₧╝ß₧öß₧Éß₧Å">
                            ...
                            ${(s.imageUrl && s.imageUrl.length > 5) ? `
                                <div class="position-absolute top-0 end-0 mt-n1 me-n1" style="z-index: 5;">
                                    <span class="badge rounded-circle bg-danger border border-2 border-white p-2 shadow-sm" style="cursor: pointer;" title="ß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧Éß₧Å" onclick="removeStudentProfileImage('${s.key}', event)">
                                ...
                                <div class="position-absolute top-0 start-0 mt-n1 ms-n1" style="z-index: 5;">
                                    <span class="badge rounded-circle bg-success border border-2 border-white p-2 shadow-sm" style="cursor: pointer;" title="ß₧æß₧╢ß₧ëß₧Öß₧Çß₧Üß₧╝ß₧öß₧Éß₧Å" onclick="downloadStudentImage('${s.imageUrl}', '${s.lastName}_${s.firstName}')">
                    ...
                    <div class="col-md ps-md-4 text-center text-md-start">
                        ...
                        <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2 mb-3">
                            ...
                            ${remaining > 0 ? `<span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 px-3 py-2 rounded-pill shadow-sm"><i class="fi fi-rr-money-bill-wave me-2"></i>ß₧ôßƒàß₧üßƒÆß₧£ßƒç: <span class="fw-black font-poppins">$${remaining.toFixed(2)}</span></span>` : '<span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-3 py-2 rounded-pill shadow-sm"><i class="fi fi-rr-check-circle me-2"></i>ß₧öß₧äßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï</span>'}
                            ${(status.status === 'installment' && (s.postponedDate || s.postponedReason)) ?
            `<span class="badge bg-warning text-dark border border-warning border-opacity-50 shadow-sm px-3 py-2 rounded-pill"><i class="fi fi-rr-calendar me-1"></i>ß₧ƒß₧ä: ${s.postponedDate || '-'}</span>` : ''}
                        </div>
                    </div>
                    ...
                    <div class="col-md-auto text-center text-md-end mt-3 mt-md-0">
                        <div class="d-flex flex-column gap-2">
                            <div class="btn-group shadow-sm">
                                <button class="btn btn-outline-primary fw-bold btn-sm px-3" onclick="showRenewModal('${s.key}')"><i class="fi fi-rr-graduation-cap me-2"></i> ß₧ößƒÆß₧Åß₧╝ß₧Üß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</button>
                                <button class="btn btn-primary fw-bold btn-sm px-3" onclick="showAdditionalPaymentModal('${s.key}')"><i class="fi fi-rr-add me-2"></i> ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ</button>
                                ${(s.enrollmentStatus || '').toLowerCase().trim() !== 'graduated' && (s.enrollmentStatus || '').toLowerCase().trim() !== 'paidoff' ?
            `<button class="btn btn-outline-success fw-bold btn-sm px-3" onclick="markAsPaidOff('${s.key}')" title="ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï"><i class="fi fi-rr-check-circle me-2"></i> ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï</button>` : ''}
                                <button class="btn btn-danger fw-bold btn-sm px-3" onclick="generatePaymentContract('${s.key}')" title="ß₧¢ß₧╖ß₧üß₧╖ß₧Åß₧ûßƒÆß₧Üß₧ÿß₧╢ß₧ô/ß₧Çß₧╖ß₧àßƒÆß₧àß₧ƒß₧ôßƒÆß₧Öß₧╢"><i class="fi fi-rr-document-signed me-2"></i> ß₧Çß₧╖ß₧àßƒÆß₧àß₧ƒß₧ôßƒÆß₧Öß₧╢</button>
                            </div>
                            <div class="btn-group shadow-sm">
                                <button class="btn btn-outline-dark btn-sm px-3" onclick="printPOSReceipt('${s.key}')"><i class="fi fi-rr-print me-2"></i> ß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü</button>
                                <button class="btn btn-warning fw-bold btn-sm px-3" onclick="createEditModal('${s.key}')"><i class="fi fi-rr-edit me-2"></i> ß₧Çßƒéß₧ößƒÆß₧Üßƒé</button>
                                ${s.enrollmentStatus !== 'graduated' ?
            `<button class="btn btn-outline-success btn-sm px-3" onclick="markAsGraduated('${s.key}')" title="ß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢"><i class="fi fi-rr-graduation-cap me-2"></i> ß₧öß₧ëßƒÆß₧àß₧ößƒï</button>` : ''
        }
            ...
            `<button class="btn btn-success btn-sm px-3" onclick="reEnrollStudent('${s.key}')"><i class="fi fi-rr-user-add me-2"></i> ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÿß₧Çß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë</button>` :
            `<button class="btn btn-outline-danger btn-sm px-3" onclick="markAsDropout('${s.key}')"><i class="fi fi-rr-user-remove me-2"></i> ß₧ößƒäßƒçß₧öß₧äßƒï</button>`
        }
                            </div>
                        </div>
                    </div>
...
function getGeneralInfoTabHTML(s, status, total, paid, remaining) {
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="card h-100 border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold text-primary mb-0"><i class="fi fi-rr-info me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧òßƒÆß₧æß₧╢ß₧¢ßƒïß₧üßƒÆß₧¢ß₧╜ß₧ô</h6>
                </div>
                <div class="card-body pt-0">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0 d-flex justify-content-between">
                            <span class="text-muted">ß₧ùßƒüß₧æ</span>
                            <span class="fw-bold">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</span>
                        </li>
                        <li class="list-group-item px-0 d-flex justify-content-between">
                            <span class="text-muted">ß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧╛ß₧Å</span>
                            <span class="fw-bold">${convertToKhmerDate(s.dob)}</span>
                        </li>
                        <li class="list-group-item px-0 d-flex justify-content-between">
                            <span class="text-muted">ß₧ƒß₧ëßƒÆß₧çß₧╢ß₧Åß₧╖</span>
                            <span class="fw-bold">${s.nationality || 'ß₧üßƒÆß₧ÿßƒéß₧Ü'}</span>
                        </li>
                        <li class="list-group-item px-0 d-flex justify-content-between">
                            <span class="text-muted">ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</span>
                            <span class="fw-bold text-primary" style="font-family: 'Poppins';">${formatPhoneWithCarrier(s.personalPhone)}</span>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="text-muted mb-1">ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ôß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ô</div>
                            <div class="fw-bold text-dark bg-light p-2 rounded small">
                                <div class="d-flex align-items-start mb-1">
                                    <i class="fi fi-rr-marker text-danger mt-1 me-2"></i>
                                    <div>
                                        ${[
            s.village ? `ß₧ùß₧╝ß₧ÿß₧╖ ${s.village}` : '',
            s.commune ? `ß₧âß₧╗ßƒå/ß₧ƒß₧äßƒÆß₧Çß₧╢ß₧Åßƒï ${s.commune}` : '',
            s.district ? `ß₧ƒßƒÆß₧Üß₧╗ß₧Ç/ß₧üß₧ÄßƒÆß₧î ${s.district}` : '',
            s.province ? `ß₧üßƒüß₧ÅßƒÆß₧Å/ß₧ÇßƒÆß₧Üß₧╗ß₧ä ${s.province}` : ''
        ].filter(Boolean).join(' - ')}
                                    </div>
                                </div>
        ...
        <div class="col-lg-6">
            <div class="card h-100 border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold text-success mb-0"><i class="fi fi-rr-book-alt me-2"></i>ß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Academic)</h6>
                </div>
                <div class="card-body pt-0">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="p-3 rounded bg-pink-primary text-white shadow-sm border border-white border-opacity-25">
                                <div class="small text-white-50 mb-1">ß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧£ß₧éßƒÆß₧éß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Course Type)</div>
                        ...
                        <div class="col-12">
                             <div class="p-3 rounded bg-light border">
                                <div class="d-flex justify-content-between align-items-center">
                                     <span class="text-muted small"><i class="fi fi-rr-calendar-plus me-2"></i>ß₧ÉßƒÆß₧äßƒâß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ô (Join Date):</span>
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded bg-success bg-opacity-10 h-100">
                                <div class="small text-muted mb-1">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Åß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</div>
                                <div class="fw-bold text-success">${s.studyLevel || 'N/A'}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded bg-info bg-opacity-10 h-100">
                                <div class="small text-muted mb-1">ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</div>
                        ...
                        <div class="col-12">
                            <div class="p-3 rounded bg-secondary bg-opacity-10 border border-secondary border-opacity-25">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <div class="small text-muted mb-1"><i class="fi fi-rr-clock-three me-2"></i>ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒéß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö (Total Duration)</div>
                                        <div class="h5 fw-bold text-dark mb-0">${s.paymentMonths || '1'} <span class="small text-muted">ß₧üßƒé (Months)</span></div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="p-3 rounded bg-light border">
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted small">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï:</span>
                                    <span class="fw-bold">${s.teacherName || 'ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧Çßƒåß₧Äß₧Åßƒï'}</span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="text-muted small">ß₧öß₧ôßƒÆß₧æß₧ößƒïß₧ÜßƒÇß₧ô:</span>
                        ...
                        <div class="col-12">
                            <div class="p-3 rounded border border-warning border-opacity-50 bg-warning bg-opacity-10 text-center">
                                <div class="small text-muted mb-2"><i class="fi fi-rr-calendar-clock me-2"></i>ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧öß₧ôßƒÆß₧æß₧╢ß₧ößƒï (Due Payment Date)</div>
            ...
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 15px; border-left: 5px solid ${status.badge.includes('danger') ? '#dc3545' : (status.badge.includes('success') ? '#28a745' : '#8a0e5b')} !important;">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold mb-0 text-dark">
                        <i class="fi fi-rr-hand-holding-usd me-2 text-primary"></i>ß₧ƒß₧äßƒÆß₧üßƒüß₧öß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Payment & Financial Summary)
                    </h6>
                    ...
                    <div class="row g-4 text-center">
                        <div class="col-md-3">
                            <div class="bg-white p-3 rounded-4 shadow-sm h-100 border border-light">
                                <div class="small text-muted mb-2">ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö (Total)</div>
                                <div class="h4 fw-black text-dark mb-0">$${total.toFixed(2)}</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-white p-3 rounded-4 shadow-sm h-100 border border-light">
                                <div class="small text-muted mb-2">ß₧öß₧äßƒïß₧Üß₧╜ß₧à (Paid)</div>
                                <div class="h4 fw-black text-success mb-0">$${paid.toFixed(2)}</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-white p-3 rounded-4 shadow-sm h-100 border border-light">
                                <div class="small text-muted mb-2">ß₧ôßƒàß₧üßƒÆß₧£ßƒç (Remaining)</div>
                                <div class="h4 fw-black text-danger mb-0">$${remaining.toFixed(2)}</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="bg-white p-3 rounded-4 shadow-sm h-100 border border-light">
                                <div class="small text-muted mb-2">ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï (Next Due)</div>
                                <div class="h4 fw-bold text-primary mb-0">${s.nextPaymentDate || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'}</div>
                                ${status.daysRemaining !== 0 ? `<small class="text-muted d-block mt-1">${status.daysRemaining < 0 ? `ß₧áß₧╜ß₧ƒ ${Math.abs(status.daysRemaining)} ß₧ÉßƒÆß₧äßƒâ` : `ß₧ôßƒàß₧ƒß₧¢ßƒï ${status.daysRemaining} ß₧ÉßƒÆß₧äßƒâ`}</small>` : ''}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 p-3 rounded-4 bg-warning bg-opacity-10 border border-warning border-opacity-20 animate__animated animate__fadeIn">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="text-start">
                                <h6 class="fw-bold mb-1 text-dark mb-0 moul-font small">ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ûß₧ôßƒÆß₧Öß₧╢ß₧ûßƒüß₧¢ß₧öß₧äßƒï (Postponement Detail)</h6>
                                <p class="text-muted small mb-0">
                                    <span class="fw-bold text-dark">ß₧ÉßƒÆß₧äßƒâß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧öß₧äßƒï:</span> ${s.postponedDate ? convertToKhmerWordDate(s.postponedDate) : 'N/A'} 
                                    ${s.postponedReason ? ` | <span class="fw-bold text-dark">ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗:</span> ${s.postponedReason}` : ''}
                                </p>
                            </div>
                        </div>
                    </div>` : ''}
        ...
        <!-- ≡ƒôé ATTACHMENTS SECTION (Dynamic Upload & Delete) -->
        <div class="col-12 mt-4">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold mb-0 text-dark">
                        <i class="fi fi-rr-clip me-2 text-primary"></i>ß₧»ß₧Çß₧ƒß₧╢ß₧Üß₧òßƒÆß₧ƒßƒüß₧äßƒù (Student Photos/Docs)
                    </h6>
                    <button class="btn btn-sm btn-outline-primary rounded-pill px-3" onclick="document.getElementById('attachUpload_${s.key}').click()">
                        <i class="fi fi-rr-upload me-2"></i>ß₧öß₧ôßƒÆß₧Éßƒéß₧ÿß₧»ß₧Çß₧ƒß₧╢ß₧Ü
                    </button>
            ...
            if (attachments.length === 0) {
                return `
                                    <div class="col-12 text-center py-4 opacity-50">
                                        ...
                                        <p class="small mb-0">ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧»ß₧Çß₧ƒß₧╢ß₧Üß₧ùßƒÆß₧çß₧╢ß₧ößƒï</p>
                                    </div>`;
            }
            return attachments.map((url, idx) => `
                                <div class="col-md-3 col-6">
                                    <div class="position-relative group shadow-sm rounded-3 overflow-hidden bg-white border" style="height: 120px;">
                                        ...
                                        <div class="position-absolute top-0 end-0 p-1">
                                            <button class="btn btn-danger btn-sm rounded-circle p-1" onclick="deleteStudentAttachment('${s.key}', ${idx})" title="ß₧¢ß₧╗ß₧öß₧àßƒäß₧¢">
                    ...
                    <div class="mt-3 small text-muted text-center">
                        <i class="fi fi-rr-info me-2"></i>ß₧Üß₧╝ß₧öß₧Éß₧Åß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧ÿß₧╢ß₧ôß₧æßƒåß₧áßƒåß₧ÿß₧╖ß₧ôß₧¢ß₧╛ß₧ƒß₧ûß₧╕ <span class="fw-bold">2MB</span> ßƒö ß₧öß₧ôßƒÆß₧æß₧╢ß₧ößƒïß₧ûß₧╕ Upload ß₧Üß₧╜ß₧à ß₧£ß₧╢ß₧ôß₧╣ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ôßƒàß₧æß₧╕ß₧ôßƒüßƒçßƒö
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm text-center" style="border-radius: 15px;">
                <div class="card-body">
                    ...
                    <h6 class="fw-bold">ß₧¬ß₧ûß₧╗ß₧Ç (Father)</h6>
                    <hr class="w-25 mx-auto my-3 text-primary opacity-25">
                    <h5 class="fw-bold text-dark mb-1" style="font-family: 'Khmer OS Muol Light'; font-size: 1rem;">${s.fatherName || 'ß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</h5>
                    <p class="text-muted small mb-3">${s.fatherJob || 'ß₧ÿß₧╗ß₧üß₧Üß₧öß₧Üß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</p>
                    
                    <div class="bg-light p-2 rounded mb-3 text-start small">
                        <div class="d-flex align-items-start">
                            <i class="fi fi-rr-marker text-muted mt-1 me-2"></i>
                            <span class="text-secondary">${s.fatherAddress || 'ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ôß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</span>
                        </div>
                    </div>

                    ${s.fatherPhone ? `<a href="tel:${s.fatherPhone}" class="btn btn-outline-primary btn-sm rounded-pill px-3"><i class="fi fi-rr-phone-call me-2"></i>${formatPhoneWithCarrier(s.fatherPhone)}</a>` : '<span class="text-muted small">ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</span>'}
                </div>
            </div>
        </div>
        <!-- Mother -->
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm text-center" style="border-radius: 15px;">
                <div class="card-body">
                    ...
                    <h6 class="fw-bold">ß₧ÿßƒÆß₧Åß₧╢ß₧Ö (Mother)</h6>
                    <hr class="w-25 mx-auto my-3 text-pink-dark opacity-25">
                    <h5 class="fw-bold text-dark mb-1" style="font-family: 'Khmer OS Muol Light'; font-size: 1rem;">${s.motherName || 'ß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</h5>
                    <p class="text-muted small mb-3">${s.motherJob || 'ß₧ÿß₧╗ß₧üß₧Üß₧öß₧Üß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</p>

                    <div class="bg-light p-2 rounded mb-3 text-start small">
                        <div class="d-flex align-items-start">
                            <i class="fi fi-rr-marker text-muted mt-1 me-2"></i>
                            <span class="text-secondary">${s.motherAddress || 'ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ôß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</span>
                        </div>
                    </div>

                    ${s.motherPhone ? `<a href="tel:${s.motherPhone}" class="btn btn-outline-pink btn-sm rounded-pill px-3" style="border-color: var(--bs-pink-primary); color: var(--bs-pink-primary);"><i class="fi fi-rr-phone-call me-2"></i>${formatPhoneWithCarrier(s.motherPhone)}</a>` : '<span class="text-muted small">ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</span>'}
                </div>
            </div>
        </div>
        <!-- Guardian -->
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm text-center" style="border-radius: 15px;">
                <div class="card-body">
                    ...
                    <h6 class="fw-bold">ß₧óß₧╢ß₧Äß₧╢ß₧ûßƒÆß₧Öß₧╢ß₧öß₧╢ß₧¢ (Guardian)</h6>
                    <hr class="w-25 mx-auto my-3 text-warning opacity-25">
                    <h5 class="fw-bold text-dark mb-1" style="font-family: 'Khmer OS Muol Light'; font-size: 1rem;">${s.guardianName || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'}</h5>
                    <p class="text-muted small mb-3">${s.guardianRelation || 'ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧çß₧╢...'}</p>
                    
                        <div class="bg-light p-2 rounded mb-3 text-start small">
                        <div class="d-flex align-items-start">
                            <i class="fi fi-rr-marker text-muted mt-1 me-2"></i>
                            <span class="text-secondary">${s.guardianAddress || 'ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ôß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</span>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm bg-primary bg-gradient text-white h-100" style="border-radius: 20px;">
                <div class="card-body position-relative overflow-hidden p-4">
                    ...
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom border-white border-opacity-25">
                        ...
                        <h5 class="fw-bold mb-0">ß₧ƒß₧äßƒÆß₧üßƒüß₧öß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗</h5>
                    </div>
                    
                    <!-- Fee Breakdown Section -->
                    <div class="mb-4">
                        <div class="small text-white-50 mb-2 text-uppercase" style="font-size: 0.7rem; letter-spacing: 0.5px;">ß₧Çß₧╢ß₧Üß₧ößƒéß₧äß₧àßƒéß₧Çß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</div>
                        <div class="d-flex justify-content-between mb-2 small">
                            <span class="opacity-90"><i class="fi fi-rr-book-alt me-2"></i>ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</span>
                            <span class="fw-bold">$${tuition.toFixed(2)}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2 small">
                            <span class="opacity-90"><i class="fi fi-rr-box-alt me-2"></i>ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê</span>
                            <span class="fw-bold">$${material.toFixed(2)}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2 small">
                            <span class="opacity-90"><i class="fi fi-rr-document me-2"></i>ß₧ÉßƒÆß₧¢ßƒâß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢</span>
                            <span class="fw-bold">$${admin.toFixed(2)}</span>
                        </div>
                        ${boarding > 0 ? `
                        <div class="d-flex justify-content-between mb-2 small">
                            <span class="opacity-90"><i class="fi fi-rr-home me-2"></i>ß₧ÉßƒÆß₧¢ßƒâß₧ƒßƒÆß₧ôß₧╢ß₧Çßƒïß₧ôßƒà</span>
                            <span class="fw-bold">$${boarding.toFixed(2)}</span>
                        </div>` : ''}
                        ${services > 0 ? `
                        <div class="d-flex justify-content-between mb-2 small">
                            <span class="opacity-90"><i class="fi fi-rr-settings me-2"></i>ß₧ƒßƒüß₧£ß₧╢ß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢ß₧òßƒÆß₧ƒßƒüß₧äßƒù</span>
                            <span class="fw-bold">$${services.toFixed(2)}</span>
                        </div>` : ''}
                        ${discount > 0 ? `
                        <div class="d-flex justify-content-between mb-2 text-warning small">
                            <span class="fw-bold"><i class="fi fi-rr-badge-percent me-2"></i>ß₧öß₧ëßƒÆß₧àß₧╗ßƒçß₧Åß₧ÿßƒÆß₧¢ßƒâ</span>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="fw-bold">ß₧ƒß₧Üß₧╗ß₧öß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï</span>
                            <span class="fs-4 fw-bold">$${total.toFixed(2)}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="fw-bold opacity-90"><i class="fi fi-rr-check-circle me-2"></i>ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧Üß₧╜ß₧à</span>
                    ...
                    <div class="bg-white bg-opacity-25 rounded-4 p-4 text-center mt-3 shadow-sm" style="backdrop-filter: blur(10px);">
                        <div class="small fw-bold mb-2 opacity-90" style="letter-spacing: 0.5px;">ß₧ôßƒàß₧üßƒÆß₧£ßƒç (BALANCE DUE)</div>
                        <div class="display-5 fw-bold text-white mb-1">$${remaining.toFixed(2)}</div>
                        ${remaining > 0 ?
            `<div class="small opacity-75 mt-2">
                                <i class="fi fi-rr-exclamation-triangle me-2"></i>
                                ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧▒ßƒÆß₧Öß₧öß₧╢ß₧ôß₧æß₧╢ß₧ôßƒïß₧ûßƒüß₧¢
                            </div>` :
            `<div class="small text-success-light mt-2">
                                <i class="fi fi-rr-badge-check me-2"></i>
                                ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧╢ß₧ôßƒï
                            </div>`
        }
                    </div>
                </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <h6 class="fw-bold mb-1 text-dark">
                                <i class="fi fi-rr-time-past me-2 text-primary"></i>ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï
                            </h6>
                            <p class="text-muted small mb-0">ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒïß₧èßƒéß₧¢ß₧öß₧╢ß₧ôß₧ÆßƒÆß₧£ß₧╛ß₧íß₧╛ß₧ä</p>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <button class="btn btn-sm btn-primary shadow-sm rounded-pill px-3" onclick="showAdditionalPaymentModal('${s.key}')">
                                <i class="fi fi-rr-plus me-2"></i>ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ
                            </button>
                            <button class="btn btn-sm btn-light border shadow-sm rounded-pill" onclick="printPaymentHistory('${s.key}')" title="ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧ûß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖">
                            ...
                            <thead class="bg-light sticky-top" style="z-index: 10;">
                                <tr class="text-secondary small">
                                    <th class="ps-4 py-3" style="font-weight: 700;">
                                        <i class="fi fi-rr-list-check me-2"></i>ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢
                                    </th>
                                    <th class="py-3" style="font-weight: 700;">
                                        <i class="fi fi-rr-calendar me-2"></i>ß₧ÉßƒÆß₧äßƒâß₧üßƒéß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï
                                    </th>
                                    <th class="py-3" style="font-weight: 700;">
                                        <i class="fi fi-rr-hourglass-end me-2"></i>ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé
                                    </th>
                                    <th class="text-end py-3" style="font-weight: 700; min-width: 120px;">
                                        <i class="fi fi-rr-usd-circle me-2"></i>ß₧ƒß₧Üß₧╗ß₧ö/ß₧öß₧╢ß₧ôß₧öß₧äßƒï/ß₧çßƒåß₧ûß₧╢ß₧Çßƒï
                                    </th>
                                    <th class="py-3" style="font-weight: 700;">
                                        <i class="fi fi-rr-user me-2"></i>ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢
                                    </th>
                                    <th class="text-end pe-4 py-3" style="font-weight: 700;">
                                        <i class="fi fi-rr-settings me-2"></i>ß₧ƒß₧Çß₧ÿßƒÆß₧ÿß₧ùß₧╢ß₧û
                                    </th>
                                </tr>
                            </thead>
        ...
        `<tr>
                                        <td colspan="7" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <p class="mb-0">ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</p>
                                                <small>ß₧àß₧╗ß₧àß₧ößƒèß₧╝ß₧Åß₧╗ß₧ä "ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ" ß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</small>
                                            </div>
                                        </td>
                                    </tr>`
        }
                ...
                <div class="card-footer bg-light border-0 py-3 px-4">
                    <div class="d-flex justify-content-between align-items-center small text-muted">
                        <span>
                            ...
                            ß₧àß₧╗ß₧àß₧¢ß₧╛ß₧ƒß₧Çß₧ÿßƒÆß₧ÿß₧ùß₧╢ß₧ûß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ ß₧Çßƒéß₧ößƒÆß₧Üßƒé ß₧¼ß₧¢ß₧╗ß₧öß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï
                        </span>
                        <span class="fw-bold text-dark">
                            ß₧ƒß₧Üß₧╗ß₧öß₧öß₧äßƒïß₧Üß₧╜ß₧à: <span class="text-success">$${paid.toFixed(2)}</span> (${totalPaymentsCount} ß₧¢ß₧╛ß₧Ç)
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="student-details-view animate__animated animate__fadeIn">
            ...
            <ul class="nav nav-pills nav-fill mb-4 p-1 bg-light rounded-pill shadow-sm" id="studentDetailsTabs" role="tablist" style="border: 1px solid #eee;">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-pill fw-bold" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-selected="true">
                        <i class="fi fi-rr-user me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧æß₧╝ß₧æßƒà
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill fw-bold" id="family-tab" data-bs-toggle="tab" data-bs-target="#family" type="button" role="tab" aria-selected="false">
                        <i class="fi fi-rr-users me-2"></i>ß₧éßƒÆß₧Üß₧╜ß₧ƒß₧╢ß₧Ü
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill fw-bold" id="finance-tab" data-bs-toggle="tab" data-bs-target="#finance" type="button" role="tab" aria-selected="false">
                        <i class="fi fi-rr-hand-holding-usd me-2"></i>ß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗
                    </button>
                </li>
                 <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill fw-bold" id="academic-tab" data-bs-toggle="tab" data-bs-target="#academic" type="button" role="tab" aria-selected="false">
                        <i class="fi fi-rr-diploma me-2"></i>ß₧¢ß₧æßƒÆß₧Æß₧òß₧¢ß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill fw-bold" id="card-tab" data-bs-toggle="tab" data-bs-target="#card" type="button" role="tab" aria-selected="false">
                        <i class="fi fi-rr-id-badge me-2"></i>ß₧Çß₧╢ß₧Åß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Student Card)
                    </button>
                </li>
                 <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill fw-bold" id="certificate-tab" data-bs-toggle="tab" data-bs-target="#certificate" type="button" role="tab" aria-selected="false">
                        <i class="fi fi-rr-diploma me-2"></i>ß₧ƒß₧ëßƒÆß₧ëß₧╢ß₧öß₧ÅßƒÆß₧Ü (Certificate)
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="studentDetailsTabContent">
                ...
                <div class="tab-pane fade" id="academic" role="tabpanel" aria-labelledby="academic-tab">
                    <div class="card h-100 border-0 shadow-sm" style="border-radius: 15px;">
                        <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                            <h6 class="fw-bold mb-0 text-dark"><i class="fi fi-rr-books me-2"></i>ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé (Monthly Scores)</h6>
                            <button class="btn btn-sm btn-primary shadow-sm" onclick="showAddScoreModal('${s.key}')">
                                <i class="fi fi-rr-plus me-2"></i> ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗
                            </button>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr class="text-secondary small">
                                            <th class="ps-4">ß₧üßƒé/ß₧åßƒÆß₧ôß₧╢ßƒå (Month/Year)</th>
                                            <th class="text-center">ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ƒß₧Üß₧╗ß₧ö (Total)</th>
                                            <th class="text-center">ß₧ÿß₧ÆßƒÆß₧Öß₧ÿß₧ùß₧╢ß₧é (Avg)</th>
                                            <th class="text-center">ß₧àßƒåß₧Äß₧╢ß₧Åßƒïß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï (Rank)</th>
                                            <th>ß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Å (Details)</th>
                                            <th class="text-end pe-4">ß₧ƒß₧Çß₧ÿßƒÆß₧ÿß₧ùß₧╢ß₧û</th>
                                        </tr>
                                    </thead>
                                    <tbody class="border-top-0">
...
window.uploadStudentAttachment = async function (key, input) {
    ...
    if (file.size > 2097152) {
        showAlert('ß₧æßƒåß₧áßƒåß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧Æßƒåß₧ûßƒüß₧Ç! ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧ÿß₧╖ß₧ôß₧▓ßƒÆß₧Öß₧¢ß₧╛ß₧ƒß₧ûß₧╕ 2MBßƒö', 'danger');
        input.value = '';
        return;
    }
    ...
    try {
        if (originalBtn) {
            originalBtn.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span>ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áßƒäßƒç...';
        ...
        showAlert('ß₧»ß₧Çß₧ƒß₧╢ß₧Üß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧öß₧äßƒÆß₧áßƒäßƒçß₧çßƒäß₧éß₧çßƒÉß₧Ö!', 'success');

    } catch (error) {
        console.error("Attachment Upload Error:", error);
        showAlert('ß₧öß₧Üß₧╢ß₧çßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧╢ß₧Üß₧öß₧äßƒÆß₧áßƒäßƒçß₧»ß₧Çß₧ƒß₧╢ß₧Ü! ' + error.message, 'danger');
    } finally {
        if (originalBtn) {
...
window.deleteStudentAttachment = async function (key, index) {
    if (!confirm('ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧Éß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧»ß₧Çß₧ƒß₧╢ß₧Üß₧ôßƒüßƒçß₧ÿßƒéß₧ôß₧æßƒü?')) return;
    ...
    try {
        ...
        // Refresh gallery UI
        refreshAttachmentGallery(key);
        showAlert('ß₧»ß₧Çß₧ƒß₧╢ß₧Üß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧¢ß₧╗ß₧öß₧àßƒüß₧ëß₧çßƒäß₧éß₧çßƒÉß₧Ö!', 'success');

    } catch (error) {
        console.error("Attachment Delete Error:", error);
        showAlert('ß₧öß₧Üß₧╢ß₧çßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧╢ß₧Üß₧¢ß₧╗ß₧öß₧»ß₧Çß₧ƒß₧╢ß₧Ü!', 'danger');
    }
};
    ...
    gallery.innerHTML = attachments.map((url, idx) => `
        <div class="col-md-3 col-6 animate__animated animate__zoomIn">
            <div class="position-relative group shadow-sm rounded-3 overflow-hidden bg-white border" style="height: 120px;">
                <img src="${url}" class="w-100 h-100 object-fit-cover cursor-pointer" onclick="window.open('${url}', '_blank')">
                <div class="position-absolute top-0 end-0 p-1">
                    <button class="btn btn-danger btn-sm rounded-circle p-1 shadow-sm" onclick="deleteStudentAttachment('${key}', ${idx})" title="ß₧¢ß₧╗ß₧öß₧àßƒäß₧¢">
                        <i class="fi fi-rr-cross-small" style="font-size: 10px;"></i>
                    </button>
                </div>
            </div>
...
window.updateStudentProfileImage = async function (key, input) {
    ...
    // 2MB Limit
    if (file.size > 2097152) {
        showAlert('ß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧Æßƒåß₧ûßƒüß₧Ç! ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧ÿß₧╖ß₧ôß₧¢ß₧╛ß₧ƒß₧ûß₧╕ 2MBßƒö', 'danger');
        input.value = '';
        return;
    }
    ...
    try {
        ...
        if (target && target.parentElement) {
            ...
            miniStatus.innerHTML = '<div class="r2-mini-spinner"></div><span>ß₧Çßƒåß₧ûß₧╗ß₧äß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç...</span>';
        ...
        if (mainImg) {
            ...
            if (headerContainer && !headerContainer.querySelector('.bg-danger')) {
                const delBtnHtml = `
                    <div class="position-absolute top-0 end-0 mt-n1 me-n1" style="z-index: 5;">
                        <span class="badge rounded-circle bg-danger border border-2 border-white p-2 shadow-sm" style="cursor: pointer;" title="ß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧Éß₧Å" onclick="removeStudentProfileImage('${key}', event)">
                            <i class="fi fi-rr-trash text-white" style="font-size: 10px;"></i>
                        </span>
                    </div>
                `;
        ...
        showAlert('ß₧ößƒÆß₧Åß₧╝ß₧Üß₧Üß₧╝ß₧öß₧Éß₧Åß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧╢ß₧ôß₧çßƒäß₧éß₧çßƒÉß₧Ö!', 'success');

    } catch (error) {
        console.error("Profile Image Update Error:", error);
        showAlert('ß₧öß₧Üß₧╢ß₧çßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧╢ß₧Üß₧ößƒÆß₧Åß₧╝ß₧Üß₧Üß₧╝ß₧öß₧Éß₧Å!', 'danger');
    } finally {
        showLoading(false);
        input.value = '';
    }
...
window.removeStudentProfileImage = async function (studentKey, event) {
    ...
    if (!confirm("ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ûß₧╖ß₧Åß₧çß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧Éß₧Åß₧ôßƒüßƒçß₧ÿßƒéß₧ôß₧æßƒü?")) return;
    ...
    try {
        ...
        showAlert("ß₧öß₧╢ß₧ôß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧Éß₧Åß₧èßƒäß₧Öß₧çßƒäß₧éß₧çßƒÉß₧Ö!", "success");

    } catch (error) {
        console.error("Γ¥î Profile removal failed:", error);
        showAlert("ß₧Çß₧╢ß₧Üß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧Éß₧Åß₧öß₧Üß₧╢ß₧çßƒÉß₧Ö!", "danger");
    }
};
...
function openEditFromDetails() {
    ...
    showLoading(true, 'ß₧Çßƒåß₧ûß₧╗ß₧äß₧ößƒÆß₧Åß₧╝ß₧Üß₧æßƒàß₧Çß₧╢ß₧ôßƒïß₧òßƒÆß₧æß₧╢ßƒåß₧äß₧Çßƒéß₧ößƒÆß₧Üßƒé...');
    ...
    return installments
        ...
        .map((inst, index) => {
            ...
            const typeLabel = isStage1 ?
                '<span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-pill px-3">ß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧ä (Initial)</span>' :
                '<span class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25 rounded-pill px-3">ß₧öß₧äßƒïß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ (Additional)</span>';
            ...
            return `
        <tr class="${rowClass}">
            <td class="ps-4 fw-bold text-secondary text-center">${stageDisplay ? 'ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧æß₧╕ ' + stageDisplay : ''}</td>
            <td>
            ...
            <td>
                <div class="fw-bold text-dark">${(inst.months !== undefined && inst.months !== '' && inst.months !== '-') ? inst.months + ' ß₧üßƒé' : '-'}</div>
                <div class="small text-muted" style="font-size: 0.75rem;">${inst.paymentMethod || 'Cash'}</div>
            </td>
            <td class="text-end">
                <div style="font-size: 1.1rem; font-weight: 900; color: #10b981;" title="ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧╢ß₧ôß₧öß₧äßƒï (Total Paid)">
                    $${paidValue.toFixed(2)}
                </div>
                <div class="small fw-bold text-muted mt-1" style="font-size: 0.75rem;">
                    ß₧ƒß₧Üß₧╗ß₧ö: <span title="ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ƒß₧Üß₧╗ß₧ö (Total Amount)">$${(parseFloat(inst.amount) || 0).toFixed(2)}</span>
                </div>
                <div class="small fw-bold text-danger" style="font-size: 0.75rem;">
                    ß₧çßƒåß₧ûß₧╢ß₧Çßƒï: <span title="ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒåß₧Äß₧╢ß₧Çßƒïß₧ôßƒàß₧ƒß₧¢ßƒï (Debt Remaining)">$${debtValue.toFixed(2)}</span>
                </div>
            </td>
            <td>
            ...
            <td class="text-end pe-4">
                <div class="btn-group shadow-sm" role="group">
                    <button class="btn btn-sm btn-white border hover-scale" onclick="reviewPayment(${reviewParam})" title="ß₧ûß₧╖ß₧ôß₧╖ß₧ÅßƒÆß₧Ö (Review)">
                         <i class="fi fi-rr-eye text-info"></i>
                    </button>
                    <button class="btn btn-sm btn-white border hover-scale" onclick="showEditInstallmentModal(${editParam})" title="ß₧Çßƒéß₧ößƒÆß₧Üßƒé (Edit)">
                        <i class="fi fi-rr-edit text-warning"></i>
                    </button>
                    <button class="btn btn-sm btn-white border hover-scale" onclick="printInstallmentReceipt(${editParam})" title="ß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü (Print)">
                        <i class="fi fi-rr-print text-secondary"></i>
                    </button>
                     <button class="btn btn-sm btn-white border hover-scale" onclick="deleteInstallment(${deleteParam})" title="ß₧¢ß₧╗ß₧ö (Delete)">
...
window.reviewPayment = (key, index) => {
    ...
    if (index === 'initial') {
        title = 'ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧ä (Initial Payment)';
        inst = {
            stage: '1',
        ...
        if (index >= 0 && index < installments.length) {
            ...
            title = `ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧æß₧╕ ${inst.stage} (Stage ${inst.stage})`;
        }
    }

    if (!inst) {
        return showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö', 'danger');
    }
    ...
    const statusText = isFullyPaid ? 'ß₧öß₧äßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï (PAID)' : 'ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï (PARTIAL)';
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 850px;">
            <div class="modal-content animate__animated animate__zoomIn animate__faster">
                ...
                <div class="ticket-left">
                    <div>
                        <div class="ticket-title">ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Åß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</div>
                    ...
                    <div class="amount-primary">
                        <div class="label">ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧╢ß₧ôß₧öß₧äßƒï (Amount Paid)</div>
                    ...
                    <button class="btn-print-receipt" onclick="printInstallmentReceipt('${key}', '${index}')">
                        <i class="fi fi-rr-print"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧ûß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü
                    </button>
                </div>
                ...
                <div class="ticket-right">
                    ...
                    <div class="section-title"><i class="fi fi-rr-file-invoice-dollar"></i> ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗</div>
                    <div class="amounts-grid">
                        <div class="receipt-row total">
                            <div class="receipt-label">ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö (Total)</div>
                            <div class="receipt-value">$${parseFloat(inst.amount || 0).toFixed(2)}</div>
                        </div>
                        <div class="receipt-row danger" style="margin-bottom: 15px;">
                            <div class="receipt-label">ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Debt)</div>
                            <div class="receipt-value">$${debtValue.toFixed(2)}</div>
                        </div>
                        <div class="receipt-row">
                            <div class="receipt-label">ß₧ƒßƒüß₧£ß₧╢ß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢</div>
                            <div class="receipt-value">$${parseFloat(inst.adminServicesFee || 0).toFixed(2)}</div>
                        </div>
                        <div class="receipt-row">
                            <div class="receipt-label">ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê</div>
                            <div class="receipt-value">$${parseFloat(inst.materialFee || 0).toFixed(2)}</div>
                        </div>
                    </div>

                    <div class="section-title"><i class="fi fi-rr-info"></i> ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ</div>
                    <div class="info-grid">
                        <div class="info-item">
                            <div class="info-item-label">ß₧ÉßƒÆß₧äßƒâß₧üßƒéß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Payment Date)</div>
                            <div class="info-item-value text-primary">${convertToKhmerDate(inst.date)}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-item-label">ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Method)</div>
                            <div class="info-item-value">${inst.paymentMethod || 'Cash'}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-item-label">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé (Months)</div>
                            <div class="info-item-value">${(inst.months !== undefined && inst.months !== '') ? inst.months + ' ß₧üßƒé' : '-'}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-item-label">ß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧üßƒé (For Month)</div>
                            <div class="info-item-value">${inst.forMonth || '-'}</div>
                        </div>
                        <div class="info-item" style="grid-column: span 2;">
                            <div class="info-item-label">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ (Receiver)</div>
                    ...
                    ${inst.note ? `
                    <div class="note-box">
                        <div class="note-label"><i class="fi fi-rr-comment-alt me-1"></i> ß₧àßƒåß₧Äß₧╢ßƒå (Note)</div>
                        <div class="note-text">${inst.note}</div>
                    </div>` : ''}

                    <!-- ≡ƒôé RECEIPT IMAGE VIEW -->
                    <div class="section-title mt-4"><i class="fi fi-rr-picture"></i> ß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü (Receipt)</div>
                    ${inst.receiptUrl ? `
                    <div class="position-relative group shadow-sm rounded-4 overflow-hidden bg-white border mt-2" style="height: 250px; cursor: pointer;" onclick="window.open('${inst.receiptUrl}', '_blank')">
                        ...
                        <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-50 text-white text-center small">
                            <i class="fi fi-rr-expand me-2"></i> ß₧àß₧╗ß₧àß₧¢ß₧╛ß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ûß₧äßƒÆß₧Üß₧╕ß₧Ç (Click to Expand)
                        </div>
                    </div>` : `
                    <div class="border-2 border-dashed border-secondary opacity-50 rounded-4 p-5 text-center mt-2 bg-white">
                        ...
                        <p class="small mb-0">ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü (No Receipt Image)</p>
                    </div>`}
        ...
        case 1: // Classic Blue
            cardInner = `
                ...
                <div class="header text-center py-3">
                    ...
                    <div class="school-name text-primary">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</div>
        ...
        case 2: // Modern Purple
            cardInner = `
                <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); height: 160px; color: white; text-align: center; padding-top: 25px; border-radius: 0 0 50% 50%;">
                    <div class="school-name text-white">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</div>
            ...
            cardInner = `
                <div class="d-flex align-items-center p-3 border-bottom">
                    ...
                    <div class="ms-3 text-start">
                        <div class="school-name fs-6 text-danger mb-0">ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</div>
                ...
                <div class="p-4 text-center">
                    ...
                    <div class="mt-4 text-start small">
                        <div class="mb-2"><span class="text-muted">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü:</span> <span class="fw-black" style="font-size: ${idSize}px;">${studentId}</span></div>
                        <div class="mb-2"><span class="text-muted">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ:</span> <span class="fw-bold">${joinDate}</span></div>
                        <div class="mb-2"><span class="text-muted">ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ:</span> <span class="fw-bold">${phone}</span></div>
                    </div>
                </div>
            `;
            break;
        ...
        case 7: // Pink School
            cardInner = `
                ...
                <div class="content p-4 text-center">
                    <div class="school-name text-danger" style="color: #8a0e5b !important;">ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖</div>
            ...
            cardInner = `
                ...
                <div class="p-4 flex-grow-1 bg-white">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            <div class="fw-bold text-dark moul-font small" style="font-size: 10px;">ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0 text-dark"><i class="fi fi-rr-settings me-2"></i>ß₧Çß₧╢ß₧Üß₧Çßƒåß₧Äß₧Åßƒïß₧Çß₧╢ß₧Å (Settings)</h6>
                </div>
                <div class="card-body">
                    <!-- Section 1: Design -->
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted mb-2"><i class="fi fi-rr-palette me-1"></i>1. ß₧Üß₧àß₧ôß₧╢ß₧ößƒÉß₧æßƒÆß₧ÿ (Design)</label>
                     ...
                     <!-- Section 2: Edit Info -->
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted mb-2"><i class="fi fi-rr-edit me-1"></i>2. ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ô (Edit Info)</label>
                        <div class="p-3 bg-light border-0 shadow-sm rounded-4">
                                ...
                                <div class="row g-2">
                                    <div class="col-8">
                                        <button class="btn btn-sm btn-outline-primary w-100 fw-bold border-2" onclick="document.getElementById('cardPhotoUpload').click()" style="border-style: dashed !important;">
                                            <i class="fi fi-rr-camera me-1"></i> ß₧ößƒÆß₧Åß₧╝ß₧Üß₧Üß₧╝ß₧ö (Change)
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-sm btn-outline-danger w-100 fw-bold border-2" onclick="removeCardPhoto('${s.key}')" title="ß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧àßƒüß₧ë (Remove Photo)">
                                            <i class="fi fi-rr-trash me-1"></i> ß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧ö
                                        </button>
                                    </div>
                                </div>
                                <input type="file" id="cardPhotoUpload" class="d-none" accept="image/*" onchange="handleCardPhotoUpload(this, '${s.key}')">
                                <div class="text-center small text-muted mt-1" style="font-size: 10px;">* ß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧ÉßƒÆß₧ÿß₧╕ß₧ôß₧╣ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ùßƒÆß₧¢ß₧╢ß₧ÿßƒù ┬╖ ß₧àß₧╗ß₧àß₧¢ß₧╗ß₧öß₧Üß₧╝ß₧ö ß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧Öß₧Ç placeholder ß₧ÅßƒÆß₧Üß₧¢ß₧ößƒï</div>
                            </div>
                            <!-- Text Info inner -->
                            <div class="row g-2">
                                <!-- ID -->
                                <div class="col-8">
                                    <div class="form-floating">
                                        ...
                                        <label for="cardEditId" class="text-muted small"><i class="fi fi-rr-id-badge me-1"></i> ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü (Student ID)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                                        ...
                                        <label for="cardEditIdSize" class="text-muted small">ß₧æßƒåß₧áßƒå px</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-8">
                                    <div class="form-floating">
                                        ...
                                        <label for="cardEditNameKh" class="text-muted small">ß₧êßƒÆß₧ÿßƒäßƒçß₧üßƒÆß₧ÿßƒéß₧Ü (Khmer Name)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                                        ...
                                        <label for="cardEditNameKhSize" class="text-muted small">ß₧æßƒåß₧áßƒå px</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-8">
                                    <div class="form-floating">
                                        ...
                                        <label for="cardEditNameCh" class="text-muted small">ß₧êßƒÆß₧ÿßƒäßƒçß₧àß₧╖ß₧ô (Chinese Name)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                                        ...
                                        <label for="cardEditNameChSize" class="text-muted small">ß₧æßƒåß₧áßƒå px</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-8">
                                    <div class="form-floating">
                                        ...
                                        <label for="cardEditPhone" class="text-muted small"><i class="fi fi-rr-phone-call me-1"></i> ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ (Phone)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                                        ...
                                        <label for="cardEditPhoneSize" class="text-muted small">ß₧æßƒåß₧áßƒå px</label>
                                    </div>
                                </div>
            ...
            return d ? d.toISOString().split('T')[0] : '';
                                        ...
                                        <label for="cardEditDate" class="text-muted small"><i class="fi fi-rr-calendar me-1"></i> ß₧ÉßƒÆß₧äßƒâß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ô (Date)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                                        ...
                                        <label for="cardEditDateSize" class="text-muted small">ß₧æßƒåß₧áßƒå px</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <label class="text-muted small fw-bold mb-2"><i class="fi fi-rr-text me-1"></i>ß₧Çßƒåß₧Äß₧Åßƒïß₧ÿßƒëß₧╝ß₧èß₧óß₧ÇßƒÆß₧ƒß₧Ü (Font Customization)</label>
                                ...
                                <div class="col-8">
                                    <div class="form-floating">
                                        <select class="form-select border-0 shadow-sm rounded-3 text-primary fw-bold" id="cardEditFontFamily" onchange="updateCardPreview('${s.key}')">
                                            <option value="">-- ß₧¢ßƒåß₧ôß₧╢ßƒåß₧èß₧╛ß₧ÿ (Default) --</option>
                                            <optgroup label="≡ƒç░≡ƒç¡ Khmer Fonts">
                                            ...
                                            <optgroup label="≡ƒç¿≡ƒç│ Chinese Fonts">
                                            ...
                                            <optgroup label="≡ƒîÉ Latin Fonts">
                                        ...
                                        <label for="cardEditFontFamily" class="text-muted small">ß₧ÿßƒëß₧╝ß₧èß₧óß₧ÇßƒÆß₧ƒß₧Ü (Font)</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-floating border-start border-3 border-light">
                            ...
                            <div class="small text-muted mt-1 mb-2" style="font-size: 10px;">* <b>Global px</b> ß₧ößƒÆß₧Üß₧╛ß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒï field ß₧Äß₧╢ß₧èßƒéß₧¢ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧£ß₧╢ß₧Öß₧æßƒåß₧áßƒåßƒö Per-field px ß₧ôßƒàß₧üß₧╢ß₧äß₧¢ß₧╛ override Global ßƒö</div>

                            <!-- Save to Database Button -->
                            <button class="btn btn-sm btn-outline-primary mt-3 w-100 fw-bold border-2" onclick="saveCardInfoToDB('${s.key}')">
                                <i class="fi fi-rr-disk me-1"></i> ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧ÇßƒÆß₧ôß₧╗ß₧äß₧öß₧ëßƒÆß₧çß₧╕ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Save Edition)
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                         <label class="form-label small fw-bold text-muted mb-2"><i class="fi fi-rr-picture me-1"></i>3. ß₧Åß₧ÿßƒÆß₧Üß₧äß₧ûß₧Äßƒîß₧Üß₧╝ß₧öß₧ùß₧╢ß₧û (Photo Filters)</label>
                         <div class="p-3 bg-light border-0 shadow-sm rounded-4">
                            <!-- Brightness -->
                            <div class="mb-3">
                                <div class="d-flex justify-content-between small text-muted mb-1 fw-bold">
                                    <span><i class="fi fi-rr-brightness me-1"></i>ß₧ûß₧ôßƒÆß₧¢ß₧║ (Brightness)</span>
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between small text-muted mb-1 fw-bold">
                                    <span><i class="fi fi-rr-contrast me-1"></i>ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Åß₧ûß₧Äßƒî (Contrast)</span>
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between small text-muted mb-1 fw-bold">
                                    <span><i class="fi fi-rr-palette me-1"></i>ß₧ûß₧Äßƒî (Color)</span>
                            ...
                            <div class="form-check form-switch mb-0" title="ß₧ößƒÆß₧Üß₧╛ß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧òßƒÆß₧æßƒâß₧üß₧╢ß₧äß₧ÇßƒÆß₧Üßƒäß₧Öß₧ûß₧Äßƒîß₧ƒ (Use for white background images)">
                                <input class="form-check-input" type="checkbox" id="check-blend" onchange="updateImageFilters('${s.key}')">
                                <label class="form-check-label small fw-bold text-muted" for="check-blend">ß₧¢ß₧╗ß₧öß₧òßƒÆß₧æßƒâß₧ûß₧Äßƒîß₧ƒ (Remove White BG)</label>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label small fw-bold text-muted mb-2"><i class="fi fi-rr-settings-sliders me-1"></i>4. ß₧Çßƒåß₧Äß₧Åßƒïß₧æßƒåß₧áßƒåß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧ûß₧Çß₧╢ß₧Å (Print Size Config)</label>
                        <div class="p-3 bg-light border-0 shadow-sm rounded-4">
                            <div class="row g-2">
                                <div class="col-6">
                                    <label for="cfgPrintWidth" class="text-muted small fw-bold mb-1">ß₧æß₧æß₧╣ß₧äß₧Çß₧╢ß₧Å (Width)</label>
                                ...
                                <div class="col-6">
                                    <label for="cfgPrintHeight" class="text-muted small fw-bold mb-1">ß₧Çß₧ÿßƒÆß₧ûß₧ƒßƒïß₧Çß₧╢ß₧Å (Height)</label>
                                    <div class="input-group input-group-sm shadow-sm rounded-3 overflow-hidden">
                            ...
                            <div class="small text-muted mt-2 lh-sm" style="font-size: 10px;">* ß₧üßƒÆß₧ôß₧╢ß₧Åß₧éß₧╖ß₧Åß₧çß₧╢ mm (ß₧ÿß₧╖ß₧¢ßƒÆß₧¢ß₧╕ß₧ÿßƒëßƒéß₧ÅßƒÆß₧Ü)ßƒö ß₧æßƒåß₧áßƒåß₧ƒßƒÆß₧Åß₧äßƒïß₧èß₧╢ß₧Üß₧éß₧║ 54mm x 86mmßƒö ß₧Çß₧╢ß₧Üß₧Çßƒåß₧Äß₧Åßƒïß₧ôß₧╣ß₧äß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧èßƒäß₧Öß₧ƒßƒÆß₧£ßƒÉß₧Öß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ßƒö</div>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-primary w-100 py-3 fw-bold rounded-4 shadow-sm mb-2" onclick="printStudentCard('${s.key}')" style="transition: all 0.2s ease;">
                        <i class="fi fi-rr-print me-2"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û / ß₧æß₧╢ß₧ëß₧Öß₧Ç (Print/Download)
                    </button>
                    <div class="text-center small text-muted mb-2">
                        * ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧æßƒåß₧áßƒåß₧ÇßƒÆß₧Üß₧èß₧╢ß₧ƒß₧▒ßƒÆß₧Öß₧öß₧╢ß₧ôß₧ÅßƒÆß₧Üß₧╣ß₧ÿß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧ôßƒàß₧ûßƒüß₧¢ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="fw-bold mb-0 text-dark"><i class="fi fi-rr-eye me-2"></i>ß₧ÿß₧╛ß₧¢ß₧éßƒåß₧Üß₧╝ (Preview)</h6>
                </div>
                <div class="card-body">
...
window.handleCardPhotoUpload = async function (input, key) {
    if (input.files && input.files[0]) {
        ...
        if (file.size > 2097152) {
            const msg = 'ß₧æßƒåß₧áßƒåß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧Æßƒåß₧ûßƒüß₧Ç! ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧ÿß₧╖ß₧ôß₧▓ßƒÆß₧Öß₧¢ß₧╛ß₧ƒß₧ûß₧╕ 2MBßƒö';
        ...
        try {
                ...
                previewArea.innerHTML = `
                    <div class="d-flex flex-column align-items-center justify-content-center h-100 py-5">
                        <div class="r2-mini-status">
                            ...
                            <span>ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áßƒäßƒç...(Uploading)</span>
                        </div>
            ...
            if (url) {
                ...
                if (typeof showAlert === 'function') {
                    showAlert('ß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧öß₧äßƒÆß₧áßƒäßƒçß₧éßƒäß₧¢ß₧èßƒà Cloudflare ß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï!', 'success');
                }
            } else {
            ...
            const msg = 'ß₧öß₧Üß₧╢ß₧çßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧╢ß₧Üß₧öß₧äßƒÆß₧áßƒäßƒçß₧Üß₧╝ß₧öß₧ùß₧╢ß₧ûß₧æßƒà Cloudflare! ' + error.message;
            if (typeof showAlert === 'function') showAlert(msg, 'danger');
            else alert(msg);
...
window.removeCardPhoto = function (key) {
    ...
    // Re-render the card ΓÇö will fall back to placeholder
    updateCardPreview(key);
};
window.saveCardInfoToDB = function (key) {
    ...
    btn.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span>ß₧Çßƒåß₧ûß₧╗ß₧äß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç...';
    btn.disabled = true;

    firebase.database().ref('students/' + key).update(updates)
        .then(() => {
            btn.innerHTML = '<i class="fi fi-rr-check-circle me-1"></i> ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Çßƒéß₧ößƒÆß₧Üßƒé!';
        ...
        .catch(err => {
            ...
            btn.innerHTML = '<i class="fi fi-rr-cross me-1"></i> ß₧öß₧Üß₧╢ß₧çßƒÉß₧Öß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧╢ß₧Üß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç';
        ...
        <div class="col-lg-4">
            <div class="card h-100 border-0 shadow-sm rounded-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted">1. ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Üß₧àß₧ôß₧╢ß₧ößƒÉß₧æßƒÆß₧ÿ (Template)</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted">2. ß₧£ß₧éßƒÆß₧éß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Course/Achievement)</label>
                        <input type="text" class="form-control" id="certCourseInput" value="${defaultCourse}" oninput="updateCertPreview('${s.key}')">
                    </div>

                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted">3. ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ (Date)</label>
                    ...
                    <button class="btn btn-primary w-100 py-3 fw-bold rounded-3 mb-2" onclick="printCertificate('${s.key}')">
                        <i class="fi fi-rr-print me-2"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û (Print)
                    </button>
                    <div class="text-center small text-muted">
                        * ß₧ƒß₧╝ß₧ÿß₧Çßƒåß₧Äß₧Åßƒïß₧æßƒåß₧áßƒåß₧ÇßƒÆß₧Üß₧èß₧╢ß₧ƒ A4 Landscape ß₧ûßƒüß₧¢ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û
                    </div>
                </div>
            </div>
        </div>
    ...
    switch (designId) {
        ...
        case 8: // Kids Achievement
            ...
            <div class="certificate-frame" style="border: 10px dashed #ff9ff3; background-color: #fff0f6;">
                 ...
                 <div style="font-size: 80px;">Γ¡É</div>
                ...
                <div style="margin: 20px; border: 2px solid #333; height: calc(100% - 40px); display: flex; flex-direction: column; justify-content: center; position: relative;">
                    ...
                    <div style="z-index: 2;">
                        ...
                        <div class="mt-5 text-muted small">
                            ${dateFormatted} ΓÇó TIAN XIN INTERNATIONAL SCHOOL
                        </div>
                    </div>
                </div>
            </div>`;
...
function createEditModal(key) {
    const student = allStudentsData[key];
    if (!student) return showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æßƒü', 'danger');
                ...
                <div class="modal-content border-0 shadow-2xl overflow-hidden" style="border-radius: 24px; background: rgba(255, 255, 255, 0.98);">
                    <div class="modal-header p-4 border-0 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #f1c40f 0%, #f39c12 100%);">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="modal-title fw-bold text-white mb-0">ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Åß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</h5>
                                <div class="text-white text-opacity-75 small">Edit Student Details ΓÇó ID: ${student.displayId || 'NEW'}</div>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-3">
                             <div class="badge bg-white bg-opacity-25 text-white px-3 py-2 rounded-pill border border-white border-opacity-30">
                                <i class="fi fi-rr-time-past me-1"></i> ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧ÆßƒÆß₧£ß₧╛ß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ôß₧ùß₧╢ß₧û: ${student.updatedAt ? convertToKhmerDate(student.updatedAt) : 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'}
                            </div>
                                ...
                                <ul class="nav nav-pills nav-fill gap-2" id="editStudentTabs" role="tablist">
                                    <li class="nav-item">
                                        <button class="nav-link fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2" id="edit-personal-tab" data-bs-toggle="tab" data-bs-target="#edit-personal" type="button" role="tab">
                                            <i class="fi fi-rr-user small"></i><span>ß₧òßƒÆß₧æß₧╢ß₧¢ßƒïß₧üßƒÆß₧¢ß₧╜ß₧ô</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2" id="edit-academic-tab" data-bs-toggle="tab" data-bs-target="#edit-academic" type="button" role="tab">
                                            <i class="fi fi-rr-graduation-cap small"></i><span>ß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link active fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2 bg-white text-primary shadow-sm" id="edit-financial-tab" data-bs-toggle="tab" data-bs-target="#edit-financial" type="button" role="tab">
                                            <i class="fi fi-rr-settings-sliders small"></i><span>ß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2" id="edit-family-tab" data-bs-toggle="tab" data-bs-target="#edit-family" type="button" role="tab">
                                            <i class="fi fi-rr-users-alt small"></i><span>ß₧éßƒÆß₧Üß₧╜ß₧ƒß₧╢ß₧Ü</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2" id="edit-other-tab" data-bs-toggle="tab" data-bs-target="#edit-other" type="button" role="tab">
                                            <i class="fi fi-rr-menu-dots small"></i><span>ß₧òßƒÆß₧ƒßƒüß₧äßƒù</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link fw-bold py-2 rounded-4 border-0 transition-all d-flex align-items-center justify-content-center gap-2" id="edit-scores-tab" data-bs-toggle="tab" data-bs-target="#edit-scores" type="button" role="tab" onclick="loadStudentScoreHistory('${key}')">
                                            <i class="fi fi-rr-stats small"></i><span>ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗</span>
                                        </button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link rounded-pill fw-bold" id="card-tab" data-bs-toggle="tab" data-bs-target="#card" type="button" role="tab" aria-selected="false">
                        ...
                        <div class="px-4 pb-3">
                            <div class="card border-0 shadow-sm bg-white p-3 d-flex flex-row align-items-center justify-content-between flex-wrap gap-3" style="border-radius: 18px; border-left: 4px solid #f1c40f !important;">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="small text-muted mb-0">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ô</div>
                        ...
                        <form id="editStudentForm" class="p-4" oninput="calculateEditFormTotals()">
                            ...
                            <div class="tab-content" id="editStudentTabContent">
                                ...
                                <div class="tab-pane fade" id="edit-scores" role="tabpanel">
                                    <div class="card border-0 rounded-4 shadow-sm p-4">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <h6 class="fw-bold text-dark moul-font mb-0"><i class="fi fi-rr-stats me-2 text-primary"></i>ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé (Monthly Score History)</h6>
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-sm btn-dark rounded-pill px-3 fw-bold shadow-sm" onclick="openAddScoreModal('${key}')">
                                                    <i class="fi fi-rr-plus-small me-1"></i> ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ÉßƒÆß₧ÿß₧╕ (Add Score)
                                                </button>
                                        ...
                                        <div id="edit-scores-container" class="animate__animated animate__fadeIn">
                                            ...
                                            <div class="text-center py-5">
                                                ...
                                                <p class="mt-2 text-muted">ß₧Çßƒåß₧ûß₧╗ß₧äß₧æß₧╢ß₧ëß₧Öß₧Çß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            ...
                                                            <label class="fw-bold text-danger">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü (ID)</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <select class="form-select border-0 bg-light fw-bold" name="enrollmentStatus">
                                                                <option value="active" ${student.enrollmentStatus === 'active' || student.status === 'active' || !student.enrollmentStatus ? 'selected' : ''}>ß₧ƒß₧Çß₧ÿßƒÆß₧ÿ (Active)</option>
                                                                <option value="dropout" ${student.enrollmentStatus === 'dropout' || student.status === 'dropout' ? 'selected' : ''}>ß₧ößƒäßƒçß₧öß₧äßƒï (Dropout)</option>
                                                                <option value="paidoff" ${student.enrollmentStatus === 'paidoff' || student.status === 'paidoff' ? 'selected' : ''}>ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï (Paid Off)</option>
                                                                <option value="graduate" ${student.enrollmentStatus === 'graduate' || student.status === 'graduate' ? 'selected' : ''}>ß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Graduate)</option>
                                                            </select>
                                                            <label class="fw-bold">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <select class="form-select border-0 bg-light fw-bold" name="gender">
                                                                <option value="Male" ${student.gender === 'Male' || student.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' ? 'selected' : ''}>ß₧ößƒÆß₧Üß₧╗ß₧ƒ (Male)</option>
                                                                <option value="Female" ${student.gender === 'Female' || student.gender === 'ß₧ƒßƒÆß₧Üß₧╕' ? 'selected' : ''}>ß₧ƒßƒÆß₧Üß₧╕ (Female)</option>
                                                            </select>
                                                            <label class="fw-bold">ß₧ùßƒüß₧æ</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            ...
                                                            <label class="fw-bold">ß₧ôß₧╢ß₧ÿß₧ÅßƒÆß₧Üß₧Çß₧╝ß₧¢ (KH)</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            ...
                                                            <label class="fw-bold">ß₧êßƒÆß₧ÿßƒäßƒç (KH)</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control border-0 bg-light" name="dob" value="${(student.dob && student.dob !== 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') ? convertToKhmerDate(student.dob) : ''}" placeholder="DD/MM/YYYY">
                                                            <label>ß₧ÉßƒÆß₧äßƒâß₧üßƒéß₧åßƒÆß₧ôß₧╢ßƒåß₧Çßƒåß₧Äß₧╛ß₧Å</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control border-0 bg-light" name="nationality" value="${student.nationality || 'ß₧üßƒÆß₧ÿßƒéß₧Ü'}" placeholder="Nationality">
                                                            <label>ß₧ƒß₧ëßƒÆß₧çß₧╢ß₧Åß₧╖</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-floating">
                                                            ...
                                                            <label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="card border-0 rounded-4 shadow-sm p-3">
                                                <h6 class="fw-bold mb-3 d-flex align-items-center gap-2"><i class="fi fi-rr-marker text-warning"></i> ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ô (Address)</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-3"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="village" value="${student.village || ''}"><label>ß₧ùß₧╝ß₧ÿß₧╖</label></div></div>
                                                    <div class="col-md-3"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="commune" value="${student.commune || ''}"><label>ß₧âß₧╗ßƒå/ß₧ƒß₧äßƒÆß₧Çß₧╢ß₧Åßƒï</label></div></div>
                                                    <div class="col-md-3"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="district" value="${student.district || ''}"><label>ß₧ƒßƒÆß₧Üß₧╗ß₧Ç/ß₧üß₧ÄßƒÆß₧î</label></div></div>
                                                    <div class="col-md-3"><div class="form-floating">
                                                        <select class="form-select border-0 bg-light" name="province">
                                                            <option value="">ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧üßƒüß₧ÅßƒÆß₧Å...</option>
                                                            ${['ß₧Üß₧╢ß₧çß₧Æß₧╢ß₧ôß₧╕ß₧ùßƒÆß₧ôßƒåß₧ûßƒüß₧ë', 'ß₧Çß₧ÄßƒÆß₧Åß₧╢ß₧¢', 'ß₧Çßƒåß₧ûß₧äßƒïß₧àß₧╢ß₧ÿ', 'ß₧ÅßƒÆß₧öß₧╝ß₧äß₧âßƒÆß₧ÿß₧╗ßƒå', 'ß₧ƒßƒÇß₧ÿß₧Üß₧╢ß₧ö', 'ß₧öß₧╢ß₧Åßƒïß₧èßƒåß₧öß₧ä', 'ß₧öß₧ôßƒÆß₧æß₧╢ß₧Öß₧ÿß₧╢ß₧ôß₧çßƒÉß₧Ö', 'ß₧ûßƒÆß₧Üßƒçß₧ƒß₧╕ß₧áß₧ôß₧╗', 'ß₧Çßƒåß₧ûß₧Å', 'ß₧Åß₧╢ß₧Çßƒéß₧£', 'ß₧ûßƒÆß₧Üßƒâß₧£ßƒéß₧ä', 'ß₧ƒßƒÆß₧£ß₧╢ß₧Öß₧ÜßƒÇß₧ä', 'ß₧ûßƒäß₧Æß₧╖ßƒìß₧ƒß₧╢ß₧Åßƒï', 'ß₧Çßƒåß₧ûß₧äßƒïß₧ƒßƒÆß₧ûß₧║', 'ß₧Çßƒåß₧ûß₧äßƒïß₧Æßƒå', 'ß₧Çßƒåß₧ûß₧äßƒïß₧åßƒÆß₧ôß₧╢ßƒåß₧ä', 'ß₧ÿß₧ÄßƒÆß₧îß₧¢ß₧éß₧╖ß₧Üß₧╕', 'ß₧Üß₧Åß₧ôß₧éß₧╖ß₧Üß₧╕', 'ß₧ƒßƒÆß₧æß₧╣ß₧äß₧ÅßƒÆß₧Üßƒéß₧ä', 'ß₧ûßƒÆß₧Üßƒçß₧£ß₧╖ß₧áß₧╢ß₧Ü', 'ß₧ÇßƒÆß₧Üß₧àßƒüßƒç', 'ß₧ºß₧ÅßƒÆß₧Åß₧Üß₧ÿß₧╢ß₧ôß₧çßƒÉß₧Ö', 'ß₧Çßƒéß₧ö', 'ß₧ößƒëßƒâß₧¢ß₧╖ß₧ô', 'ß₧Çßƒäßƒçß₧Çß₧╗ß₧ä'].map(p => `<option value="${p}" ${student.province === p ? 'selected' : ''}>${p}</option>`).join('')}
                                                        </select>
                                                        <label>ß₧üßƒüß₧ÅßƒÆß₧Å/ß₧ÇßƒÆß₧Üß₧╗ß₧ä</label>
                                                    </div></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border-0 rounded-4 shadow-sm h-100 overflow-hidden">
                                                <div class="card-header bg-primary bg-opacity-10 border-0 py-3">
                                                    <h6 class="fw-bold mb-0 text-primary"><i class="fi fi-rr-user-md me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï (Teacher Info)</h6>
                                                </div>
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <div class="form-floating">
                                                                <select class="form-select border-0 bg-light fw-bold" name="teacherName" id="edit_teacherName">
                                                                    <option value="">ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧éßƒÆß₧Üß₧╝...</option>
                                                                ...
                                                                <label class="fw-bold">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-floating">
                                                                ...
                                                                <label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æß₧éßƒÆß₧Üß₧╝</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border-0 rounded-4 shadow-sm h-100 overflow-hidden">
                                                <div class="card-header bg-success bg-opacity-10 border-0 py-3">
                                                    <h6 class="fw-bold mb-0 text-success"><i class="fi fi-rr-school me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Class Info)</h6>
                                                </div>
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                <select class="form-select border-0 bg-light" name="studyLevel">
                                                                    <option value="">ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒ...</option>
                                                                    ${(window.allMasterLevels || []).map(l => `<option value="${l}" ${student.studyLevel === l ? 'selected' : ''}>${l}</option>`).join('')}
                                                                </select>
                                                                <label class="fw-bold">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Åß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Level)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                ...
                                                                <label class="fw-bold">ß₧öß₧ôßƒÆß₧æß₧ößƒï (Select Room)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-floating">
                                                                ...
                                                                <label>ß₧öß₧ôßƒÆß₧æß₧ößƒïß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Classroom)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                ...
                                                                <label class="fw-bold">ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Study Time)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                ...
                                                                <label>ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ (Manual Time)</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="card border-0 rounded-4 shadow-sm overflow-hidden">
                                                <div class="card-header bg-info bg-opacity-10 border-0 py-3">
                                                    <h6 class="fw-bold mb-0 text-info"><i class="fi fi-rr-book-alt me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧Çß₧ÿßƒÆß₧ÿß₧£ß₧╖ß₧Æß₧╕ß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Program Details)</h6>
                                                </div>
                                                <div class="card-body p-4">
                                                    <div class="row g-3">
                                                        <div class="col-md-3">
                                                            <div class="form-floating">
                                                                ...
                                                                <label class="fw-bold">ß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧£ß₧éßƒÆß₧éß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-floating">
                                                                ...
                                                                <label>ß₧Çß₧ÿßƒÆß₧ÿß₧£ß₧╖ß₧Æß₧╕ß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Program)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-floating">
                                                                <select class="form-select border-0 bg-light" name="bakdoub">
                                                                    <option value="">ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒ...</option>
                                                                    <option value="ß₧çß₧╢ß₧ößƒï" ${student.bakdoub === 'ß₧çß₧╢ß₧ößƒï' ? 'selected' : ''}>ß₧çß₧╢ß₧ößƒï</option>
                                                                    <option value="ß₧ÆßƒÆß₧¢ß₧╢ß₧Çßƒï" ${student.bakdoub === 'ß₧ÆßƒÆß₧¢ß₧╢ß₧Çßƒï' ? 'selected' : ''}>ß₧ÆßƒÆß₧¢ß₧╢ß₧Çßƒï</option>
                                                                </select>
                                                                <label>ß₧öß₧╢ß₧Çßƒïß₧îß₧╗ß₧ö</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 d-flex align-items-center">
                                                            <div class="form-check form-switch ms-3">
                                                                ...
                                                                <label class="form-check-label fw-bold" for="edit_isOldStudent">ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╢ß₧ƒßƒï</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="grade" value="${student.grade || ''}"><label>ß₧ÜßƒÇß₧ôß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧æß₧╕</label></div></div>
                                                        
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control border-0 bg-light" name="subject" value="${student.subject || ''}" placeholder="Subject" />
                                                                <label>ß₧ÿß₧╗ß₧üß₧£ß₧╖ß₧çßƒÆß₧çß₧╢ (Subject)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                ...
                                                                <label>ß₧ùß₧╢ß₧ƒß₧╢ß₧èßƒéß₧¢ß₧öß₧╢ß₧ôß₧ÜßƒÇß₧ô (Languages Learnt)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control border-0 bg-light" name="stayWith" value="${student.stayWith || ''}" placeholder="Stay With" />
                                                                <label>ß₧ƒßƒÆß₧ôß₧╢ß₧Çßƒïß₧ôßƒàß₧çß₧╢ß₧ÿß₧╜ß₧Ö (Stay With)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control border-0 bg-light fw-bold text-primary" name="startDate" id="edit_startDate" value="${(student.startDate && student.startDate !== 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') ? convertToKhmerDate(student.startDate) : ''}" onchange="handleDateLogicChange()" placeholder="DD/MM/YYYY" />
                                                                <label class="text-primary fw-bold">ß₧ÉßƒÆß₧äßƒâß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ô (Start Date)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                ...
                                                                <label class="text-primary fw-bold">ß₧öß₧äßƒïß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧Üß₧Ößƒêß₧ûßƒüß₧¢ (Months)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-floating">
                                                                <input type="text" class="form-control border-0 bg-danger bg-opacity-10 fw-bold text-danger" name="nextPaymentDate" id="edit_nextPaymentDate" value="${(student.nextPaymentDate && student.nextPaymentDate !== 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') ? convertToKhmerDate(student.nextPaymentDate) : (student.paymentDueDate ? convertToKhmerDate(student.paymentDueDate) : '')}" placeholder="DD/MM/YYYY" />
                                                                <label class="text-danger fw-bold">ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧öß₧ôßƒÆß₧æß₧╢ß₧ößƒï (Due Date)</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden bg-white border-start border-primary border-4">
                                                    <div class="card-body p-4">
                                                        <h6 class="fw-bold mb-4 text-dark moul-font small"><i class="fi fi-rr-book-alt me-2 text-primary"></i>ßƒí. ß₧Çßƒåß₧Äß₧Åßƒïß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Tuition Fee)</h6>
                                                        <div class="row g-3">
                                                            <div class="col-12">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Tuition Fee $)</label>
                                                            ...
                                                            <div class="col-6">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧öß₧ëßƒÆß₧àß₧╗ßƒçß₧Åß₧ÿßƒÆß₧¢ßƒâ (%)</label>
                                                                <div class="input-group shadow-sm rounded-3 overflow-hidden border-0 bg-light">
                                                            ...
                                                            <div class="col-12 mt-4 pt-2 border-top border-light">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <span class="small fw-bold text-muted moul-font very-small">ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö (NET FEE):</span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden bg-white border-start border-success border-4">
                                                    <div class="card-body p-4">
                                                        <h6 class="fw-bold mb-4 text-dark moul-font small"><i class="fi fi-rr-box me-2 text-success"></i>ßƒó. ß₧ÉßƒÆß₧¢ßƒâß₧ƒßƒüß₧£ß₧╢ß₧Çß₧ÿßƒÆß₧ÿ (Additional Services)</h6>
                                                        <div class="row g-3">
                                                            <div class="col-6">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê ($)</label>
                                                            ...
                                                            <div class="col-6">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧ÉßƒÆß₧¢ßƒâß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢ ($)</label>
                                                            ...
                                                            <div class="col-6">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧ÉßƒÆß₧¢ßƒâß₧ƒßƒÆß₧ôß₧╢ß₧Çßƒïß₧ôßƒà ($)</label>
                                                            ...
                                                            <div class="col-6">
                                                                <label class="form-label very-small fw-bold text-muted text-uppercase ls-1">ß₧ƒßƒüß₧£ß₧╢ß₧Çß₧ÿßƒÆß₧ÿß₧òßƒÆß₧ƒßƒüß₧äßƒù ($)</label>
                                                            ...
                                                            <div class="col-12 mt-3 p-3 bg-light rounded-4">
                                                                <div class="text-center mb-2"><span class="badge bg-white text-muted px-3 border fw-bold very-small moul-font">ß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Åß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê (Breakdown)</span></div>
                                                                <div class="d-flex justify-content-between align-items-center gap-1 text-center">
                                                                    <div class="flex-grow-1"><small class="very-small text-muted opacity-75 fw-bold">ß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç</small><input type="number" step="0.1" class="form-control form-control-sm border-0 bg-white shadow-sm p-1 text-center fw-bold small" name="registrationFee" value="${student.registrationFee || 0}" oninput="syncMaterialFees()"></div>
                                                                    <div class="flex-grow-1"><small class="very-small text-muted opacity-75 fw-bold">ß₧»ß₧Çß₧ƒß₧ÄßƒÆß₧ïß₧╢ß₧ô</small><input type="number" step="0.1" class="form-control form-control-sm border-0 bg-white shadow-sm p-1 text-center fw-bold small" name="uniformFee" value="${student.uniformFee || 0}" oninput="syncMaterialFees()"></div>
                                                                    <div class="flex-grow-1"><small class="very-small text-muted opacity-75 fw-bold">ß₧Çß₧╢ß₧Å</small><input type="number" step="0.1" class="form-control form-control-sm border-0 bg-white shadow-sm p-1 text-center fw-bold small" name="idCardFee" value="${student.idCardFee || 0}" oninput="syncMaterialFees()"></div>
                                                                    <div class="flex-grow-1"><small class="very-small text-muted opacity-75 fw-bold">ß₧ƒßƒÇß₧£ß₧ùßƒà</small><input type="number" step="0.1" class="form-control form-control-sm border-0 bg-white shadow-sm p-1 text-center fw-bold small" name="bookFee" value="${student.bookFee || 0}" oninput="syncMaterialFees()"></div>
                                                                    <div class="flex-grow-1"><small class="very-small text-muted opacity-75 fw-bold">ß₧ƒßƒÇß₧£ß₧ùßƒàß₧Æßƒå</small><input type="number" step="0.1" class="form-control form-control-sm border-0 bg-white shadow-sm p-1 text-center fw-bold small" name="fulltimeBookFee" value="${student.fulltimeBookFee || 0}" oninput="syncMaterialFees()"></div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 mt-3">
                                                                <div class="p-3 bg-white border border-warning border-opacity-25 rounded-4 shadow-sm">
                                                                    <div class="row g-3 align-items-center">
                                                                        <div class="col-md-6">
                                                                            <label class="form-label very-small fw-bold text-muted text-uppercase mb-1">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Payment Status)</label>
                                                                            <select class="form-select border-0 bg-light fw-bold" name="paymentStatus" onchange="const pd = document.getElementById('postponedDateContainer'); if(this.value === 'Delay' || this.value === 'Installment') { pd.style.display = 'block'; } else { pd.style.display = 'none'; const inputs = pd.querySelectorAll('input'); inputs.forEach(i => i.value = ''); } calculateEditFormTotals();">
                                                                                <option value="Paid" ${student.paymentStatus === 'Paid' ? 'selected' : ''}>ß₧öß₧äßƒïß₧Üß₧╜ß₧à (Paid)</option>
                                                                                <option value="Pending" ${student.paymentStatus === 'Pending' ? 'selected' : ''}>ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒï (Pending)</option>
                                                                                <option value="Installment" ${student.paymentStatus === 'Installment' ? 'selected' : ''}>ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Installment)</option>
                                                                                <option value="Delay" ${student.paymentStatus === 'Delay' ? 'selected' : ''}>ß₧ûß₧ôßƒÆß₧Öß₧╢ (Delay)</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-md-12 mt-2" id="postponedDateContainer" style="display: ${['Delay', 'Installment'].includes(student.paymentStatus) ? 'block' : 'none'};">
                                                                            <div class="row g-2">
                                                                                <div class="col-md-5">
                                                                                    <label class="form-label very-small fw-bold text-warning text-uppercase mb-1">ß₧ÉßƒÆß₧äßƒâß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧öß₧äßƒï (Date)</label>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-text border-0 bg-warning bg-opacity-10 text-warning"><i class="fi fi-rr-calendar-clock"></i></span>
                                                                                        <input type="text" class="form-control border-0 bg-light fw-bold t-warning" name="postponedDate" value="${(student.postponedDate && student.postponedDate !== 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') ? convertToKhmerDate(student.postponedDate) : ''}" placeholder="DD/MM/YYYY">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-7">
                                                                                    <label class="form-label very-small fw-bold text-warning text-uppercase mb-1">ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ (Reason)</label>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-text border-0 bg-warning bg-opacity-10 text-warning"><i class="fi fi-rr-info"></i></span>
                                                                                        <input type="text" class="form-control border-0 bg-light fw-bold t-warning" name="postponedReason" value="${student.postponedReason || ''}" placeholder="ß₧öß₧ôßƒÆß₧Éßƒéß₧ÿß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ß₧ôßƒâß₧Çß₧╢ß₧Üß₧çßƒåß₧ûß₧╢ß₧Çßƒï/ß₧ûß₧ôßƒÆß₧Öß₧╢...">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-8">
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <div>
                                                            <h6 class="fw-bold mb-1 moul-font small">ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧öß₧╝ß₧ä (Initial Payment)</h6>
                                                            <p class="text-muted small mb-0 opacity-75">ß₧àßƒåß₧Äßƒéß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒéß₧¢ß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧äß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧Çß₧╢ß₧Üß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç (Admin Only)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                        ...
                                        <div class="card border-0 shadow-lg rounded-5 overflow-hidden border-start border-warning border-5 mt-4 glass-panel">
                                            <div class="card-header bg-white border-0 py-4 px-4 d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h5 class="fw-bold mb-0 moul-font small text-dark"><i class="fi fi-rr-time-forward me-2 fs-6"></i>ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Installment Ledger)</h5>
                                                        <p class="text-muted small mb-0 opacity-75">ß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧äß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ ß₧ôß₧╖ß₧ä ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧Üß₧öß₧ƒßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</p>
                                                    </div>
                                                </div>
                                                <button type="button" class="btn btn-warning rounded-pill px-4 py-2 fw-black shadow-sm hover-scale transition-all" onclick="addInstallmentRow()">
                                                    <i class="fi fi-rr-plus-small fs-4 me-1"></i> ß₧öß₧ôßƒÆß₧Éßƒéß₧ÿß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï
                                                </button>
                                            </div>
                                                ...
                                                <table class="table table-hover align-middle mb-0 border-0">
                                                    <thead class="bg-light border-bottom border-warning border-opacity-10 sticky-top" style="z-index: 5;">
                                                        <tr class="small text-uppercase text-muted fw-bold">
                                                            ...
                                                            <th width="140" class="border-0">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ</th>
                                                            <th width="120" class="border-0 text-center">ß₧Åß₧ÿßƒÆß₧¢ßƒâ ($)</th>
                                                            <th width="120" class="border-0 text-center text-success">ß₧öß₧äßƒïß₧ûß₧╖ß₧Å ($)</th>
                                                            <th width="80" class="border-0 text-center">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé</th>
                                                            <th width="120" class="border-0">ß₧ÿß₧ÆßƒÆß₧Ößƒäß₧öß₧╢ß₧Ö</th>
                                                            <th class="border-0">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ ß₧ôß₧╖ß₧ä ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒå (Receiver & Ref)</th>
                                                            <th width="110" class="border-0 text-center">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                                                ...
                                                <div class="row g-5 align-items-center position-relative">
                                                    <div class="col-md-3">
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <div>
                                                                <div class="small text-white-50 mb-0 fw-bold ls-1 text-uppercase mb-1">ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧Üß₧╗ß₧ö (Fees)</div>
                                                    ...
                                                    <div class="col-md-3 border-start border-secondary border-opacity-30 ps-4">
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <div>
                                                                <div class="small text-white-50 mb-0 fw-bold ls-1 text-uppercase mb-1">ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</div>
                                                    ...
                                                    <div class="col-md-6 border-start border-secondary border-opacity-30 ps-5 text-end">
                                                        <div class="d-inline-block text-start">
                                                            <div class="small text-white-50 mb-1 fw-bold ls-1 text-uppercase ps-1">ß₧ƒß₧ÿß₧Åß₧╗ß₧¢ßƒÆß₧Öß₧ôßƒàß₧ƒß₧¢ßƒï</div>
                                    ...
                                    <div class="card border-0 rounded-4 shadow-sm p-4">
                                        <div class="row g-4">
                                            <div class="col-md-6 border-end pe-4">
                                                <h6 class="fw-bold text-primary mb-3"><i class="fi fi-rr-man-head me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧¬ß₧ûß₧╗ß₧Ç</h6>
                                                <div class="form-floating mb-2"><input type="text" class="form-control border-0 bg-light" name="fatherName" value="${student.fatherName || ''}"><label>ß₧êßƒÆß₧ÿßƒäßƒçß₧ûßƒüß₧ë</label></div>
                                                <div class="row g-2 mb-2">
                                                    <div class="col-4"><div class="form-floating"><input type="number" class="form-control border-0 bg-light" name="fatherAge" value="${student.fatherAge || ''}"><label>ß₧óß₧╢ß₧Öß₧╗</label></div></div>
                                                    <div class="col-8"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="fatherPhone" value="${student.fatherPhone || ''}"><label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</label></div></div>
                                                </div>
                                                <div class="form-floating"><textarea class="form-control border-0 bg-light" name="fatherAddress" style="height: 60px;">${student.fatherAddress || ''}</textarea><label>ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ô</label></div>
                                            </div>
                                            <div class="col-md-6 ps-4">
                                                <h6 class="fw-bold text-danger mb-3"><i class="fi fi-rr-woman-head me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ÿßƒÆß₧Åß₧╢ß₧Ö</h6>
                                                <div class="form-floating mb-2"><input type="text" class="form-control border-0 bg-light" name="motherName" value="${student.motherName || ''}"><label>ß₧êßƒÆß₧ÿßƒäßƒçß₧ûßƒüß₧ë</label></div>
                                                <div class="row g-2 mb-2">
                                                    <div class="col-4"><div class="form-floating"><input type="number" class="form-control border-0 bg-light" name="motherAge" value="${student.motherAge || ''}"><label>ß₧óß₧╢ß₧Öß₧╗</label></div></div>
                                                    <div class="col-8"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="motherPhone" value="${student.motherPhone || ''}"><label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</label></div></div>
                                                </div>
                                                <div class="form-floating"><textarea class="form-control border-0 bg-light" name="motherAddress" style="height: 60px;">${student.motherAddress || ''}</textarea><label>ß₧óß₧╢ß₧ƒß₧Öß₧èßƒÆß₧ïß₧╢ß₧ô</label></div>
                                            </div>
                                            <div class="col-12"><hr class="opacity-10"></div>
                                            <div class="col-12">
                                                <h6 class="fw-bold text-warning mb-3"><i class="fi fi-rr-shield-check me-2"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧óß₧╢ß₧Äß₧╢ß₧ûßƒÆß₧Öß₧╢ß₧öß₧╢ß₧¢</h6>
                                                <div class="row g-2">
                                                    <div class="col-md-5"><div class="form-floating"><input type="text" class="form-control border-0 bg-light fw-bold" name="guardianName" value="${student.guardianName || ''}"><label>ß₧êßƒÆß₧ÿßƒäßƒçß₧ûßƒüß₧ë</label></div></div>
                                                    <div class="col-md-4"><div class="form-floating"><input type="text" class="form-control border-0 bg-light fw-bold" name="guardianPhone" value="${student.guardianPhone || ''}"><label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</label></div></div>
                                                    <div class="col-md-3"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="guardianRelation" value="${student.guardianRelation || ''}"><label>ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧çß₧╢ (Relation)</label></div></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="edit-other" role="tabpanel">
                                    <div class="card border-0 rounded-4 shadow-sm p-4">
                                        <div class="row g-3">
                                            <div class="col-md-4"><label class="small fw-bold">ß₧ƒß₧╢ß₧¢ß₧╢ß₧àß₧╢ß₧ƒßƒï</label><input type="text" class="form-control bg-light border-0" name="previousSchool" value="${student.previousSchool || ''}"></div>
                                            <div class="col-md-4"><label class="small fw-bold">ß₧óßƒÆß₧ôß₧Çß₧Äßƒéß₧ôß₧╢ßƒå</label><input type="text" class="form-control bg-light border-0" name="referral" value="${student.referral || ''}"></div>
                                            <div class="col-md-4"><label class="small fw-bold">ß₧éßƒäß₧¢ß₧ößƒåß₧Äß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</label><input type="text" class="form-control bg-light border-0" name="motivation" value="${student.motivation || ''}"></div>
                                            
                                            <div class="col-md-6 border-end">
                                                <h6 class="fw-bold mb-2 small text-primary">ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧óßƒÆß₧ôß₧Çß₧çß₧╝ß₧ô ß₧ôß₧╖ß₧äß₧æß₧æß₧╜ß₧¢</h6>
                                                <div class="row g-2">
                                                    <div class="col-6"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="pickerName" value="${student.pickerName || ''}"><label>ß₧êßƒÆß₧ÿßƒäßƒç</label></div></div>
                                                    <div class="col-6"><div class="form-floating"><input type="text" class="form-control border-0 bg-light" name="pickerPhone" value="${student.pickerPhone || ''}"><label>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</label></div></div>
                                                </div>
                                            </div>
                                            
                                            <div class="col-md-6"><label class="small fw-bold">ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒåß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ/ß₧ƒß₧╗ß₧üß₧ùß₧╢ß₧û (Notes)</label><textarea class="form-control bg-light border-0" name="healthInfo" rows="4">${student.healthInfo || student.note || ''}</textarea></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer p-4 border-0 bg-white d-flex justify-content-between align-items-center">
                        <button type="button" class="btn btn-light px-4 rounded-pill border fw-bold" data-bs-dismiss="modal">ß₧ößƒäßƒçß₧öß₧äßƒï</button>
                        <div class="d-flex gap-2">
...
function addInstallmentRow(data = {}) {
    ...
    const receiverHtml = typeof getReceiverSelectHtml === 'function'
        ...
        : `<input type="text" class="form-control form-control-sm inst-receiver border-0 bg-white shadow-sm px-2 py-1 rounded-3 very-small" style="font-size: 0.75rem;" value="${data.receiver || ''}" placeholder="ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢">`;
    ...
    tr.innerHTML = `
        ...
        <td class="py-1">
            <div class="input-group shadow-sm rounded-3 overflow-hidden border-0 bg-white">
                ...
                <input type="text" class="form-control form-control-sm inst-date text-center border-0 bg-white fw-bold py-1 very-small ps-0" style="font-size: 0.75rem;" value="${(data.date && data.date !== 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') ? convertToKhmerDate(data.date) : ''}" placeholder="DD/MM/YYYY">
            </div>
        </td>
        ...
        <td class="text-center py-1">
            <input type="number" step="0.1" class="form-control form-control-sm text-center fw-bold inst-months border-0 bg-white shadow-sm py-1 rounded-3 very-small" style="font-size: 0.75rem;" value="${data.months || 0}" placeholder="ß₧üßƒé">
        </td>
        <td class="py-1">
            <select class="form-select form-select-sm border-0 bg-white shadow-sm inst-method rounded-3 fw-bold py-1 very-small" style="font-size: 0.75rem;">
                <option value="Cash" ${method === 'Cash' ? 'selected' : ''}>≡ƒÆ╡ Cash</option>
                <option value="ABA" ${method === 'ABA' ? 'selected' : ''}>≡ƒÅª ABA</option>
                <option value="Wing" ${method === 'Wing' ? 'selected' : ''}>≡ƒÆ╕ Wing</option>
            </select>
        </td>
        <td class="py-1">
            <div class="d-flex gap-2 align-items-center">
                ...
                <div class="input-group shadow-sm rounded-3 overflow-hidden border-0 bg-white flex-grow-1">
                    ...
                    <input type="text" class="form-control form-control-sm inst-note border-0 bg-white py-1 very-small ps-0" style="font-size: 0.7rem;" value="${data.note || ''}" placeholder="ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒå">
                </div>
            </div>
        </td>
        <td class="text-center py-1">
...
function calculateEditFormTotals() {
    ...
    if (statusSelect && badgeEl) {
        ...
        const config = {
            'Paid': { text: 'ß₧öß₧äßƒïß₧Üß₧╜ß₧à (PAID)', badge: 'bg-success' },
            'Pending': { text: 'ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒï (PENDING)', badge: 'bg-danger' },
            'Installment': { text: 'ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï (INSTALLMENT)', badge: 'bg-warning text-dark' },
            'Delay': { text: 'ß₧ûß₧ôßƒÆß₧Öß₧╢ (DELAY)', badge: 'bg-info' },
            'Paid Full': { text: 'ß₧öß₧äßƒïß₧èß₧╢ß₧àßƒï (PAID FULL)', badge: 'bg-primary' }
        };
...
window.loadStudentScoreHistory = function (key) {
    ...
    const s = allStudentsData[key];
    if (!s) {
        container.innerHTML = '<div class="alert alert-danger">ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</div>';
        return;
    }
    ...
    if (records.length === 0) {
        container.innerHTML = `
            <div class="text-center py-5 opacity-50">
                ...
                <h6 class="mt-3 moul-font">ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ôßƒàß₧íß₧╛ß₧Öß₧æßƒü</h6>
    ...
    const isChineseFullTime = prog.includes('chinese-fulltime') || prog.includes('cfulltime') || prog.includes('ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä');

    // Header labels based on curriculum
    const chineseLabels = ["ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒí", "ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒó", "ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé", "ß₧ƒßƒÆß₧Åß₧╢ß₧ößƒï", "ß₧ôß₧╖ß₧Öß₧╢ß₧Ö", "ß₧óß₧╢ß₧ô", "ß₧ƒß₧╗ß₧çß₧╕ß₧£ß₧Æß₧ÿßƒî", "ß₧óß₧£ß₧ÅßƒÆß₧Åß₧ÿß₧╢ß₧ô", "ß₧Çß₧╖ß₧àßƒÆß₧àß₧Çß₧╢ß₧Ü", "ß₧àßƒÆß₧ÜßƒÇß₧ä", "HSK"];
    const generalLabels = ["ß₧ùß₧╢ß₧ƒß₧╢ß₧üßƒÆß₧ÿßƒéß₧Ü", "ß₧éß₧Äß₧╖ß₧Åß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ß₧ƒß₧╢ß₧ƒßƒÆß₧ÅßƒÆß₧Ü", "ß₧ùß₧╝ß₧ÿß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧ƒß₧╕ß₧ƒß₧Æß₧ÿßƒîß₧ûß₧¢ß₧Üß₧èßƒÆß₧ï", "ß₧óß₧ößƒïß₧Üßƒåß₧ƒß₧╖ß₧ƒßƒÆß₧ößƒê", "ß₧ößƒåß₧Äß₧╖ß₧ôß₧çß₧╕ß₧£ß₧╖ß₧Å", "ß₧óß₧ößƒïß₧Üßƒåß₧Çß₧╢ß₧Ö", "-", "-"];
    const activeLabels = isChineseFullTime ? chineseLabels : generalLabels;

    const khmerMonths = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
            ...
            <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                <thead class="bg-light">
                    <tr class="text-muted very-small text-uppercase ls-1">
                        <th class="ps-3 py-3">ß₧üßƒé / ß₧åßƒÆß₧ôß₧╢ßƒå</th>
                        <th class="text-center">ß₧ƒß₧Üß₧╗ß₧ö</th>
                        <th class="text-center">ß₧ÿß₧ÆßƒÆß₧Öß₧ÿ</th>
                        <th class="text-center">ß₧ôß₧╖ß₧æßƒÆß₧æßƒüß₧ƒ</th>
                        <th class="text-center">ß₧àßƒåß₧Äß₧╢ß₧Åßƒïß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</th>
                        <th class="text-center pe-3">ß₧ƒß₧Çß₧ÿßƒÆß₧ÿß₧ùß₧╢ß₧û</th>
                    </tr>
                </thead>
                <tbody>
    `;
        ...
        html += `
            <tr class="animate__animated animate__fadeIn">
                <td class="ps-3 py-3 fw-bold">
                    ${monthKh}-${r.year}
                    <div class="very-small text-muted fw-normal">${prog.includes('three-languages') ? 'ß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà' : (isChineseFullTime ? 'ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä' : 'ß₧ùß₧╢ß₧ƒß₧╢')}</div>
                </td>
                ...
                <td class="text-center pe-3">
                    <button type="button" class="btn btn-sm btn-light rounded-pill px-3" onclick="showScoreDetails('${key}', '${r.month}', '${r.year}')">
                        <i class="fi fi-rr-eye me-1"></i> ß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Å
                    </button>
                </td>
            </tr>
        `;
...
window.showScoreDetails = function (key, month, year) {
    ...
    const prog = (s.studyType || s.courseType || '').toLowerCase();
    const isCh = prog.includes('chinese-fulltime') || prog.includes('cfulltime') || prog.includes('ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä');
    const chineseLabels = ["ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒí", "ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒó", "ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé", "ß₧ƒßƒÆß₧Åß₧╢ß₧ößƒï", "ß₧ôß₧╖ß₧Öß₧╢ß₧Ö", "ß₧óß₧╢ß₧ô", "ß₧ƒß₧╗ß₧çß₧╕ß₧£ß₧Æß₧ÿßƒî", "ß₧óß₧£ß₧ÅßƒÆß₧Åß₧ÿß₧╢ß₧ô", "ß₧Çß₧╖ß₧àßƒÆß₧àß₧Çß₧╢ß₧Ü", "ß₧àßƒÆß₧ÜßƒÇß₧ä", "HSK"];
    const generalLabels = ["ß₧ùß₧╢ß₧ƒß₧╢ß₧üßƒÆß₧ÿßƒéß₧Ü", "ß₧éß₧Äß₧╖ß₧Åß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ß₧ƒß₧╢ß₧ƒßƒÆß₧ÅßƒÆß₧Ü", "ß₧ùß₧╝ß₧ÿß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢", "ß₧ƒß₧╕ß₧ƒß₧Æß₧ÿßƒîß₧ûß₧¢ß₧Üß₧èßƒÆß₧ï", "ß₧óß₧ößƒïß₧Üßƒåß₧ƒß₧╖ß₧ƒßƒÆß₧ößƒê", "ß₧ößƒåß₧Äß₧╖ß₧ôß₧çß₧╕ß₧£ß₧╖ß₧Å", "ß₧óß₧ößƒïß₧Üßƒåß₧Çß₧╢ß₧Ö", "-", "-"];
    ...
    Swal.fire({
        title: `ß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Åß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧üßƒé ${khmerMonthNames[month - 1]} - ${year}`,
        html: `
            <div class="text-start">
                <div class="mb-3 d-flex justify-content-between">
                    <div><strong>ß₧ƒß₧Üß₧╗ß₧ö:</strong> ${r.totalScore}</div>
                    <div><strong>ß₧ÿß₧ÆßƒÆß₧Öß₧ÿß₧ùß₧╢ß₧é:</strong> ${r.averageScore}</div>
                </div>
                ${scoresHtml}
            </div>
        `,
        confirmButtonText: 'ß₧Öß₧¢ßƒïß₧ûßƒÆß₧Üß₧ÿ',
...
window.openAddScoreModal = function (key) {
    ...
    document.getElementById('scoreProgramDisplay').innerText = isCh ? 'ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä' : 'ß₧àßƒåß₧Äßƒüßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà';
    ...
    const subjects = isCh ? [
        { key: 'week01', label: 'ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒí' },
        { key: 'week02', label: 'ß₧ƒß₧ößƒÆß₧Åß₧╢ß₧áßƒìßƒó' },
        { key: 'monthly', label: 'ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé' },
        { key: 'listening', label: 'ß₧ƒßƒÆß₧Åß₧╢ß₧ößƒï' },
        { key: 'speaking', label: 'ß₧ôß₧╖ß₧Öß₧╢ß₧Ö' },
        { key: 'reading', label: 'ß₧óß₧╢ß₧ô' },
        { key: 'ethics', label: 'ß₧ƒß₧╗ß₧çß₧╕ß₧£ß₧Æß₧ÿßƒî' },
        { key: 'attendance', label: 'ß₧óß₧£ß₧ÅßƒÆß₧Åß₧ÿß₧╢ß₧ô' },
        { key: 'homework', label: 'ß₧Çß₧╖ß₧àßƒÆß₧àß₧Çß₧╢ß₧Ü' },
        { key: 'singing', label: 'ß₧àßƒÆß₧ÜßƒÇß₧ä' },
        { key: 'hsk', label: 'HSK' }
    ] : [
        { key: 'week01', label: 'ß₧ùß₧╢ß₧ƒß₧╢ß₧üßƒÆß₧ÿßƒéß₧Ü (Khmer Language)' },
        { key: 'week02', label: 'ß₧éß₧Äß₧╖ß₧Åß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ (Mathematics)' },
        { key: 'monthly', label: 'ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ß₧ƒß₧╢ß₧ƒßƒÆß₧ÅßƒÆß₧Ü (Science)' },
        { key: 'listening', label: 'ß₧ùß₧╝ß₧ÿß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ (Geography)' },
        { key: 'speaking', label: 'ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧£ß₧╖ß₧æßƒÆß₧Öß₧╢ (History)' },
        { key: 'reading', label: 'ß₧ƒß₧╕ß₧¢ß₧Æß₧ÿßƒî-ß₧ûß₧¢ß₧Üß₧èßƒÆß₧ï (Ethics-Civics)' },
        { key: 'ethics', label: 'ß₧óß₧ößƒïß₧Üßƒåß₧ƒß₧╖ß₧¢ßƒÆß₧ößƒê (Arts Education)' },
        { key: 'attendance', label: 'ß₧ößƒåß₧Äß₧╖ß₧ôß₧çß₧╕ß₧£ß₧╖ß₧Å (Life Skills)' },
        { key: 'homework', label: 'ß₧óß₧ößƒïß₧Üßƒåß₧Çß₧╢ß₧Ö (Physical Education)' }
    ];
...
window.saveAdminScore = function () {
    ...
    studentsRef.child(key).update({
        ...
        Swal.fire({
            icon: 'success',
            title: 'ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧çßƒäß₧éß₧çßƒÉß₧Ö!',
            text: 'ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧æßƒàß₧ÇßƒÆß₧ôß₧╗ß₧äß₧ößƒÆß₧Üß₧ûßƒÉß₧ôßƒÆß₧Æß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï',
            timer: 1500,
...
async function saveStudentChanges(key) {
    ...
    if (!form.lastName.value.trim() || !form.firstName.value.trim() || !form.displayId.value.trim()) {
        return showAlert('ß₧ƒß₧╝ß₧ÿß₧ößƒåß₧ûßƒüß₧ëß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧àß₧╢ßƒåß₧öß₧╢ß₧àßƒï (ß₧êßƒÆß₧ÿßƒäßƒç ß₧ôß₧╖ß₧äß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü)', 'warning');
    }

    showLoading(true, 'ß₧Çßƒåß₧ûß₧╗ß₧äß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç...');
    ...
    if (imageInput && imageInput.files && imageInput.files[0]) {
        try {
            console.log("≡ƒôñ Uploading student edit image to Cloudflare R2...");
            const preview = document.getElementById('editImagePreview');
            if (preview && preview.parentElement) {
                const miniStatus = document.createElement('div');
                miniStatus.id = 'editMiniStatus';
                miniStatus.className = 'r2-mini-status';
                miniStatus.innerHTML = '<div class="r2-mini-spinner"></div><span>ß₧ößƒÆß₧Åß₧╝ß₧Üß₧Üß₧╝ß₧öß₧Éß₧Å...</span>';
            ...
            if (url) {
                data.imageUrl = url;
                console.log("Γ£à Student edit image R2 URL:", url);
            }
        } catch (e) {
            console.error("Γ¥î Student edit image R2 upload error:", e);
        }
    }
    ...
    studentsRef.child(key).update(data)
        .then(() => {
            Swal.fire({
                icon: 'success',
                title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö!',
                text: 'ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧èßƒäß₧Öß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                timer: 1500,
                showConfirmButton: false
            });
            const modalEl = document.getElementById('editStudentModal');
        ...
        .catch(error => {
            ...
            showAlert('ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧ƒß₧ÿßƒÆß₧Üßƒüß₧à: ' + error.message, 'danger');
        })
...
function deleteStudent(key, displayId) {
    if (!confirm(`ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ ID: ${displayId} ß₧ÿßƒéß₧ôß₧æßƒü?`)) return;
    studentsRef.child(key).remove()
        .then(() => showAlert(`ß₧¢ß₧╗ß₧ö ID: ${displayId} ß₧çßƒäß₧éß₧çßƒÉß₧Ö`, 'success'))
...
// Forward compatibility: old callers of updatePaymentPreview ΓåÆ use updateHybridPreview
        ...
        if (dateStr.match(/^\d{4}-\d{2}-\d{2}$/)) {
            ...
            if (parts.length >= 3) {
                ...
                if (isNaN(parseInt(parts[1], 10))) {
                    const kmMonths = ['ß₧ÿß₧Çß₧Üß₧╢', 'ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê', 'ß₧ÿß₧╕ß₧ôß₧╢', 'ß₧ÿßƒüß₧ƒß₧╢', 'ß₧ºß₧ƒß₧ùß₧╢', 'ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢', 'ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢', 'ß₧ƒß₧╕ß₧áß₧╢', 'ß₧Çß₧ëßƒÆß₧ëß₧╢', 'ß₧Åß₧╗ß₧¢ß₧╢', 'ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢', 'ß₧ÆßƒÆß₧ôß₧╝'];
...
function markAsPaid(key) {
    const s = allStudentsData[key];
    if (!s) return;
    if (!confirm('ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ƒß₧Üß₧╗ß₧öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧üßƒéß₧ôßƒüßƒç?')) return;

    const months = parseInt(s.paymentMonths || 1);
    let nextDate = 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô';
    ...
    studentsRef.child(key).update(updateData).then(() => {
        showAlert('ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï', 'success');
...
function checkPaymentAlerts(data) {
    ...
    if (notifications.warning.length > 0) {
        showAlert(`ΓÜá∩╕Å ß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ ${notifications.warning.length} ß₧ôß₧╢ß₧Çßƒïß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï(10 ß₧ÉßƒÆß₧äßƒâ)`, 'warning');
    }
}
...
function renderAlertPanel() {
    ...
    if (notifications.overdue.length === 0 && notifications.warning.length === 0) {
        html = '<div class="p-4 text-center text-muted"><i class="fi fi-rr-check-circle fa-2x mb-2 d-block text-success"></i>ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧Çß₧╢ß₧Üß₧çß₧╝ß₧ôß₧èßƒåß₧Äß₧╣ß₧ä</div>';
    } else {
        notifications.overdue.forEach(n => {
            html += `<div class="alert-item overdue p-3 border-bottom d-flex align-items-center" onclick="viewStudentDetails('${n.id}')" style="cursor:pointer">
                ...
                <div>
                    <div class="fw-bold text-danger">ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï: ${n.name}</div>
                    <small class="text-muted"><i class="fi fi-rr-calendar-xmark me-1"></i>ß₧áß₧╜ß₧ƒ ${n.days} ß₧ÉßƒÆß₧äßƒâ</small>
                </div>
            </div>`;
        });
        notifications.warning.forEach(n => {
            html += `<div class="alert-item warning p-3 border-bottom d-flex align-items-center" onclick="viewStudentDetails('${n.id}')" style="cursor:pointer">
                ...
                <div>
                    <div class="fw-bold text-warning">ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒï: ${n.name}</div>
                    <small class="text-muted"><i class="fi fi-rr-clock me-1"></i>ß₧ôßƒàß₧ƒß₧¢ßƒï ${n.days} ß₧ÉßƒÆß₧äßƒâ</small>
                </div>
            </div>`;
        });
    }
        ...
        <div class="modal fade" id="renewStudentModal" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-header p-4 border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        <div>
                            <h5 class="modal-title fw-bold text-white mb-1">
                                <i class="fi fi-rr-refresh me-2"></i>ß₧ößƒÆß₧Åß₧╝ß₧Üß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢
                            </h5>
                            <p class="text-white-50 small mb-0">ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧Üß₧öß₧ƒßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</p>
                        </div>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
            ...
            `<div class="rounded-circle bg-secondary bg-opacity-25 me-3 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">ID: ${s.displayId} ΓÇó ${typeof formatStudyType === 'function' ? formatStudyType(s) : (s.studyType || '')}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info border-0 mb-4" style="background: rgba(13, 110, 253, 0.1);">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="small">
                                            <strong>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ô:</strong><br>
                                                <span class="text-muted">
                                                    ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å: <strong>${s.studyLevel || 'N/A'}</strong> ΓÇó
                                                    ß₧ÿßƒëßƒäß₧ä: <strong>${formatStudyTimeKhmer(s.studyTime || 'N/A')}</strong> ΓÇó
                                                    ß₧éßƒÆß₧Üß₧╝: <strong>${s.teacherName || 'N/A'}</strong> ΓÇó
                                                    ß₧öß₧ôßƒÆß₧æß₧ößƒï: <strong>${s.classroom || 'N/A'}</strong>
                                                </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card border-0 shadow-sm mb-4">
                                    <div class="card-header bg-white border-0 py-3">
                                        <h6 class="fw-bold mb-0 text-dark">
                                            <i class="fi fi-rr-edit me-2 text-primary"></i>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ÉßƒÆß₧ÿß₧╕
                                        </h6>
                                    </div>
                                    <div class="card-body p-4">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold small">
                                                    <i class="fi fi-rr-book-alt me-1 text-primary"></i>ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Åß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Level)
                                                </label>
                                                <select class="form-select form-select-lg" name="newLevel" required>
                                                    <option value="">-- ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å --</option>
                                                    ${levelOptions}
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold small">
                                                    <i class="fi fi-rr-clock me-1 text-primary"></i>ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Time)
                                                </label>
                                                <select class="form-select form-select-lg" name="newTime" required>
                                                    <option value="">-- ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧ÿßƒëßƒäß₧ä --</option>
                                                    ${timeOptions}
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold small">
                                                    <i class="fi fi-rr-user me-1 text-primary"></i>ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï (Teacher)
                                                </label>
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold small">
                                                    <i class="fi fi-rr-room-service me-1 text-primary"></i>ß₧öß₧ôßƒÆß₧æß₧ößƒïß₧ÜßƒÇß₧ô (Classroom)
                                                </label>
                                                <select class="form-select form-select-lg" name="newClassroom" required>
                                                    <option value="">-- ß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧öß₧ôßƒÆß₧æß₧ößƒï --</option>
                                                    ${classroomOptions}
                                                </select>
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label fw-bold small">
                                                    <i class="fi fi-rr-comment-alt me-1 text-primary"></i>ß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï (Note)
                                                </label>
                                                <textarea class="form-control" name="note" rows="2" placeholder="ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï (ß₧ößƒÆß₧Üß₧ƒß₧╖ß₧ôß₧öß₧╛ß₧ÿß₧╢ß₧ô)..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer p-4 bg-light border-0">
                        <button type="button" class="btn btn-light px-4 rounded-pill" data-bs-dismiss="modal">
                            <i class="fi fi-rr-cross-small me-1"></i>ß₧ößƒäßƒçß₧öß₧äßƒï
                        </button>
                        <button type="button" class="btn btn-primary px-5 fw-bold rounded-pill shadow-sm" onclick="processRenew('${s.key}')" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                            <i class="fi fi-rr-check-circle me-2"></i>ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧Çß₧╢ß₧Üß₧òßƒÆß₧¢ß₧╢ß₧ƒßƒïß₧ößƒÆß₧Åß₧╝ß₧Ü
                        </button>
                    </div>
                </div>
            </div>
...
function processRenew(key) {
    ...
    if (!newLevel || !newTime || !newTeacher || !newClassroom) {
        showAlert('ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒïß₧▒ßƒÆß₧Öß₧öß₧╢ß₧ôß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧╢ß₧ôßƒï!', 'warning');
        return;
    }
    ...
    if (!hasChanges) {
        showAlert('ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧Çß₧╢ß₧Üß₧òßƒÆß₧¢ß₧╢ß₧ƒßƒïß₧ößƒÆß₧Åß₧╝ß₧Üß₧æßƒü!', 'info');
        return;
    }
    ...
    studentsRef.child(key).update(updateData)
        .then(() => {
            ...
            let changes = [];
            if (newLevel !== oldInfo.level) changes.push(`ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å: ${oldInfo.level} ΓåÆ ${newLevel} `);
            if (newTime !== oldInfo.time) changes.push(`ß₧ÿßƒëßƒäß₧ä: ${formatStudyTimeKhmer(oldInfo.time)} ΓåÆ ${formatStudyTimeKhmer(newTime)} `);
            if (newTeacher !== oldInfo.teacher) changes.push(`ß₧éßƒÆß₧Üß₧╝: ${oldInfo.teacher} ΓåÆ ${newTeacher} `);
            if (newClassroom !== oldInfo.classroom) changes.push(`ß₧öß₧ôßƒÆß₧æß₧ößƒï: ${oldInfo.classroom} ΓåÆ ${newClassroom} `);

            const successMsg = `Γ£à ß₧ößƒÆß₧Åß₧╝ß₧Üß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧çßƒäß₧éß₧çßƒÉß₧Ö!<br>${changes.join('<br>')}`;
        ...
        .catch(e => {
            ...
            showAlert('Γ¥î ß₧Çßƒåß₧áß₧╗ß₧ƒ: ' + e.message, 'danger');
        })
        .finally(() => showLoading(false));
}
...
function deleteInstallment(key, index) {
    if (!confirm('ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ûß₧╖ß₧Åß₧çß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧ôßƒüßƒçß₧ÿßƒéß₧ôß₧æßƒü?')) return;
    ...
    if (index === 'initial') {
        ...
        studentsRef.child(key).update(resetPayload)
            .then(() => {
                showAlert('ß₧¢ß₧╗ß₧öß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧äß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
                if (studentDetailsModal) {
                    studentDetailsModal.hide();
                    setTimeout(() => viewStudentDetails(key), 500);
                }
    ...
    if (index >= 0 && index < installments.length) {
        ...
        studentsRef.child(key).update({
            ...
            .then(() => {
                showAlert('ß₧¢ß₧╗ß₧öß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
                if (studentDetailsModal) {
                    studentDetailsModal.hide();
                    setTimeout(() => viewStudentDetails(key), 500);
                }
...
function showEditInstallmentModal(key, index, displayStage) {
    ...
    const lockInfo = (isInitial && !isAdmin) ? '<div class="alert alert-warning border-0 shadow-sm py-2 px-3 mb-3 small d-flex align-items-center"><i class="fi fi-rr-lock me-2"></i> ß₧ÿß₧╢ß₧ôß₧Åßƒéß₧óßƒÆß₧ôß₧Çß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧ä (Admin) ß₧æßƒüß₧èßƒéß₧¢ß₧óß₧╢ß₧àß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧öß₧╢ß₧ôßƒö</div>' : '';
    ...
    function deleteInstallmentFromModal(key, index) {
        if (confirm('ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ûß₧╖ß₧Åß₧çß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ôßƒüßƒçß₧ÿßƒéß₧ôß₧æßƒü?')) {
                ...
                <div class="modal-content animate__animated animate__zoomIn animate__faster">
                    <div class="modal-header">
                        <h5 class="modal-title mb-0">
                            ...
                            ${isInitial ? (isAdmin ? 'ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧öß₧╝ß₧ä (Admin)' : 'ß₧ÿß₧╛ß₧¢ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧öß₧╝ß₧ä (Admin Only Edit)') : `ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧æß₧╕ ${displayStage || inst.stage || index + 1})`}
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editInstallmentForm">
                            <div class="row g-4">
                                <!-- Row 1 -->
                                <div class="col-md-3">
                                    <label class="form-label"><i class="fi fi-rr-layer-plus me-1"></i> ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢</label>
                                ...
                                <div class="col-md-5">
                                    <label class="form-label"><i class="fi fi-rr-calendar me-1"></i> ß₧ÉßƒÆß₧äßƒâß₧üßƒéß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</label>
                                    ...
                                    <small class="text-muted" style="font-size: 0.65rem;">ß₧æß₧ÿßƒÆß₧Üß₧äßƒï: ß₧ÉßƒÆß₧äßƒâ-ß₧üßƒé-ß₧åßƒÆß₧ôß₧╢ßƒå (ß₧º. 10-03-2026)</small>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label"><i class="fi fi-rr-hourglass-end me-1"></i> ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé</label>
                                    <input type="number" class="form-control elegant-input" name="months" value="${inst.months || ''}" placeholder="ß₧º. 1, 3, 6" ${readonlyAttr}>
                                </div>

                                <!-- Row 2 (Amounts) -->
                                <div class="col-md-6">
                                    <label class="form-label"><i class="fi fi-rr-usd-circle me-1"></i> ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (ß₧ƒß₧Üß₧╗ß₧ö)</label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-success"><i class="fi fi-rr-hand-holding-usd me-1"></i> ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧╢ß₧ôß₧öß₧äßƒï (Paid)</label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label text-danger"><i class="fi fi-rr-time-past me-1"></i> ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒåß₧Äß₧╢ß₧Çßƒï (Debt)</label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label"><i class="fi fi-rr-bank me-1"></i> ß₧ƒßƒüß₧£ß₧╢ß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label"><i class="fi fi-rr-box-open me-1"></i> ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê</label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                ...
                                <!-- Row 4 (Info) -->
                                <div class="col-md-6">
                                    <label class="form-label"><i class="fi fi-rr-user me-1"></i> ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢</label>
                                    ${getReceiverSelectHtml(inst.receiver || '', 'receiver', 'form-control elegant-input', '', disabledAttr)}
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><i class="fi fi-rr-wallet me-1"></i> ß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</label>
                                    ${getPaymentMethodSelectHtml(inst.paymentMethod || '', 'paymentMethod', 'form-control elegant-input', '', disabledAttr)}
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label"><i class="fi fi-rr-comment-alt me-1"></i> ß₧àßƒåß₧Äß₧╢ßƒå (Note)</label>
                                    <input type="text" class="form-control elegant-input" name="note" value="${inst.note || ''}" placeholder="ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ..." ${readonlyAttr}>
                                </div>
                                
                                <div class="col-12 mt-4">
                                    <div class="status-switch-card">
                                        <label class="form-check-label fw-bold text-dark fs-6 cursor-pointer" for="instPaidCheck">
                                            <i class="fi fi-rr-shield-check text-success me-2"></i> ß₧¢ß₧ÇßƒÆß₧üß₧üß₧ÄßƒÆß₧îß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (ß₧öß₧äßƒïß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï / Paid)
                                        </label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-royal btn-danger-dynamic" onclick="deleteInstallmentFromModal(${deleteParamVal})" ${disabledAttr}>
                            <i class="fi fi-rr-trash me-2"></i>ß₧¢ß₧╗ß₧öß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖
                        </button>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-royal btn-cancel" data-bs-dismiss="modal">ß₧óß₧Åßƒïß₧æßƒü (Cancel)</button>
                            <button type="button" class="btn btn-royal btn-primary-dynamic" onclick="saveInstallmentEdit(${saveParamVal})" ${disabledAttr}>
                                <i class="fi fi-rr-disk me-2"></i>ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç (Save)
                            </button>
                        </div>
                    </div>
                </div>
...
function saveInstallmentEdit(key, index) {
    ...
    if (index === 'initial' && !isCurrentUserAdmin()) {
        showAlert('ß₧óßƒÆß₧ôß₧Çß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧æßƒÆß₧Æß₧╖ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧öß₧╝ß₧äß₧íß₧╛ß₧Ö!', 'danger');
        return;
    }
    ...
    if (dateRaw.includes('-')) {
        ...
        if (parts.length === 3) {
            ...
            const m = parseInt(parts[1]);
            if (d > 31 || d < 1) { showAlert('ß₧ÉßƒÆß₧äßƒâß₧ÿß₧╖ß₧ôß₧óß₧╢ß₧àß₧¢ß₧╛ß₧ƒß₧ûß₧╕ 31 ß₧íß₧╛ß₧Ö!', 'danger'); return; }
            if (m > 12 || m < 1) { showAlert('ß₧üßƒéß₧ÿß₧╖ß₧ôß₧óß₧╢ß₧àß₧¢ß₧╛ß₧ƒß₧ûß₧╕ 12 ß₧íß₧╛ß₧Ö!', 'danger'); return; }
        }
    }
    ...
    if (index === 'initial') {
        ...
        studentsRef.child(key).update(updatePayload)
            .then(() => {
                showAlert('ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧äß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
                const modal = bootstrap.Modal.getInstance(document.getElementById('editInstallmentModal'));
                if (modal) modal.hide();
                if (studentDetailsModal) {
                    studentDetailsModal.hide();
    ...
    if (index >= 0 && index < installments.length) {
        ...
        studentsRef.child(key).update(updatePayload)
            .then(() => {
                showAlert('ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
...
window.filterDueToday = function () {
    ...
    renderFilteredTable();
    showAlert('ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧èßƒéß₧¢ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç', 'info');
};
...
window.exportSpecificCategoryPDF = function (category) {
    ...
    if (category === 'chinese-fulltime') {
        ...
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (Chinese Full-time)";
    } else if (category === '3-languages' || category === 'trilingual') {
        filtered = activeStudents.filter(s => isStudentTrilingual(s));
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà (General Knowledge)";
    } else if (category === 'part-time') {
        filtered = activeStudents.filter(s => isStudentPartTime(s));
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (Part-time Students)";
    } else if (category === '2-languages') {
        filtered = activeStudents.filter(s => (s.studyProgram || '').toLowerCase().includes('2_languages'));
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒóß₧ùß₧╢ß₧ƒß₧╢)";
    } else if (category === '1-language') {
        filtered = activeStudents.filter(s => (s.studyProgram || '').toLowerCase().includes('1_language'));
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒíß₧ùß₧╢ß₧ƒß₧╢)";
    } else {
        filtered = activeStudents;
        title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï";
    }

    if (filtered.length === 0) {
        return showAlert("ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧ôßƒüßƒçß₧æßƒü (No data found for this category)", 'info');
    }
...
function exportToExcel(data = null, filename = 'Student_Data') {
    ...
    if (students.length === 0) return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ôß₧╢ßƒåß₧àßƒüß₧ë', 'warning');

    let csv = '\uFEFFß₧¢.ß₧Ü,ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü,ß₧êßƒÆß₧ÿßƒäßƒç,ß₧ùßƒüß₧æ,ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å,ß₧ÿßƒëßƒäß₧ä,ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç,ß₧ÉßƒÆß₧äßƒâß₧òß₧╗ß₧Åß₧Çßƒåß₧Äß₧Åßƒï,ß₧ÉßƒÆß₧äßƒâß₧ûß₧ôßƒÆß₧Öß₧╢,ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ß₧ûß₧ôßƒÆß₧Öß₧╢,ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé,ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï,ß₧àßƒåß₧Äß₧╢ßƒå,ß₧Åß₧ÿßƒÆß₧¢ßƒâ,ß₧üßƒÆß₧£ßƒç,ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û\n';
    students.forEach((s, i) => {
        ...
        csv += `${i + 1},${s.displayId},"${s.lastName} ${s.firstName}",${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'},${s.studyLevel || ''},${s.studyTime || ''},${joinDate || ''},${expiryDate || ''},${postponeDate || ''},"${(s.postponedReason || '').replace(/"/g, '""')}",${s.paymentMonths || ''},"${teacher}","${(s.remark || '').replace(/"/g, '""')}",$${calculateTotalAmount(s).toFixed(2)},$${calculateRemainingAmount(s).toFixed(2)},${status.text}\n`;
    });
...
function exportOverdueReport() {
    ...
    // 1. Group Data
    const categories = {
        'Chinese Fulltime': { title: 'ß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 },
        'Chinese Parttime': { title: 'ß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 },
        '1 Language': { title: 'ß₧ùß₧╢ß₧ƒß₧╢ (ßƒíß₧ùß₧╢ß₧ƒß₧╢)', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 },
        '2 Languages': { title: 'ß₧ùß₧╢ß₧ƒß₧╢ (ßƒóß₧ùß₧╢ß₧ƒß₧╢)', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 },
        '3 Languages': { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 },
        'Other': { title: 'ß₧òßƒÆß₧ƒßƒüß₧äßƒù', groups: { today: [], overdue: [], warning: [], unpaid: [] }, totalDebt: 0 }
    };
    ...
    if (students.length === 0) return showAlert('ß₧¢ßƒÆß₧óß₧Äß₧╢ß₧ƒßƒï! ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧çßƒåß₧ûß₧╢ß₧Çßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒïß₧æßƒü', 'success');
    ...
    students.forEach(s => {
        ...
        if (prog.includes('3_languages') || prog.includes('ßƒú ß₧ùß₧╢ß₧ƒß₧╢')) catKey = '3 Languages';
        else if (prog.includes('2_languages') || prog.includes('ßƒó ß₧ùß₧╢ß₧ƒß₧╢')) catKey = '2 Languages';
        else if (prog.includes('1_language') || prog.includes('ßƒí ß₧ùß₧╢ß₧ƒß₧╢')) catKey = '1 Language';
        else if (type.includes('fulltime') || type.includes('ß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä')) catKey = 'Chinese Fulltime';
        else if (type.includes('parttime') || type.includes('ß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä')) catKey = 'Chinese Parttime';
        ...
        const hasDate = s.nextPaymentDate && !['N/A', 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô', ''].includes(s.nextPaymentDate);
    ...
    let html = `<html><head><title>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒåß₧Äß₧╗ß₧¢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</title>
    ...
    <div class="action-bar no-print">
        <a href="javascript:void(0)" onclick="window.close()" class="btn-action btn-home"><i class="fa fa-times-circle"></i> ß₧öß₧╖ß₧æ (Close)</a>
        <button onclick="window.print()" class="btn-action btn-print"><i class="fa fa-print"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û (Print)</button>
    </div>
    ...
    <div class="header-container">
        ...
        <div class="school-text">
            <h1>ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</h1>
            <h2>TIAN XIN INTERNATIONAL SCHOOL</h2>
            <div class="report-badge">ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒåß₧Äß₧╗ß₧¢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Debt Report)</div>
        </div>
        <div class="date-box">
    ...
    <div class="remark-container">
        <div class="remark-line">
            <span class="remark-label">ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï (Note):</span>
            ...
            <button id="btnEdit" onclick="toggleEditRemark()" class="btn-icon no-print" title="ß₧Çßƒéß₧ößƒÆß₧Üßƒé (Edit)">
                <i class="fa fa-pen"></i>
            </button>
            <button id="btnSave" onclick="saveRemark()" class="btn-icon btn-save no-print" style="display:none;" title="ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç (Save)">
    ...
    Object.keys(categories).forEach(catKey => {
        ...
        html += `
            <div class="category-section">
                <div class="section-header ${hdrClass}">
                    ...
                    <div>
                        <span class="badge" style="font-size:12px; color:#555; background:#f8f9fa; border:1px solid #eee; padding:5px 12px; border-radius:30px; margin-right:5px;">ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ: ${count}</span>
        ...
        const renderSubTable = (title, color, list, icon) => {
            ...
            let tbl = `
                <div class="sub-title" style="color:${color}"><i class="${icon}"></i> ${title} <span style="font-size:12px; color:#999; margin-left:5px;">(${list.length} ß₧ôß₧╢ß₧Çßƒï)</span></div>
                <table>
                    <thead>
                        <tr>
                            <th width="40">L.R</th>
                            <th width="70">ID</th>
                            <th style="text-align:left;">ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                            <th width="50">ß₧ùßƒüß₧æ</th>
                            <th width="90">ß₧ÿßƒëßƒäß₧ä</th>
                            <th width="100">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</th>
                            <th width="100">ß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧Åßƒï</th>
                            <th width="100">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                            <th width="90">ß₧çßƒåß₧ûß₧╢ß₧Çßƒï</th>
                        </tr>
                    </thead>
                    <tbody>`;
            ...
            list.forEach((s, idx) => {
                ...
                let badge = '';
                if (color === '#0d6efd') badge = `<span style="color:#0d6efd; background:#e7f1ff; padding:4px 10px; border-radius:50px; font-weight:bold; font-size:11px;">ß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç</span>`;
                else if (color === '#dc3545') badge = `<span style="color:#dc3545; background:#fff5f5; padding:4px 10px; border-radius:50px; font-weight:bold; font-size:11px;">ß₧áß₧╜ß₧ƒ ${Math.abs(days)} ß₧ÉßƒÆß₧äßƒâ</span>`;
                else if (color === '#fd7e14') badge = `<span style="color:#fd7e14; background:#fff9db; padding:4px 10px; border-radius:50px; font-weight:bold; font-size:11px;">ß₧ƒß₧¢ßƒï ${days} ß₧ÉßƒÆß₧äßƒâ</span>`;
                else badge = `<span style="color:#666; background:#f8f9fa; padding:4px 10px; border-radius:50px; font-size:11px;">ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒï</span>`;
                ...
                tbl += `
                    <tr>
                        ...
                        <td>${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</td>
                        <td>${s.studyTime || '-'}</td>
        ...
        html += renderSubTable('ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç (Due Today)', '#0d6efd', cat.groups.today, 'fa fa-calendar-day');
        html += renderSubTable('ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï (Overdue)', '#dc3545', cat.groups.overdue, 'fa fa-exclamation-circle');
        html += renderSubTable('ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ (Upcoming)', '#fd7e14', cat.groups.warning, 'fa fa-clock');
        html += renderSubTable('ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒïß₧òßƒÆß₧ƒßƒüß₧äßƒù (Other Unpaid)', '#6c757d', cat.groups.unpaid, 'fa fa-file-invoice-dollar');
    ...
    <div class="dashboard-grid" style="margin-top: 50px; border-top: 2px dashed #ddd; padding-top: 30px; break-inside: avoid;">
        <div class="stat-card blue">
            ...
            <div class="stat-title">ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç</div>
            <div class="stat-value">${stats.today.count} ß₧ôß₧╢ß₧Çßƒï</div>
            <div class="stat-debt">$${stats.today.amount.toFixed(2)}</div>
        </div>
        <div class="stat-card red">
            <div class="stat-icon"><i class="fa fa-exclamation-triangle"></i></div>
            <div class="stat-title">ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï</div>
            <div class="stat-value">${stats.overdue.count} ß₧ôß₧╢ß₧Çßƒï</div>
            <div class="stat-debt">$${stats.overdue.amount.toFixed(2)}</div>
        </div>
        <div class="stat-card orange">
            <div class="stat-icon"><i class="fa fa-clock"></i></div>
            <div class="stat-title">ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ</div>
            <div class="stat-value">${stats.warning.count} ß₧ôß₧╢ß₧Çßƒï</div>
            <div class="stat-debt">$${stats.warning.amount.toFixed(2)}</div>
        </div>
        <div class="stat-card gray">
            <div class="stat-icon"><i class="fa fa-users"></i></div>
            <div class="stat-title">ß₧ƒß₧Üß₧╗ß₧öß₧Üß₧╜ß₧ÿ</div>
            <div class="stat-value" style="color:#8a0e5b;">${stats.total.count} ß₧ôß₧╢ß₧Çßƒï</div>
    ...
    html += `
        <div style="margin-top: 60px; display: flex; justify-content: space-between; padding: 0 50px; break-inside: avoid;">
            <div style="text-align: center; width: 40%;">
                <p style="font-weight:bold; color:#555;">ß₧ÜßƒÇß₧öß₧àßƒåß₧èßƒäß₧Ö</p>
                <div style="height:60px;"></div>
                <div style="width:180px; border-top:1px solid #bbb; margin:0 auto;"></div>
                <p style="margin-top:8px; font-size:13px; color:#777;">ß₧ößƒüß₧íß₧╢ß₧Çß₧Ü</p>
            </div>
            <div style="text-align: center; width: 40%;">
                <p style="font-weight:bold; color:#555;">ß₧óß₧ôß₧╗ß₧ÿßƒÉß₧Åß₧èßƒäß₧Ö</p>
                <div style="height:60px;"></div>
                <div style="width:180px; border-top:1px solid #bbb; margin:0 auto;"></div>
                <p style="margin-top:8px; font-size:13px; color:#777;">ß₧ôß₧╢ß₧Öß₧Çß₧ƒß₧╢ß₧¢ß₧╢</p>
            </div>
        </div>
...
function generateStandardPDF(students, title, subtitle = '') {
    if (!students || students.length === 0) return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧öß₧äßƒÆß₧Çß₧╛ß₧Åß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒì', 'warning');
    ...
    let html = `<html><head><title>${title}</title>
        ...
        <div class="action-bar no-print">
            <a href="data-tracking.html" class="btn btn-close" onclick="window.close(); return false;">
                <i class="fi fi-rr-arrow-left"></i> ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧æßƒàß₧òßƒÆß₧æß₧╢ßƒåß₧äß₧èß₧╛ß₧ÿ
            </a>
            <button class="btn btn-print" onclick="window.print()">
                <i class="fi fi-rr-print"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧ûß₧»ß₧Çß₧ƒß₧╢ß₧Ü
            </button>
        </div>
        ...
        <div class="header-container">
            ...
            <div class="date-info">
                ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧öß₧ëßƒÆß₧àßƒüß₧ë: ${new Date().toLocaleDateString('en-GB')}
            </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th width="4%">ß₧¢.ß₧Ü</th>
                    <th width="8%">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü</th>
                    <th width="15%">ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                    <th width="5%">ß₧ùßƒüß₧æ</th>
                    <th width="10%">ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ</th>
                    <th width="8%">ß₧Çßƒåß₧Üß₧╖ß₧Åß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                    <th width="8%">ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                    <th width="8%">ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç</th>
                    <th width="8%">ß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧Åßƒï</th>
                    <th width="12%">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</th>
                    <th width="8%">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                     <th width="8%">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧üßƒÆß₧£ßƒç</th>
                </tr>
            </thead>
            <tbody>`;
    ...
    students.forEach((s, index) => {
        ...
        html += `<tr>
            ...
            <td>${s.teacherName || 'ß₧ÿß₧╖ß₧ôß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒï'}</td>
    ...
    html += `
            <tr style="background-color: #f0f0f0; font-weight: bold;">
                <td colspan="11" class="text-right">ß₧ƒß₧Üß₧╗ß₧öß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒéß₧¢ß₧ôßƒàß₧üßƒÆß₧£ßƒç (Total Outstanding):</td>
        ...
        <div class="footer" style="display: flex; justify-content: space-between; padding: 0 50px;">
            <div class="signature-box" style="width: 40%;">
                <p>ß₧ÜßƒÇß₧öß₧àßƒåß₧èßƒäß₧Ö</p>
                <div class="signature-line" style="width: 180px; margin: 0 auto; border-top: 1px solid #333;"></div>
                <p>ß₧ößƒüß₧íß₧╢ß₧Çß₧Ü</p>
            </div>
            <div class="signature-box" style="width: 40%;">
                <p>ß₧óß₧ôß₧╗ß₧ÿßƒÉß₧Åß₧èßƒäß₧Ö</p>
                <div class="signature-line" style="width: 180px; margin: 0 auto; border-top: 1px solid #333;"></div>
                <p>ß₧ôß₧╢ß₧Öß₧Çß₧ƒß₧╢ß₧¢ß₧╢</p>
            </div>
        </div>
...
function downloadMonthlyReport(type) {
    ...
    if (isNaN(month) || isNaN(year) || month < 1 || month > 12) {
        return showAlert('ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ÿß₧╖ß₧ôß₧ÅßƒÆß₧Üß₧╣ß₧ÿß₧ÅßƒÆß₧Üß₧╝ß₧£', 'danger');
    }
    ...
    if (students.length === 0) return showAlert(`ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÇßƒÆß₧ôß₧╗ß₧äß₧üßƒé ${month}/${year}`, 'info');

    const title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé ${month} ß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
    const subtitle = `ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÉßƒÆß₧ÿß₧╕ (New Registrations)`;
...
function downloadYearlyReport(type) {
    ...
    const year = parseInt(promptYear);
    if (isNaN(year)) return showAlert('ß₧åßƒÆß₧ôß₧╢ßƒåß₧ÿß₧╖ß₧ôß₧ÅßƒÆß₧Üß₧╣ß₧ÿß₧ÅßƒÆß₧Üß₧╝ß₧£', 'danger');
    ...
    if (students.length === 0) return showAlert(`ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÇßƒÆß₧ôß₧╗ß₧äß₧åßƒÆß₧ôß₧╢ßƒå ${year}`, 'info');

    const title = `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧åßƒÆß₧ôß₧╢ßƒå ${year}`;
    const subtitle = `ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÉßƒÆß₧ÿß₧╕ (New Registrations)`;
...
function generateDetailedAlertReport() {
    ...
    if (alertStudents.length === 0) return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧çß₧╝ß₧ôß₧èßƒåß₧Äß₧╣ß₧ä (No students to alert)', 'info');

    // 2. Define Categories
    const categories = {
        'chinese_full': { label: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (Chinese Full-time)', students: [], total: 0 },
        'chinese_part': { label: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ôß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (Chinese Part-time)', students: [], total: 0 },
        'lang_1': { label: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒíß₧ùß₧╢ß₧ƒß₧╢ / 1 Language)', students: [], total: 0 },
        'lang_2': { label: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ùß₧╢ß₧ƒß₧╢ (ßƒóß₧ùß₧╢ß₧ƒß₧╢ / 2 Languages)', students: [], total: 0 },
        'lang_3': { label: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà', students: [], total: 0 },
        'other': { label: 'ß₧òßƒÆß₧ƒßƒüß₧äßƒù (Other)', students: [], total: 0 }
    };
    ...
    alertStudents.forEach(s => {
        ...
        if (isStudentChineseFullTime(s)) {
            ...
            if (course.includes('one-language') || course.includes('ßƒíß₧ùß₧╢ß₧ƒß₧╢')) catKey = 'lang_1';
            else if (course.includes('two-languages') || course.includes('ßƒóß₧ùß₧╢ß₧ƒß₧╢')) catKey = 'lang_2';
    ...
    let win = window.open('', '_blank');
    let html = `<html><head><title>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒïß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</title>
        <base href="${window.location.href}">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
        <style>
            @font-face {
        ...
        <div class="action-bar no-print">
            <div class="d-flex align-items-center">
                 <h4><i class="fas fa-file-invoice-dollar me-2"></i>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï</h4>
            </div>
            <div class="d-flex align-items-center">
                 <div class="search-container me-3">
                    <i class="fas fa-search text-muted"></i>
                    <input type="text" id="searchReportInput" class="search-input" onkeyup="searchTable()" placeholder="ß₧ƒßƒÆß₧£ßƒéß₧äß₧Üß₧Çß₧êßƒÆß₧ÿßƒäßƒç/ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü...">
                 </div>
                <a href="data-tracking.html" class="btn btn-back" onclick="window.close(); return false;">
                    <i class="fas fa-home"></i> ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧æßƒàß₧òßƒÆß₧æß₧╢ßƒåß₧äß₧èß₧╛ß₧ÿ
                </a>
                <button class="btn btn-print ms-2" onclick="window.print()">
                    <i class="fas fa-print"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û
                </button>
            </div>
        </div>
        ...
        <div class="content-wrapper">
            <div class="header-container">
                ...
                <div class="report-title">
                    <h2>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒïß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</h2>
                </div>
                <div class="date-info">
                    ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ: ${new Date().toLocaleDateString('en-GB')}
                </div>
                
                <div style="text-align: center; margin-top: 20px;">
                    <div class="summary-card">
                        <h4>ß₧ƒß₧Üß₧╗ß₧öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï</h4>
                        <p>${alertStudents.length} ß₧ôß₧╢ß₧Çßƒï</p>
                    </div>
                     <div class="summary-card">
                        <h4>ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧üßƒÆß₧£ßƒçß₧ƒß₧Üß₧╗ß₧ö</h4>
        ...
        return `
                <div class="section-container">
                    <div class="section-header">
                        ...
                        <span class="badge bg-danger text-white px-2 rounded">${cat.students.length} ß₧ôß₧╢ß₧Çßƒï</span>
                    </div>
                    <table>
                        <thead>
                            <tr>
                                <th width="4%">ß₧¢.ß₧Ü</th>
                                <th width="7%">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü</th>
                                <th width="15%">ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                                <th width="5%">ß₧ùßƒüß₧æ</th>
                                <th width="10%">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</th>
                                <th width="10%">ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                                <th width="8%">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧öß₧äßƒï</th>
                                <th width="8%">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé</th>
                                <th width="12%">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                                <th width="10%">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧üßƒÆß₧£ßƒç</th>
                                <th width="10%">ß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            if (days < 0) {
                statusLabel = `ß₧áß₧╜ß₧ƒ ${Math.abs(days)} ß₧ÉßƒÆß₧äßƒâ`;
                statusClass = "text-danger";
            } else {
                statusLabel = `ß₧çß₧╖ß₧Åß₧èß₧¢ßƒï (${days} ß₧ÉßƒÆß₧äßƒâß₧æßƒÇß₧Å)`;
                statusClass = "text-warning";
            }

            // Override if unpaid but not strictly overdue by date logic (rare but possible if manually set)
            if (statusObj.status === 'paid') statusLabel = "ß₧öß₧╢ß₧ôß₧öß₧äßƒï (Verified)"; // Should not happen due to filter
            ...
            return `
                                <tr>
                                    ...
                                    <td>${s.paymentMonths || 1} ß₧üßƒé</td>
                            ...
                            <tr class="total-row" style="background-color: #ffe6e6; font-weight: bold;">
                                <td colspan="9" class="text-right">ß₧ƒß₧Üß₧╗ß₧öß₧òßƒÆß₧ôßƒéß₧Çß₧ôßƒüßƒç (Subtotal):</td>
...
function generateMonthlyReport() {
    ...
    const monthlyStudents = Object.values(allStudentsData).filter(student => {
        if (!student.startDate || student.startDate === 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô') return false;
        try {
    ...
    if (monthlyStudents.length === 0) {
        return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÇßƒÆß₧ôß₧╗ß₧äß₧üßƒéß₧ôßƒüßƒçß₧æßƒü', 'info');
    }

    monthlyStudents.sort((a, b) => (parseInt(a.displayId) || 0) - (parseInt(b.displayId) || 0));

    let win = window.open('', '_blank');
    let html = `<html><head><title>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé</title>
        <base href="${window.location.href}">
        <style>
        ...
        <div class="header">
            <div class="school-info">
                ...
                <div class="school-name">
                    <h2>ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ (International School)</h2>
                    <p>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÉßƒÆß₧ÿß₧╕ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé</p>
                </div>
            </div>
            <div class="date-info">
                <p>ß₧üßƒé: ${currentMonth}/${currentYear}</p>
                <button class="no-print" onclick="window.print()" style="padding: 8px 20px; background: #2980b9; color: white; border: none; border-radius: 5px; cursor: pointer;">ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û</button>
            </div>
        </div>
        <div class="report-title">
            <h1>ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒçß₧ÉßƒÆß₧ÿß₧╕ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé ${currentMonth} ß₧åßƒÆß₧ôß₧╢ßƒå ${currentYear}</h1>
        </div>
        <table>
            <thead>
                <tr>
                    <th>ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü</th>
                    <th>ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                    <th>ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç</th>
                    <th>ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö ($)</th>
                </tr>
            </thead>
            <tbody>`;
    ...
    html += `</tbody></table>
        <div class="footer">
            <p>ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧ûß₧èßƒäß₧Öß₧ößƒÆß₧Üß₧ûßƒÉß₧ôßƒÆß₧Æß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧äß₧ƒß₧╢ß₧¢ß₧╢ ß₧ôßƒàß₧ÉßƒÆß₧äßƒâß₧æß₧╕ ${new Date().toLocaleString('en-GB')}</p>
        </div>
    </body></html>`;
...
function checkAllPayments() {
    if (!allStudentsData || Object.keys(allStudentsData).length === 0) {
        showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æßƒü', 'info');
        return;
    }
    ...
    if (totalAlerts > 0) {
        showAlert(`ß₧Çß₧╢ß₧Üß₧ûß₧╖ß₧ôß₧╖ß₧ÅßƒÆß₧Ößƒû ${overdueCount} ß₧ôß₧╢ß₧Çßƒïß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï, ${warningCount} ß₧ôß₧╢ß₧Çßƒïß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧Çßƒåß₧Äß₧Åßƒï | ß₧ƒß₧Üß₧╗ß₧öß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧üßƒÆß₧£ßƒç: $${totalDue.toFixed(2)}`, 'warning', 8000);
    } else {
        showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï ß₧¼ß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧Çßƒåß₧Äß₧Åßƒïß₧æßƒü', 'success');
    }
}
...
function getPaymentMethodSelectHtml(selectedValue, nameAttr, classAttr, idAttr, extraAttr = '') {
    ...
    // User requested specifically "ß₧Åß₧╢ß₧ÿß₧Æß₧ôß₧╢ß₧éß₧╢ß₧Ü (Bank)" and "ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ƒß₧╗ß₧æßƒÆß₧Æ (Cash)"
    const methods = [
        { value: "Cash", label: "ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ƒß₧╗ß₧æßƒÆß₧Æ (Cash)" },
        { value: "Bank", label: "ß₧Åß₧╢ß₧ÿß₧Æß₧ôß₧╢ß₧éß₧╢ß₧Ü (Bank)" }
    ];
...
window.refreshData = function () {
    loadStudentData();
    showAlert('ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧ÆßƒÆß₧£ß₧╛ß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ôß₧ùß₧╢ß₧ûß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï (Data updated successfully)', 'success');
};
...
$(document).ready(function () {
    ...
    $('#clearFiltersBtn').on('click', function () {
        ...
        $('#endDateFilter').val('');
        renderFilteredTable();
        showAlert('ß₧öß₧╢ß₧ôß₧ƒß₧ÿßƒÆß₧óß₧╢ß₧Åß₧Çß₧╢ß₧Üß₧ƒßƒÆß₧£ßƒéß₧äß₧Üß₧Ç', 'info');
    });
    ...
    console.log('Γ£à Data Tracking System Successfully Loaded');
    ...
    */
        ...
        <body>
            ...
            <div class="pos-receipt-paper">
                ...
                <div class="header-row">
                    ...
                    <div class="text-col">
                        <div class="school-kh">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ô ß₧ƒßƒèß₧╕ß₧ô</div>
                        <div class="school-en">TIAN XIN INTERNATIONAL SCHOOL</div>
                        <div class="contact">ß₧ƒß₧╢ß₧üß₧╢ß₧æß₧╕ßƒó ß₧ùß₧╝ß₧ÿß₧╖ß₧ÇßƒÆß₧Üß₧╢ßƒåß₧ä ß₧ƒß₧äßƒÆß₧Çß₧╢ß₧Åßƒïß₧ÇßƒÆß₧Üß₧╢ßƒåß₧äß₧óßƒåß₧ûß₧╖ß₧¢ ß₧ÇßƒÆß₧Üß₧╗ß₧äß₧Çßƒåß₧ûß₧Å ß₧üßƒüß₧ÅßƒÆß₧Åß₧Çßƒåß₧ûß₧Å<br>Tel: 093 83 56 78</div>
                    </div>
                    <div class="meta-col">
                        <div class="receipt-badge">
                            <div class="receipt-title-kh">ß₧£ß₧╖ß₧ÇßƒÆß₧Çß₧Öß₧öß₧ÅßƒÆß₧Ü</div>
                ...
                <div class="content-grid">
                    <div class="left-panel">
                        <div style="font-weight:bold; font-size:10pt; color:#d63384; border-bottom:1px solid #eee; margin-bottom:5px;">
                            <i class="fa fa-user-graduate"></i> ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ
                        </div>
                        <table>
                            <tr><td class="info-label">ß₧êßƒÆß₧ÿßƒäßƒç / Name:</td><td class="info-val">${s.lastName} ${s.firstName}</td></tr>
                            <tr><td class="info-label">ß₧ùßƒüß₧æ / Gender:</td><td class="info-val">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ (M)' : 'ß₧ƒßƒÆß₧Üß₧╕ (F)'}</td></tr>
                            <tr><td class="info-label">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å / Level:</td><td class="info-val">${s.studyLevel || '-'}</td></tr>
                            <tr><td class="info-label">ß₧ÿßƒëßƒäß₧ä / Time:</td><td class="info-val">${formatStudyTimeKhmer(s.studyTime)}</td></tr>
                            <tr><td class="info-label" style="color:#0d6efd">ß₧ÉßƒÆß₧äßƒâß₧àß₧╝ß₧¢ / Start:</td><td class="info-val" style="color:#0d6efd">${convertToKhmerDate(s.startDate) || '-'}</td></tr>
                            <tr><td class="info-label">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé / Paid:</td><td class="info-val">${s.paymentMonths || '0'} ß₧üßƒé</td></tr>
                            <tr><td class="info-label" style="color:#dc3545">ß₧òß₧╗ß₧Åß₧Çßƒåß₧Äß₧Åßƒï / Due:</td><td class="info-val" style="color:#dc3545">${convertToKhmerDate(s.nextPaymentDate || s.paymentDueDate) || '-'}</td></tr>
                        </table>
                    </div>
                    ...
                    <div class="right-panel">
                        <table class="invoice-table">
                            <thead>
                                <tr><th>ß₧öß₧Üß₧╖ß₧Öß₧╢ß₧Ö (Description)</th><th width="30%">ß₧Åß₧ÿßƒÆß₧¢ßƒâ (Price)</th></tr>
                            </thead>
                            <tbody>
                                <tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ / Tuition Fee</td><td>$${(parseFloat(s.tuitionFee) || 0).toFixed(2)}</td></tr>
                                ${(parseFloat(s.registrationFee) || 0) > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç / Registration</td><td>$${(parseFloat(s.registrationFee) || 0).toFixed(2)}</td></tr>` : ''}
                                ${(parseFloat(s.bookFee) || 0) > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧ƒßƒÇß₧£ß₧ùßƒà / Book Fee</td><td>$${(parseFloat(s.bookFee) || 0).toFixed(2)}</td></tr>` : ''}
                                ${(parseFloat(s.fulltimeBookFee) || 0) > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧ƒßƒÇß₧£ß₧ùßƒàß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä / FT Book</td><td>$${(parseFloat(s.fulltimeBookFee) || 0).toFixed(2)}</td></tr>` : ''}
                                ${(parseFloat(s.uniformFee) || 0) > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧»ß₧Çß₧ƒß₧ÄßƒÆß₧ïß₧╢ß₧ô / Uniform</td><td>$${(parseFloat(s.uniformFee) || 0).toFixed(2)}</td></tr>` : ''}
                                ${(parseFloat(s.adminServicesFee) || 0) > 0 ? `<tr><td>ß₧ƒßƒüß₧£ß₧╢ß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢ / Admin Service</td><td>$${(parseFloat(s.adminServicesFee) || 0).toFixed(2)}</td></tr>` : ''}
                            ...
                            <tfoot>
                                <tr class="total-row"><td>ß₧ƒß₧Üß₧╗ß₧öß₧Üß₧╜ß₧ÿ / TOTAL:</td><td>$${totalUSD.toFixed(2)}</td></tr>
                                <tr style="color:#198754; font-weight:bold;"><td>ß₧öß₧╢ß₧ôß₧öß₧äßƒï / PAID:</td><td align="right">$${paidUSD.toFixed(2)}</td></tr>
                                <tr style="color:#dc3545; font-weight:bold;"><td>ß₧ôßƒàß₧üßƒÆß₧£ßƒç / BALANCE:</td><td align="right">$${remainingUSD.toFixed(2)}</td></tr>
                            </tfoot>
                        </table>
                    </div>
                </div>
                ...
                <div class="footer-row">
                    <div class="footer-note">
                        <div style="font-weight:bold; text-decoration:underline;">ß₧àßƒåß₧Äß₧╢ßƒå / Note:</div>
                        <div>1. ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧Üß₧╜ß₧à ß₧ÿß₧╖ß₧ôß₧óß₧╢ß₧àß₧èß₧Çß₧£ß₧╖ß₧ëß₧öß₧╢ß₧ôß₧æßƒü (Paid money is non-refundable)</div>
                        <div>2. ß₧ƒß₧╝ß₧ÿß₧ûß₧╖ß₧ôß₧╖ß₧ÅßƒÆß₧Öß₧öß₧äßƒÆß₧Çß₧╢ß₧ôßƒïß₧èßƒâß₧ÿß₧╗ß₧ôß₧àß₧╢ß₧Çß₧àßƒüß₧ë (Check receipt before leaving)</div>
                        <div>3. ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧ÿß₧╢ß₧ôß₧öß₧äßƒÆß₧Çß₧╢ß₧ôßƒïß₧èßƒâß₧ûß₧╕ Reception (Receipt required)</div>
                        <div style="margin-top:5px; font-style:italic; font-size:7pt; color:#999;">Printed: ${receiptDate}</div>
                    </div>
                    <div class="footer-sig">
                        <div class="sig-box">
                            <div class="sig-label">ß₧óßƒÆß₧ôß₧Çß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï / Payer</div>
                            <div class="sig-line"></div>
                        </div>
                        <div class="sig-box">
                            <div class="sig-label">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ / Receiver</div>
                            <div class="sig-line"></div>
                        </div>
                    </div>
                </div>
    ...
    function printInstallmentReceipt(key, index) {
        ...
        if (!inst) {
            return showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧àßƒåß₧Äß₧╢ß₧Öß₧ôßƒüßƒçß₧æßƒü', 'danger');
        }
        ...
        <body>
            ...
            <div class="receipt">
                ...
                <div class="title">ß₧öß₧äßƒÆß₧Çß₧╢ß₧ôßƒïß₧èßƒâß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï / RECEIPT</div>

                <div class="info-grid">
                    <div class="info-item"><div class="info-label">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü/ID:</div><div class="info-val">${s.displayId}</div></div>
                    <div class="info-item"><div class="info-label">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ/Date:</div><div class="info-val">${receiptDate}</div></div>
                    <div class="info-item"><div class="info-label">ß₧êßƒÆß₧ÿßƒäßƒç/Name:</div><div class="info-val">${s.lastName} ${s.firstName}</div></div>
                    <div class="info-item"><div class="info-label">ß₧ùßƒüß₧æ/Gender:</div><div class="info-val">${s.gender}</div></div>
                </div>

                <table>
                    <thead>
                        <tr>
                            <th>ß₧öß₧Üß₧╖ß₧Öß₧╢ß₧Ö (Description)</th>
                            <th width="30%">ß₧Åß₧ÿßƒÆß₧¢ßƒâ (Amount)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="text-align: left;">
                                ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧æß₧╕ ${inst.stage} (Payment Stage ${inst.stage})<br>
                        ...
                        <tr>
                            <td colspan="2" style="border: none; text-align: left;">
                                <small>ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ (Received By): ${inst.receiver || '-'}</small>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="total-row">
                    <table>
                        <tr>
                            <td style="border:none; text-align:right;">ß₧ƒß₧Üß₧╗ß₧ö (Total):</td>
                ...
                <div class="footer">
                    <div>
                        <div class="sig-line"></div>
                        <div>ß₧áß₧ÅßƒÆß₧Éß₧¢ßƒüß₧üß₧╢ß₧óßƒÆß₧ôß₧Çß₧öß₧äßƒï<br>Payer Signature</div>
                    </div>
                    <div>
                        <div class="sig-line"></div>
                        <div>ß₧áß₧ÅßƒÆß₧Éß₧¢ßƒüß₧üß₧╢ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢<br>Receiver Signature</div>
                    </div>
                </div>
            </div>
        </body>
    ...
    function printPaymentHistory(key) {
        ...
        if (s.initialPayment > 0) {
            ...
            rows += `
                <tr>
                    <td>1</td>
                    <td>${s.startDate || '-'}</td>
                    <td>ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧ä</td>
            ...
            list.forEach(inst => {
                ...
                rows += `
                    <tr>
                        ...
                        <td>${inst.status === 'paid' ? 'ß₧öß₧äßƒïß₧Üß₧╜ß₧à' : 'ß₧öß₧äßƒïß₧Üßƒåß₧¢ß₧ƒßƒï/ß₧çßƒåß₧ûß₧╢ß₧Çßƒï'}</td>
        ...
        <body>
            <h2>ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ô ß₧ƒßƒèß₧╕ß₧ô</h2>
            <h3>ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Payment History)</h3>
            
            <div class="info-box">
                <b>ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü/ID:</b> ${s.displayId} <br>
                <b>ß₧êßƒÆß₧ÿßƒäßƒç/Name:</b> ${s.lastName} ${s.firstName} <br>
                <b>ß₧£ß₧éßƒÆß₧éß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢/Course:</b> ${s.studyType || '-'}
            </div>

            <table>
                <thead>
                    <tr>
                        <th>ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ (Stage)</th>
                        <th>ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ (Date)</th>
                        <th>ß₧öß₧Üß₧╖ß₧Öß₧╢ß₧Ö (Description)</th>
                        <th>ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Amount)</th>
                        <th>ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ (Receiver)</th>
                    </tr>
                </thead>
                <tbody>
                    ${rows}
            ...
            <div class="summary">
                <div>ß₧Åß₧ÿßƒÆß₧¢ßƒâß₧£ß₧éßƒÆß₧éß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧ƒß₧Üß₧╗ß₧ö: $${totalFee.toFixed(2)}</div>
                <div>ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧ƒß₧Üß₧╗ß₧ö: $${totalPaid.toFixed(2)}</div>
                <div style="color: ${remaining > 0 ? 'red' : 'green'};">ß₧ôßƒàß₧üßƒÆß₧£ßƒç: $${remaining.toFixed(2)}</div>
            </div>
    ...
    /* ß₧Çß₧╝ß₧è Filter "ß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç" */
    ...
    window.filterPaidOffData = () => {
        ...
        renderFilteredTable();
        showAlert('ß₧Çßƒåß₧ûß₧╗ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧èßƒéß₧¢ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï 100%', 'success');
    };
    ...
    window.exportTodayDuePDF = () => {
        ...
        if (todayDue.length === 0) {
            return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ôßƒàß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒçß₧æßƒü', 'info');
        }

        generateStudentListPDF(todayDue, 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç (Students Due Today)');
    };
    ...
    const buildDynamicTitle = (base, category = 'all') => {
        ...
        if (category !== 'all') {
            const catMap = {
                'chinese-fulltime': 'ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (Full-time)',
                'part-time': 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (Part-time)',
                'trilingual': 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà'
            };
            details.push(catMap[category] || category);
        }

        if (currentFilters.filterClassTeacher !== 'all') details.push(`ß₧éßƒÆß₧Üß₧╝ßƒû ${currentFilters.filterClassTeacher}`);
        if (currentFilters.filterTime !== 'all') details.push(`ß₧ÿßƒëßƒäß₧äßƒû ${currentFilters.filterTime}`);
        if (currentFilters.filterLevel !== 'all') details.push(`ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Åßƒû ${currentFilters.filterLevel}`);
        if (currentFilters.searchName) details.push(`ß₧ƒßƒÆß₧£ßƒéß₧äß₧Üß₧Çßƒû "${currentFilters.searchName}"`);
    ...
    window.exportCurrentViewPDF = (category = 'all') => {
        ...
        if (students.length === 0) return showAlert('ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ôß₧╢ßƒåß₧àßƒüß₧ëß₧æßƒü!', 'warning');
        generateStudentListPDF(students, buildDynamicTitle('ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧öß₧ëßƒÆß₧çß₧╕ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ', category));
    };
    ...
    window.exportPaymentReportPDF = (type) => {
        ...
        switch (type) {
            case 'today':
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç';
                subtitle = 'Students Due Today';
                filterFn = (s) => checkStatus(s, 'today');
                break;
            case 'overdue':
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï';
                subtitle = 'Overdue Students';
                filterFn = (s) => checkStatus(s, 'overdue');
                break;
            case 'warning':
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒï';
                subtitle = 'Close to Due (Within 10 Days)';
                filterFn = (s) => checkStatus(s, 'warning');
                break;
            case 'delay':
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Ü';
                subtitle = 'Postponed / Priority Delay';
                filterFn = (s) => checkStatus(s, 'delay');
                break;
            case 'debt':
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧çßƒåß₧ûß₧╢ß₧Çßƒï';
            ...
            case 'pending':
                ...
                title = 'ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧öß₧äßƒï';
        ...
        if (filtered.length === 0) {
            return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧ôßƒüßƒçß₧æßƒü (No data found)', 'info');
        }
    ...
    window.generateStudentListPDF = async (students, title, subtitle = '') => {
        ...
        let html = `<html><head><title>${title}</title>
            ...
            <div class="no-print">
                <span class="fw-bold">ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧öß₧äßƒÆß₧Çß₧╛ß₧Åß₧çßƒäß₧éß₧çßƒÉß₧Ö</span>
                <button class="btn" onclick="window.print()">ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û (Print)</button>
            </div>
            <div class="header">
                <img src="img/1.jpg" class="logo" onerror="this.src='img/logo.jpg'">
                <div class="school-info">
                    <div class="school-name">
                        ...
                        <h2>ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</h2>
                    </div>
                </div>
                <div class="report-title">
                    <h2>${title}</h2>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th width="8%">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü</th>
                        <th>ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                        <th width="6%">ß₧ùßƒüß₧æ</th>
                        <th width="8%">ß₧Çßƒåß₧Üß₧╖ß₧Å</th>
                        <th width="8%">ß₧ÿßƒëßƒäß₧ä</th>
                        <th width="10%">ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç</th>
                        <th width="10%">ß₧ÉßƒÆß₧äßƒâß₧Çßƒåß₧Äß₧Åßƒï</th>
                        <th width="10%">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Ç</th>
                        <th width="10%">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                        <th width="8%">ß₧çßƒåß₧ûß₧╢ß₧Çßƒï</th>
                    </tr>
                </thead>
                <tbody>
                    ${rows}
                    <tr style="background: #f1f1f1; font-weight: bold;">
                        <td colspan="11" class="text-right">ß₧ƒß₧Üß₧╗ß₧öß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧üßƒÆß₧£ßƒç (Total Due):</td>
            ...
            <div class="footer" style="display: flex; justify-content: space-between; padding: 0 40px;">
                <div class="signature-box" style="width: 45%;">
                    <div class="fw-bold">ß₧óßƒÆß₧ôß₧Çß₧ÜßƒÇß₧öß₧àßƒå (Prepared By)</div>
                    <div class="signature-line"></div>
                </div>
                <div class="signature-box" style="width: 45%;">
                    <div class="fw-bold">ß₧ôß₧╢ß₧Öß₧Çß₧ƒß₧╢ß₧¢ß₧╢ (Principal)</div>
                    <div class="signature-line"></div>
                </div>
            </div>
        </body></html>`;
    ...
    window.generatePostponedReportPDF = async (students, title, subtitle = '') => {
        ...
        let html = `<html><head><title>${title}</title>
            ...
            <div class="no-print">
                <span class="fw-bold" style="color: #8a0e5b;"><i class="fi fi-rr-check-circle"></i> ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï ß₧ÜßƒÇß₧öß₧àßƒåß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒïß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û ß₧¼ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç</span>
                <button class="btn" onclick="window.print()">ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û (Print / Save as PDF)</button>
            </div>
            <div class="header">
                <img src="img/1.jpg" class="logo" onerror="this.src='img/logo.jpg'">
                <div class="school-info">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                        <th width="5%">ß₧ùßƒüß₧æ</th>
                        <th width="8%">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å</th>
                        <th width="10%">ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Ç</th>
                        <th width="9%">ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧êßƒÆß₧ÿßƒäßƒç</th>
                        <th width="9%">ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï</th>
                        <th width="10%">ß₧öß₧äßƒïß₧ôßƒàß₧ÉßƒÆß₧äßƒâ</th>
                        <th width="12%">ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗/ß₧àßƒåß₧Äß₧╢ßƒå</th>
                        <th width="8%">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</th>
                    </tr>
                </thead>
                <tbody>
                    ${rows}
                    <tr style="background: #f1f1f1; font-weight: bold;">
                        <td colspan="11" class="text-right">ß₧ƒß₧Üß₧╗ß₧öß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Total Due):</td>
                        <td class="text-right text-danger">$${totalDueAmount.toFixed(2)}</td>
                    </tr>
                </tbody>
            </table>
    ...
    window.exportTrilingualPartTimeOutTimeReport = async () => {
        ...
        if (students.length === 0) {
            return showAlert('ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (ß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà) ß₧Åß₧╢ß₧ÿß₧Çß₧╢ß₧Üß₧àß₧ÿßƒÆß₧Üßƒäßƒçß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ôß₧æßƒü!', 'warning');
        }

        // Helper to extract out time from "7:00 - 9:00" format
        const getOutTime = (timeStr) => {
            if (!timeStr || ['N/A', '-', ''].includes(timeStr)) return 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ÿßƒëßƒäß₧ä';
        ...
        const groupedData = {};
        students.forEach(s => {
            const teacher = (s.teacherName || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧éßƒÆß₧Üß₧╝').trim();
        ...
        const title = "ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àßƒüß₧ëß₧ÿßƒëßƒäß₧ä (ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà)";
        let filterStatus = [];
        if (currentFilters.filterClassTeacher !== 'all') filterStatus.push(`ß₧éßƒÆß₧Üß₧╝ßƒû ${currentFilters.filterClassTeacher}`);
        if (currentFilters.filterTime !== 'all') filterStatus.push(`ß₧ÿßƒëßƒäß₧äßƒû ${currentFilters.filterTime}`);
        ...
        teachers.forEach((teacher, tIdx) => {
            ...
            sectionsHtml += `<div class="${sectionClass}">
                <div class="teacher-header">
                    <i class="fi fi-rr-chalkboard-user"></i> ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïßƒû ${teacher}
                </div>`;
            ...
            outTimes.forEach(time => {
                ...
                let rows = timeStudents.map((s, idx) => `
                    <tr>
                        ...
                        <td class="text-left">${s.lastName || ''} ${s.firstName || ''}</td>
                        <td width="8%">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</td>
                ...
                sectionsHtml += `
                    <div class="time-subsection">
                        <div class="time-header">ß₧ÿßƒëßƒäß₧äß₧àßƒüß₧ëßƒû ${time} (ß₧àßƒåß₧ôß₧╜ß₧ô ${timeStudents.length} ß₧ôß₧╢ß₧Çßƒï)</div>
                        <table>
                            <thead>
                                <tr>
                                    <th>ß₧¢.ß₧Ü</th>
                                    ...
                                    <th>ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</th>
                                    <th>ß₧ùßƒüß₧æ</th>
                                    <th>ß₧ÿßƒëßƒäß₧äß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                                    <th>ß₧ÿßƒëßƒäß₧äß₧àßƒüß₧ë</th>
                                    <th>ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å</th>
                                    <th>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ƒß₧╗ß₧üß₧ùß₧╢ß₧û/ß₧òßƒÆß₧ƒßƒüß₧äßƒù</th>
                                </tr>
                            </thead>
                            <tbody>
                                ${rows}
        ...
        let html = `<html><head><title>${title}</title>
            ...
            <div class="no-print">
                <span class="fw-bold" style="color: #8a0e5b;"><i class="fi fi-rr-check-circle"></i> ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àßƒüß₧ëß₧ÿßƒëßƒäß₧ä ß₧ÜßƒÇß₧öß₧àßƒåß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒïß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧æß₧╢ß₧ëß₧çß₧╢ PDF ß₧¼ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û</span>
                <button class="btn" onclick="window.print()"><i class="fi fi-rr-print"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û (Print / Save as PDF)</button>
            </div>
            <div class="header">
                <img src="img/1.jpg" class="logo" onerror="this.src='img/logo.jpg'">
                <div class="school-info">
    ...
    window.downloadClassTeacherReport = (format) => {
        if (currentFilters.filterClassTeacher === 'all') {
            return showAlert('ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Çß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧çß₧╢ß₧ÿß₧╗ß₧ôß₧ƒß₧╖ß₧ô!', 'warning');
        }

        const filteredStudents = filterStudents(rawStudentsArray);
        if (filteredStudents.length === 0) {
            return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧éßƒÆß₧Üß₧╝ß₧ôßƒüßƒçß₧æßƒü!', 'warning');
        }
        ...
        if (format === 'excel') {
            ...
            generateStudentListPDF(filteredStudents, `ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (ß₧éßƒÆß₧Üß₧╝ßƒû ${teacherName})`, `Teacher: ${teacherName}`);
        }
    };
    ...
    window.printPaymentHistory = function (studentKey) {
        ...
        let rowsHtml = installments.map((inst, idx) => `
            <tr>
                ...
                <td style="text-align:center;">${inst.months || '-'} ß₧üßƒé</td>
        ...
        <body>
            ...
            <div class="header">
                <div class="school-name">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ô ß₧ƒßƒèß₧╕ß₧ô</div>
                <div style="font-size: 14px; font-weight: bold;">TIAN XIN INTERNATIONAL SCHOOL</div>
                <div class="report-title" style="margin-top:20px;">ß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Payment History)</div>
            </div>

            <div class="student-info">
                <div class="info-item"><span class="label">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü / ID:</span> <b>${s.displayId}</b></div>
                <div class="info-item"><span class="label">ß₧êßƒÆß₧ÿßƒäßƒç / Name:</span> <b>${s.lastName} ${s.firstName}</b></div>
                <div class="info-item"><span class="label">ß₧ùßƒüß₧æ / Gender:</span> <b>${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</b></div>
                <div class="info-item"><span class="label">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å / Level:</span> <b>${s.studyLevel || '-'}</b></div>
                <div class="info-item"><span class="label">ß₧ÿßƒëßƒäß₧ä / Time:</span> <b>${s.studyTime || '-'}</b></div>
            </div>

            <table>
                <thead>
                    <tr>
                        <th width="10%">ß₧èßƒåß₧Äß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢<br>(Stage)</th>
                        <th width="20%">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ<br>(Date)</th>
                        <th width="15%">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï<br>(Amount)</th>
                        <th width="15%">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé<br>(Months)</th>
                        <th width="20%">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢<br>(Receiver)</th>
                        <th width="20%">ß₧òßƒÆß₧ƒßƒüß₧äßƒù<br>(Note)</th>
                    </tr>
                </thead>
                <tbody>
                    ${rowsHtml}
    ...
    window.printPaymentReceipt = function (studentKey, index) {
        ...
        if (!inst) return showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï', 'error');
            ...
            <div class="pos-receipt-paper">
                ...
                <div class="content-grid">
                    <div class="left-panel">
                        ...
                        <table>
                            ...
                            <tr><td class="info-label">ß₧ùßƒüß₧æ / Gender:</td><td class="info-val">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ (M)' : 'ß₧ƒßƒÆß₧Üß₧╕ (F)'}</td></tr>
                            <tr><td class="info-label">ß₧Çß₧ÿßƒÆß₧Üß₧╖ß₧Å / Level:</td><td class="info-val">${s.studyLevel || '-'}</td></tr>
                            <tr><td class="info-label">ß₧ÿßƒëßƒäß₧ä / Time:</td><td class="info-val">${s.studyTime || '-'}</td></tr>
                            <tr><td class="info-label" style="color:#0d6efd">ß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒï / Date:</td><td class="info-val" style="color:#0d6efd">${convertToKhmerDate(inst.date) || '-'}</td></tr>
                            <tr><td class="info-label">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé / Months:</td><td class="info-val">${inst.months || '1'} ß₧üßƒé</td></tr>
                        </table>
                    </div>
                    ...
                    <div class="right-panel">
                        <table class="invoice-table">
                            ...
                            <tbody>
                                <tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Tuition Fee)</td><td>$${amount.toFixed(2)}</td></tr>
                                ${inst.materialFee > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧ÿßƒÆß₧ùß₧╢ß₧Üßƒê (Material Fee)</td><td>$${parseFloat(inst.materialFee).toFixed(2)}</td></tr>` : ''}
                                ${inst.adminServicesFee > 0 ? `<tr><td>ß₧ÉßƒÆß₧¢ßƒâß₧Üß₧èßƒÆß₧ïß₧öß₧╢ß₧¢ (Admin Fee)</td><td>$${parseFloat(inst.adminServicesFee).toFixed(2)}</td></tr>` : ''}
                                ${inst.discountPercent > 0 ? `<tr style="color:#d63384; font-style:italic;"><td>ß₧Çß₧╢ß₧Üß₧öß₧ëßƒÆß₧àß₧╗ßƒçß₧Åß₧ÿßƒÆß₧¢ßƒâ (Discount ${inst.discountPercent}%)</td><td>-$${(amount * inst.discountPercent / 100).toFixed(2)}</td></tr>` : ''}
                                ${inst.discountDollar > 0 ? `<tr style="color:#d63384; font-style:italic;"><td>ß₧Çß₧╢ß₧Üß₧öß₧ëßƒÆß₧àß₧╗ßƒçß₧Åß₧ÿßƒÆß₧¢ßƒâ (Discount)</td><td>-$${parseFloat(inst.discountDollar).toFixed(2)}</td></tr>` : ''}
                                ${inst.note ? `<tr><td style="font-style:italic; font-size:8pt; color:#666;">* ${inst.note}</td><td></td></tr>` : ''}
                            </tbody>
                            <tfoot>
                                <tr class="total-row"><td>ß₧ƒß₧Üß₧╗ß₧öß₧öß₧äßƒï / TOTAL PAID:</td><td>$${(() => {
                ...
                <div class="footer-row">
                    ...
                    <div class="footer-sig">
                        ...
                        <div class="sig-box">
                            <div class="sig-label">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ / Receiver (User: ${inst.receiver || '-'})</div>
                            <div class="sig-line"></div>
                        </div>
                    </div>
                </div>
...
// DUPLICATE NAME CHECKER
// ==========================================
/* ß₧Çß₧╝ß₧è "ß₧êßƒÆß₧ÿßƒäßƒçß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢" */
window.checkDuplicateNames = () => {
    ...
    if (dups.length === 0) return showAlert('ß₧éßƒÆß₧ÿß₧╢ß₧ôß₧êßƒÆß₧ÿßƒäßƒçß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢ß₧æßƒü', 'success');
    ...
    dups.forEach(k => {
        html += `<div style="margin-bottom:10px; border-bottom:1px solid #eee;">
                    ...
                    ${groups[k].map(s => `<br> - ID: ${s.displayId} (ß₧ÿßƒëßƒäß₧ä: ${s.studyTime})`).join('')}
                 </div>`;
    });
    Swal.fire({ title: 'ß₧êßƒÆß₧ÿßƒäßƒçß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢', html: html, icon: 'warning' });
};
...
window.checkMissingChineseNames = () => {
    // ß₧ÅßƒÆß₧Üß₧äß₧Öß₧Çß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧èßƒéß₧¢ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧êßƒÆß₧ÿßƒäßƒçß₧ùß₧╢ß₧ƒß₧╢ß₧àß₧╖ß₧ô (ß₧æß₧╢ßƒåß₧äß₧ôß₧╢ß₧ÿß₧üßƒÆß₧¢ß₧╜ß₧ô ß₧ôß₧╖ß₧äß₧ôß₧╢ß₧ÿß₧ÅßƒÆß₧Üß₧Çß₧╝ß₧¢)
    ...
    if (missing.length === 0) {
        return Swal.fire({
            title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö!',
            text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒïß₧ÿß₧╢ß₧ôß₧êßƒÆß₧ÿßƒäßƒçß₧àß₧╖ß₧ôß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒïß₧áß₧╛ß₧Ö',
            icon: 'success'
        });
    }
    ...
    let html = `
        <div class="alert alert-info py-2 mb-3 text-start">
            <i class="fi fi-rr-info me-2"></i> ß₧Üß₧Çß₧âß₧╛ß₧ëß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ <b>${missing.length}</b> ß₧ôß₧╢ß₧Çßƒïß₧èßƒéß₧¢ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧êßƒÆß₧ÿßƒäßƒçß₧àß₧╖ß₧ôßƒö
        </div>
            ...
            <div style="margin-bottom:12px; border-bottom:1px solid #f0f0f0; padding-bottom:8px; display:flex; justify-content:between; align-items:center;">
                <div style="flex-grow:1;">
                    ...
                    <div class="mt-1" style="font-size:0.75rem; color:#666;">
                        <i class="fi fi-rr-clock me-1"></i>ß₧ÿßƒëßƒäß₧ä: ${s.studyTime || 'N/A'} | 
                        <i class="fi fi-rr-user me-1"></i>ß₧éßƒÆß₧Üß₧╝: ${s.teacherName || 'N/A'}
                    </div>
                </div>
    ...
    Swal.fire({
        title: '<span style="font-family: Kantumruy Pro;">ß₧ûß₧╖ß₧ôß₧╖ß₧ÅßƒÆß₧Öß₧êßƒÆß₧ÿßƒäßƒçß₧èßƒéß₧¢ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧êßƒÆß₧ÿßƒäßƒçß₧àß₧╖ß₧ô</span>',
        html: html,
        icon: 'warning',
        width: '600px',
        confirmButtonText: 'ß₧Öß₧¢ßƒïß₧ûßƒÆß₧Üß₧ÿ',
...
function editPayment(key, index) {
    ...
    if (index === 'initial') {
        paymentData = {
            ...
            receiver: s.initialReceiver || 'System',
            paymentMethod: 'Cash',
            note: 'Initial Payment / ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧ä'
        };
    } else {
        const installs = Array.isArray(s.installments) ? s.installments : Object.values(s.installments);
    ...
    if (!paymentData || (paymentData.amount === undefined && !paymentData.date)) return showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï', 'danger');
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                <div class="modal-header bg-warning text-dark border-0">
                    <h5 class="modal-title fw-bold"><i class="fi fi-rr-edit me-2"></i>ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Edit Payment)</h5>
                ...
                <div class="modal-body p-4 bg-light">
                    <form id="editPaymentForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold small text-muted">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ (Date)</label>
                            <input type="text" class="form-control" id="editPayDate" value="${paymentData.date || ''}" placeholder="DD-Month-YYYY or YYYY-MM-DD">
                        </div>
                        <div class="row g-3 mb-3">
                             <div class="col-6">
                                <label class="form-label fw-bold small text-success">ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï ($)</label>
                                <input type="number" step="0.01" class="form-control fw-bold text-success" id="editPayAmount" value="${paymentData.amount || 0}">
                             </div>
                             <div class="col-6">
                                <label class="form-label fw-bold small text-muted">ß₧àßƒåß₧ôß₧╜ß₧ôß₧üßƒé</label>
                                <input type="text" class="form-control" id="editPayMonths" value="${paymentData.months || ''}">
                             </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold small text-muted">ß₧óßƒÆß₧ôß₧Çß₧æß₧æß₧╜ß₧¢ (Receiver)</label>
                            <input type="text" class="form-control" id="editPayReceiver" value="${paymentData.receiver || ''}">
                        </div>
                         <div class="mb-3">
                            <label class="form-label fw-bold small text-muted">ß₧àßƒåß₧Äß₧╢ßƒå (Note)</label>
                            <input type="text" class="form-control" id="editPayNote" value="${paymentData.note || ''}">
                        </div>
                         <div class="alert alert-info small py-2 mb-0">
                            <i class="fi fi-rr-info me-1"></i> ${index === 'initial' ? 'ß₧ôßƒüßƒçß₧çß₧╢ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧èßƒåß₧öß₧╝ß₧ä (First Payment)' : 'ß₧ôßƒüßƒçß₧çß₧╢ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧àß₧╢ßƒå (Additional Payment)'}
                        </div>
                    </form>
                </div>
                <div class="modal-footer border-0 bg-white p-3" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">ß₧ößƒäßƒçß₧öß₧äßƒï</button>
                    <button type="button" class="btn btn-warning fw-bold shadow-sm" onclick="savePaymentEdit()">
                        <i class="fi fi-rr-disk me-2"></i>ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç
                    </button>
                </div>
            </div>
        </div>
...
function savePaymentEdit() {
    ...
    if (isNaN(amount)) return showAlert('ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ÅßƒÆß₧Üß₧╣ß₧ÿß₧ÅßƒÆß₧Üß₧╝ß₧£', 'warning');
    ...
    studentsRef.child(key).update(updateData)
        .then(async () => {
            ...
            showAlert('ß₧Çßƒéß₧ößƒÆß₧Üßƒéß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
        ...
        .catch(e => {
            console.error(e);
            showAlert('ß₧öß₧Üß₧╢ß₧çßƒÉß₧Ö: ' + e.message, 'danger');
        })
        .finally(() => showLoading(false));
}

function deletePayment(key, index) {
    if (!confirm('ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ûß₧╖ß₧Åß₧çß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ôßƒüßƒçß₧¼? \n(Are you sure you want to delete this payment?)')) return;
    ...
    if (index === 'initial') {
        ...
        studentsRef.child(key).update({
            ...
            showAlert('ß₧¢ß₧╗ß₧öß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧èßƒåß₧öß₧╝ß₧äß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
            viewStudentDetails(key);
            renderFilteredTable();
        }).catch(e => {
            showAlert('ß₧öß₧Üß₧╢ß₧çßƒÉß₧Ö: ' + e.message, 'danger');
        ...
        if (installments[idx]) {
            ...
            studentsRef.child(key).child('installments').set(installments)
                .then(async () => {
                    s.installments = installments;
                    await syncStudentFinancials(key);
                    showAlert('ß₧¢ß₧╗ß₧öß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
                    viewStudentDetails(key);
                    renderFilteredTable();
                })
                .catch(e => {
...
window.generatePaymentContract = (key) => {
    const s = allStudentsData[key];
    if (!s) {
        showAlert('ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ', 'danger');
        return;
    }
    ...
    const html = `
        <div style="font-family: 'Khmer OS Battambang', serif; color: black; line-height: 1.6; padding: 20px;">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <h4 style="font-family: 'Khmer OS Muol Light'; margin-bottom: 12px; font-size: 14pt;">ß₧ûßƒÆß₧Üßƒçß₧Üß₧╢ß₧çß₧╢ß₧Äß₧╢ß₧àß₧ÇßƒÆß₧Üß₧Çß₧ÿßƒÆß₧ûß₧╗ß₧çß₧╢</h4>
                <h5 style="font-family: 'Khmer OS Muol Light'; margin-bottom: 25px; font-size: 13pt;">ß₧çß₧╢ß₧Åß₧╖ ß₧ƒß₧╢ß₧ƒß₧ôß₧╢ ß₧ûßƒÆß₧Üßƒçß₧ÿß₧áß₧╢ß₧ÇßƒÆß₧ƒß₧ÅßƒÆß₧Ü</h5>
                ...
                <h4 style="font-family: 'Khmer OS Muol Light'; margin-top: 25px; text-decoration: underline; font-size: 16pt; font-weight: bold;">ß₧Çß₧╖ß₧àßƒÆß₧àß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</h4>
            </div>

            <!-- Body Content -->
            <div style="text-align: justify; font-size: 12pt;">
                <p style="text-indent: 30px; margin-bottom: 10px;">
                    ß₧ÆßƒÆß₧£ß₧╛ß₧ôßƒà <b>ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</b>, ß₧ÉßƒÆß₧äßƒâß₧æß₧╕ <b>${day}</b> ß₧üßƒé <b>${khmerMonth}</b> ß₧åßƒÆß₧ôß₧╢ßƒå <b>${year}</b>ßƒö
                </p>

                <p style="margin-bottom: 10px;">ß₧Öß₧╛ß₧äß₧üßƒÆß₧ëß₧╗ßƒåß₧êßƒÆß₧ÿßƒäßƒç <b>${s.lastName || ''} ${s.firstName || ''}</b> ß₧ùßƒüß₧æ: <b>${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕'}</b></p>
                <p style="margin-bottom: 10px;">
                   ß₧Åß₧╜ß₧ôß₧╢ß₧æß₧╕ß₧çß₧╢: <b>ß₧óß₧╢ß₧Äß₧╢ß₧ûßƒÆß₧Öß₧╢ß₧öß₧╢ß₧¢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ</b>
                   <br>ß₧¢ßƒüß₧üß₧æß₧╝ß₧Üß₧ƒßƒÉß₧ûßƒÆß₧æ: <b>${s.personalPhone || s.parentsPhone || '..................'}</b>
                </p>
                
                <p style="margin-bottom: 20px;">
                    ß₧ƒß₧╝ß₧ÿß₧ÆßƒÆß₧£ß₧╛ß₧Çß₧╖ß₧àßƒÆß₧àß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧àßƒåß₧ûßƒäßƒçß₧ÿß₧╗ß₧üß₧éß₧Äßƒêß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧äß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô ß₧èß₧╝ß₧àß₧üß₧╢ß₧äß₧ÇßƒÆß₧Üßƒäß₧ÿßƒû
                </p>

                <p style="margin-bottom: 10px; text-indent: 30px;">
                    ß₧èßƒäß₧Öß₧ƒß₧╢ß₧Üß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧éßƒÆß₧Üß₧╜ß₧ƒß₧╢ß₧Üß₧öß₧àßƒÆß₧àß₧╗ß₧ößƒÆß₧öß₧ôßƒÆß₧ô ß₧üßƒÆß₧ëß₧╗ßƒåß₧öß₧╢ß₧æ/ß₧ôß₧╢ß₧äß₧üßƒÆß₧ëß₧╗ßƒå ß₧ƒß₧╝ß₧ÿß₧Æß₧╢ß₧ôß₧╢ß₧óßƒçß₧óß₧╢ß₧äß₧Éß₧╢ß₧ôß₧╣ß₧äß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ÉßƒÆß₧¢ßƒâß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧àßƒåß₧ôß₧╜ß₧ô <b>$${remaining.toFixed(2)}</b> (ß₧èßƒéß₧¢ß₧ôßƒàß₧üßƒÆß₧£ßƒç) ß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ <b>${s.lastName} ${s.firstName}</b> (ID: ${s.displayId})ßƒö
                </p>

                ${(s.postponedDate || s.postponedReason) ? `
                <div style="margin-bottom: 15px; border: 1px dashed #ccc; padding: 10px; background-color: #fafafa;">
                    <p style="margin-bottom: 5px;"><strong>ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧ûßƒüß₧¢ (Postponement Info):</strong></p>
                    ${s.postponedDate ? `<p style="margin-bottom: 5px;">- ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Ü (To Date): <b>${convertToKhmerDate(s.postponedDate)}</b></p>` : ''}
                    ${s.postponedReason ? `<p style="margin-bottom: 0;">- ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ (Reason): <b>${s.postponedReason}</b></p>` : ''}
                </div>` : ''}

                 <p style="margin-bottom: 15px;">ß₧Çß₧╢ß₧Üß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ôß₧╣ß₧äß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧ÆßƒÆß₧£ß₧╛ß₧íß₧╛ß₧äß₧Åß₧╢ß₧ÿß₧Çß₧╢ß₧¢ß₧Çßƒåß₧Äß₧Åßƒïß₧èß₧╝ß₧àß₧üß₧╢ß₧äß₧ÇßƒÆß₧Üßƒäß₧ÿßƒû</p>

                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; font-size: 11pt;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid black; padding: 8px; text-align: center; width: 10%;">ß₧¢ß₧╛ß₧Çß₧æß₧╕</th>
                            <th style="border: 1px solid black; padding: 8px; text-align: center; width: 35%;">ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧ƒß₧ôßƒÆß₧Öß₧╢</th>
                            <th style="border: 1px solid black; padding: 8px; text-align: center; width: 25%;">ß₧àßƒåß₧ôß₧╜ß₧ôß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï</th>
                            <th style="border: 1px solid black; padding: 8px; text-align: center; width: 30%;">ß₧Åßƒåß₧Äß₧╢ß₧äß₧ƒß₧╢ß₧¢ß₧╢</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="border: 1px solid black; padding: 8px; text-align: center;">ßƒí</td>
                            <td style="border: 1px solid black; padding: 8px;">.........................................</td>
                            <td style="border: 1px solid black; padding: 8px;">$...........................</td>
                             <td style="border: 1px solid black; padding: 8px;"></td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid black; padding: 8px; text-align: center;">ßƒó</td>
                            <td style="border: 1px solid black; padding: 8px;">.........................................</td>
                            <td style="border: 1px solid black; padding: 8px;">$...........................</td>
                            <td style="border: 1px solid black; padding: 8px;"></td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid black; padding: 8px; text-align: center;">ßƒú</td>
                            <td style="border: 1px solid black; padding: 8px;">.........................................</td>
                            <td style="border: 1px solid black; padding: 8px;">$...........................</td>
                            <td style="border: 1px solid black; padding: 8px;"></td>
                        </tr>
                ...
                <p style="margin-bottom: 10px; text-indent: 30px;">
                    ß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Çß₧Üß₧Äß₧╕ß₧èßƒéß₧¢ß₧üßƒÆß₧ëß₧╗ßƒåß₧öß₧╢ß₧æ/ß₧ôß₧╢ß₧äß₧üßƒÆß₧ëß₧╗ßƒå ß₧ÿß₧╖ß₧ôß₧öß₧╢ß₧ôß₧éßƒäß₧Üß₧ûß₧Åß₧╢ß₧ÿß₧Çß₧╢ß₧Üß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧ôßƒüßƒçß₧æßƒü ß₧ƒß₧╢ß₧¢ß₧╢ß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧æßƒÆß₧Æß₧╖ß₧óß₧ôß₧╗ß₧£ß₧ÅßƒÆß₧Åß₧Åß₧╢ß₧ÿß₧öß₧æß₧öß₧ëßƒÆß₧çß₧╢ß₧òßƒÆß₧æßƒâß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Üß₧öß₧ƒßƒïß₧ƒß₧╢ß₧¢ß₧╢ß₧èßƒäß₧Öß₧éßƒÆß₧ÿß₧╢ß₧ôß₧¢ß₧ÇßƒÆß₧üß₧üß₧ÄßƒÆß₧îßƒö
                </p>
                
                 <p style="margin-bottom: 10px; text-indent: 30px;">
                    ß₧¢ß₧╖ß₧üß₧╖ß₧Åß₧ôßƒüßƒçß₧ÆßƒÆß₧£ß₧╛ß₧íß₧╛ß₧äß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧çß₧╢ß₧ùßƒÉß₧ƒßƒÆß₧Åß₧╗ß₧Åß₧╢ß₧ä ß₧ôß₧╖ß₧äß₧ÿß₧╢ß₧ôß₧ößƒÆß₧Üß₧ƒß₧╖ß₧æßƒÆß₧Æß₧ùß₧╢ß₧ûß₧àß₧╢ß₧ößƒïß₧ûß₧╕ß₧ÉßƒÆß₧äßƒâß₧àß₧╗ßƒçß₧áß₧ÅßƒÆß₧Éß₧¢ßƒüß₧üß₧╢ß₧ôßƒüßƒçß₧Åß₧æßƒàßƒö
                </p>
            </div>
            ...
            <!-- Signatures Footer -->
             <div style="display: flex; justify-content: space-between; margin-top: 40px; font-family: 'Khmer OS Muol Light';">
                <div style="text-align: center; width: 40%;">
                    <p style="margin-bottom: 100px;">ß₧ƒßƒÆß₧ôß₧╢ß₧ÿß₧ÿßƒüß₧èßƒâ/ß₧áß₧ÅßƒÆß₧Éß₧¢ßƒüß₧üß₧╢ ß₧ùß₧╢ß₧éß₧╕ (ß₧Ç)</p>
                    <p style="border-top: 1px dashed black; padding-top: 5px; font-family: 'Khmer OS Battambang';">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô</p>
                </div>
                <div style="text-align: center; width: 40%;">
                    <p style="margin-bottom: 100px;">ß₧ƒßƒÆß₧ôß₧╢ß₧ÿß₧ÿßƒüß₧èßƒâ/ß₧áß₧ÅßƒÆß₧Éß₧¢ßƒüß₧üß₧╢ ß₧ùß₧╢ß₧éß₧╕ (ß₧ü)</p>
                    <p style="border-top: 1px dashed black; padding-top: 5px; font-family: 'Khmer OS Battambang';">ß₧êßƒÆß₧ÿßƒäßƒç: ${s.lastName} ${s.firstName}</p>
                </div>
            </div>
        </div>
    `;
...
function renderAcademicHistory(student) {
    if (!student.academicRecords || !Array.isArray(student.academicRecords) || student.academicRecords.length === 0) {
        return `<tr><td colspan="6" class="text-center py-5 text-muted"><i class="fi fi-rr-document-info fa-2x mb-2 d-block opacity-50"></i>ß₧ÿß₧╖ß₧ôß₧æß₧╢ß₧ôßƒïß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗</td></tr>`;
    }
    ...
    const monthNames = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
    ...
    return records.map((rec, index) => {
        ...
        return `
            <tr class="align-middle">
                ...
                <td class="text-end pe-4">
                     <button class="btn btn-sm btn-light border-0 hover-scale text-danger" onclick="deleteScore('${student.key}', ${index})" title="ß₧¢ß₧╗ß₧ö">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                <div class="modal-header bg-primary text-white border-0">
                    <h5 class="modal-title fw-bold"><i class="fi fi-rr-add me-2"></i>ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ößƒÆß₧Üß₧àß₧╢ßƒåß₧üßƒé (Add Score)</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4 bg-light">
                    <form id="addScoreForm">
                        ...
                        <div class="row g-3 mb-3">
                             <div class="col-6">
                                <label class="form-label fw-bold small text-muted">ß₧üßƒé (Month)</label>
                                <select class="form-select" id="scoreMonth">
                                    <option value="1">ß₧ÿß₧Çß₧Üß₧╢ (Jan)</option>
                                    <option value="2">ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê (Feb)</option>
                                    <option value="3">ß₧ÿß₧╕ß₧ôß₧╢ (Mar)</option>
                                    <option value="4">ß₧ÿßƒüß₧ƒß₧╢ (Apr)</option>
                                    <option value="5">ß₧ºß₧ƒß₧ùß₧╢ (May)</option>
                                    <option value="6">ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢ (Jun)</option>
                                    <option value="7">ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢ (Jul)</option>
                                    <option value="8">ß₧ƒß₧╕ß₧áß₧╢ (Aug)</option>
                                    <option value="9">ß₧Çß₧ëßƒÆß₧ëß₧╢ (Sep)</option>
                                    <option value="10">ß₧Åß₧╗ß₧¢ß₧╢ (Oct)</option>
                                    <option value="11">ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢ (Nov)</option>
                                    <option value="12">ß₧ÆßƒÆß₧ôß₧╝ (Dec)</option>
                                </select>
                             </div>
                             <div class="col-6">
                                <label class="form-label fw-bold small text-muted">ß₧åßƒÆß₧ôß₧╢ßƒå (Year)</label>
                        ...
                        <div class="card border-0 shadow-sm mb-3">
                            <div class="card-body p-3">
                                <h6 class="fw-bold text-primary mb-3 border-bottom pb-2">ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧Åß₧╢ß₧ÿß₧ÿß₧╗ß₧üß₧£ß₧╖ß₧çßƒÆß₧çß₧╢ (Subject Scores)</h6>
                                <div class="row g-2">
                                    <div class="col-6">
                                        <label class="small text-muted">ß₧ƒßƒÆß₧Åß₧╢ß₧ößƒï (Listening)</label>
                                        <input type="number" class="form-control form-control-sm score-input" id="scoreListening" placeholder="0">
                                    </div>
                                    <div class="col-6">
                                        <label class="small text-muted">ß₧ôß₧╖ß₧Öß₧╢ß₧Ö (Speaking)</label>
                                        <input type="number" class="form-control form-control-sm score-input" id="scoreSpeaking" placeholder="0">
                                    </div>
                                    <div class="col-6">
                                        <label class="small text-muted">ß₧óß₧╢ß₧ô (Reading)</label>
                                        <input type="number" class="form-control form-control-sm score-input" id="scoreReading" placeholder="0">
                                    </div>
                                     <div class="col-6">
                                        <label class="small text-muted">ß₧ƒß₧Üß₧ƒßƒüß₧Ü (Writing)</label>
                        ...
                        <div class="row g-2 align-items-end">
                             <div class="col-3">
                                <label class="form-label fw-bold small text-success">ß₧ƒß₧Üß₧╗ß₧ö (Total)</label>
                                <input type="number" class="form-control fw-bold text-success bg-white" id="scoreTotal" readonly value="0">
                             </div>
                              <div class="col-3">
                                <label class="form-label fw-bold small text-info">ß₧ÿß₧ÆßƒÆß₧Öß₧ÿß₧ùß₧╢ß₧é (Avg)</label>
                                <input type="number" class="form-control fw-bold text-info bg-white" id="scoreAverage" readonly value="0">
                             </div>
                             <div class="col-3">
                                <label class="form-label fw-bold small text-primary">ß₧ôß₧╖ß₧æßƒüß₧ƒ (Grade)</label>
                                <input type="text" class="form-control fw-bold bg-white" id="scoreGrade" readonly placeholder="-">
                             </div>
                              <div class="col-3">
                                <label class="form-label fw-bold small text-warning">ß₧àßƒåß₧Äß₧╢ß₧Åßƒïß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒï</label>
                ...
                <div class="modal-footer border-0 bg-white p-3" style="border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal" onclick="viewStudentDetails('${key}')">ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÇßƒÆß₧Üßƒäß₧Ö</button>
...
function calculateScoreTotals() {
    ...
    // Auto Calculate Grade (ß₧ôß₧╖ß₧æßƒüß₧ƒ)
    let grade = 'F';
...
window.saveScore = () => {
    ...
    studentsRef.child(key).update({
        ...
        showAlert('ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧çßƒäß₧éß₧çßƒÉß₧Ö', 'success');
...
window.deleteScore = (key, index) => {
    if (!confirm('ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ûß₧╖ß₧Åß₧çß₧╢ß₧àß₧äßƒïß₧¢ß₧╗ß₧öß₧ûß₧╖ß₧ôßƒÆß₧æß₧╗ß₧ôßƒüßƒçß₧¼?')) return;
...
window.updateStudentId = async (studentKey, oldId, autoNewId = null) => {
    ...
    if (!newId) {
        ...
        const { value: promptedId } = await Swal.fire({
            title: 'ß₧ößƒÆß₧Åß₧╝ß₧Üß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ÉßƒÆß₧ÿß₧╕',
            input: 'text',
            inputValue: nextId,
            inputLabel: 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (Student ID)',
            showCancelButton: true,
            confirmButtonText: 'ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç',
            cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
            inputValidator: (value) => {
                if (!value) return 'ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü!';
                const val = value.trim();
                const exists = Object.values(allStudentsData).some(s => s.displayId === val);
                if (exists) return 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ôßƒüßƒçß₧ÿß₧╢ß₧ôß₧Üß₧╜ß₧àß₧áß₧╛ß₧Ö!';
            }
        });
        newId = promptedId;
    }
    ...
    if (newId) {
        ...
        try {
            ...
            if (doubleCheck && !autoNewId) {
                Swal.fire('ß₧Çßƒåß₧áß₧╗ß₧ƒ', 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ôßƒüßƒçß₧æß₧╛ß₧öß₧Åßƒéß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧ößƒÆß₧Üß₧╛ß₧ößƒÆß₧Üß₧╢ß₧ƒßƒïß₧èßƒäß₧Öß₧óßƒÆß₧ôß₧Çß₧òßƒÆß₧ƒßƒüß₧ä! ß₧ƒß₧╝ß₧ÿß₧ûßƒÆß₧Öß₧╢ß₧Öß₧╢ß₧ÿß₧ÿßƒÆß₧Åß₧äß₧æßƒÇß₧Åßƒö', 'error');
                showLoading(false);
                return;
            }
            ...
            Swal.fire({
                icon: 'success',
                title: 'ß₧öß₧╢ß₧ôß₧ößƒÆß₧Åß₧╝ß₧Üß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                text: `ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ÉßƒÆß₧ÿß₧╕ß₧éß₧║: ${val}`,
                timer: 1500,
                showConfirmButton: false
            });
            ...
            console.error(e);
            showAlert('ß₧Çßƒåß₧áß₧╗ß₧ƒß₧öß₧àßƒÆß₧àßƒüß₧Çß₧æßƒüß₧ƒßƒû ' + e.message, 'danger');
        }
        showLoading(false);
    }
};
...
window.checkAllDuplicates = () => {
    ...
    if (duplicates.length === 0) {
        return Swal.fire({
            icon: 'success',
            title: 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢ß₧æßƒü',
            text: 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒïß₧ÿß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧ößƒÆß₧¢ßƒéß₧Çßƒùß₧éßƒÆß₧ôß₧╢ (Unique) ß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒïß₧áß₧╛ß₧Ößƒö',
    ...
    let html = `
        <div class="mb-3 text-start small border-bottom pb-2 text-muted">
            <i class="fi fi-rr-info me-1"></i> ß₧ÿß₧╢ß₧ôß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧àßƒåß₧ôß₧╜ß₧ô <b>${duplicates.length}</b> ß₧ÇßƒÆß₧Üß₧╗ß₧ÿß₧èßƒéß₧¢ß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢ßƒö ß₧ƒß₧╝ß₧ÿß₧àß₧╗ß₧àß₧ößƒèß₧╝ß₧Åß₧╗ß₧ä "Auto ID" ß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧òßƒÆß₧Åß₧¢ßƒïß₧¢ßƒüß₧üß₧ÉßƒÆß₧ÿß₧╕ß₧ùßƒÆß₧¢ß₧╢ß₧ÿßƒù ß₧¼ "ß₧Çßƒé ID" ß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧Çßƒåß₧Äß₧Åßƒïß₧èßƒäß₧Öß₧üßƒÆß₧¢ß₧╜ß₧ôß₧»ß₧äßƒö
        </div>
        ...
        html += `
            <div class="mb-3 p-3 border rounded bg-white shadow-sm border-danger" style="border-left-width: 5px !important;">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span class="badge bg-danger fs-6 px-3">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü: ${id}</span>
                    <span class="badge bg-light text-dark border">${list.length} ß₧ôß₧╢ß₧Çßƒïß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢</span>
                </div>
            ...
            html += `
                <div class="list-group-item d-flex justify-content-between align-items-center px-0 py-2 border-bottom-0">
                    ...
                    <div class="d-flex gap-1">
                        <button class="btn btn-xs btn-success py-1 px-2" onclick="window.updateStudentId('${s.key}', '${id}', '${autoId}')" title="ß₧òßƒÆß₧Åß₧¢ßƒï ID ß₧ÉßƒÆß₧ÿß₧╕ß₧ƒßƒÆß₧£ßƒÉß₧Öß₧ößƒÆß₧Üß₧£ß₧ÅßƒÆß₧Åß₧╖">
                        ...
                        <button class="btn btn-xs btn-outline-primary py-1 px-2" onclick="window.updateStudentId('${s.key}', '${id}')">
                            <i class="fi fi-rr-edit me-1"></i>ß₧Çßƒé
                        </button>
                    </div>
                 </div>
            `;
    ...
    Swal.fire({
        title: '<span class="text-danger"><i class="fi fi-rr-exclamation me-2"></i>ß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧äß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧üß₧èßƒéß₧¢ß₧çß₧╢ß₧ôßƒïß₧éßƒÆß₧ôß₧╢</span>',
        html: html,
        icon: null,
        width: '600px',
        showConfirmButton: false,
...
window.showQuickFinancialSummary = () => {
    ...
    if (activeStudents.length === 0) {
        Swal.fire({
            icon: 'info',
            title: 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö',
            text: 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (ß₧èßƒéß₧¢ß₧öß₧╢ß₧ôß₧àß₧ÿßƒÆß₧Üß₧╢ß₧ëßƒï) ß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧íß₧╛ß₧Ößƒö'
        });
        return;
    }
    ...
    const sections = {
        chineseFullTime: { title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (Full-Time)', students: [], paid: 0, outstanding: 0, counts: { today: 0, overdue: 0, debt: 0, delay: 0, warning: 0 } },
        partTime: { title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (Part-Time)', students: [], paid: 0, outstanding: 0, counts: { today: 0, overdue: 0, debt: 0, delay: 0, warning: 0 } },
        trilingual: { title: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà', students: [], paid: 0, outstanding: 0, counts: { today: 0, overdue: 0, debt: 0, delay: 0, warning: 0 } }
    };
    ...
    let html = `
        <div id="financialReportPrintArea" class="p-4" style="font-family: 'Khmer OS Battambang', sans-serif; background: white;">
            ...
            <div class="text-center mb-4 d-flex justify-content-between align-items-center">
                ...
                <div>
                    <h4 class="fw-bold text-primary mb-1" style="font-family: 'Khmer OS Muol Light';">ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧ÆßƒÇß₧ô ß₧ƒßƒèß₧╕ß₧ô</h4>
                    <h5 class="fw-bold mb-0">ß₧öß₧ëßƒÆß₧çß₧╕ß₧Üß₧╢ß₧Öß₧ôß₧╢ß₧ÿß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ ß₧ôß₧╖ß₧äß₧Åß₧╗ß₧¢ßƒÆß₧Öß₧ùß₧╢ß₧ûß₧áß₧╖ß₧Üß₧ëßƒÆß₧ëß₧£ß₧ÅßƒÆß₧Éß₧╗</h5>
                ...
                <div style="width: 150px;" class="text-end no-print">
                    <button class="btn btn-sm btn-outline-primary rounded-pill px-3" onclick="window.print()">
                        <i class="fi fi-rr-print me-1"></i> ß₧ößƒäßƒçß₧ûß₧╗ß₧ÿßƒÆß₧û
                    </button>
                </div>
            </div>
            ...
            <div class="card border mb-4 no-print shadow-sm">
                <div class="card-header bg-light py-2 fw-bold small text-muted text-uppercase">
                    <i class="fi fi-rr-stats me-2"></i>ß₧ƒß₧äßƒÆß₧üßƒüß₧öß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û (Status Summary)
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered table-sm mb-0 text-center align-middle" style="font-size: 0.85rem;">
                        <thead class="bg-white fw-bold">
                            <tr>
                                <th rowspan="2" class="align-middle" width="30%">ß₧òßƒÆß₧ôßƒéß₧Çß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢</th>
                                <th colspan="5">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (ß₧àßƒåß₧ôß₧╜ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ)</th>
                                <th rowspan="2" class="align-middle" width="20%">ß₧çßƒåß₧ûß₧╢ß₧Çßƒïß₧ƒß₧Üß₧╗ß₧ö</th>
                                <th rowspan="2" class="align-middle" width="15%">ß₧öß₧äßƒïß₧öß₧╢ß₧ôß₧ƒß₧Üß₧╗ß₧ö</th>
                            </tr>
                            <tr>
                                <th class="text-primary">ß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç</th>
                                <th class="text-danger">ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï</th>
                                <th class="text-warning">ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï</th>
                                <th class="text-secondary">ß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Ü</th>
                                <th class="text-info">ß₧ûßƒÆß₧Üß₧ÿß₧╢ß₧ô</th>
                            </tr>
                        </thead>
                        <tbody>`;
    ...
    html += `
                        ...
                        <tfoot class="bg-light fw-bold">
                            <tr>
                                <td class="text-end pe-3">ß₧ƒß₧Üß₧╗ß₧öß₧Üß₧╜ß₧ÿ:</td>
            ...
            <div class="row g-2 mb-4 no-print">
                <div class="col-6">
                    <div class="border rounded-3 p-3 bg-light text-center h-100">
                        <div class="text-muted small fw-bold mb-1 text-uppercase">ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧æß₧æß₧╜ß₧¢ß₧öß₧╢ß₧ôß₧ƒß₧Üß₧╗ß₧ö</div>
                        <div class="h4 mb-0 fw-bold text-success">$${grandTotalPaid.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="border rounded-3 p-3 bg-light text-center h-100">
                        <div class="text-muted small fw-bold mb-1 text-uppercase">ß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒïß₧ƒß₧Üß₧╗ß₧ö</div>
        ...
        html += `
            <div class="registry-section mb-4">
                <h6 class="fw-bold border-bottom pb-1 mb-2">
                    <i class="fi fi-rr-list me-2"></i>ß₧òßƒÆß₧ôßƒéß₧Çßƒû ${section.title} (${section.students.length} ß₧ôß₧╢ß₧Çßƒï)
                </h6>
                <table class="table table-bordered table-sm align-middle mb-0" style="font-size: 0.8rem;">
                    <thead class="bg-light">
                        <tr class="text-center">
                            <th width="5%">ß₧¢.ß₧Ü</th>
                            <th width="10%">ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü</th>
                            <th width="20%" class="text-start px-2">ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ (KH / CN)</th>
                            <th width="6%">ß₧ùßƒüß₧æ</th>
                            <th width="10%">ß₧öß₧äßƒïß₧Üß₧╜ß₧à</th>
                            <th width="10%">ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï</th>
                            <th width="15%">ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û</th>
                            <th width="24%">ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒå (Remark)</th>
                        </tr>
                    </thead>
                    <tbody>`;
    ...
    html += `
            <div class="text-end text-muted small mt-3 no-print">
                <i class="fi fi-rr-info me-1"></i> ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìßƒû ${new Date().toLocaleString('en-GB')}
            </div>
...
// ==========================================
// ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧ÅßƒÆß₧Üß₧╜ß₧Åß₧ûß₧╖ß₧ôß₧╖ß₧ÅßƒÆß₧Ö ß₧ôß₧╖ß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ƒß₧Üß₧╗ß₧öß₧ößƒåß₧Äß₧╗ß₧¢
// ==========================================
...
window.toggleDebtSummary = () => {
    ...
    // ß₧öß₧╖ß₧æ report ß₧òßƒÆß₧ƒßƒüß₧äßƒù ß₧ößƒÆß₧Üß₧ƒß₧╖ß₧ôß₧öß₧╛ß₧öß₧╛ß₧Ç
    ...
    // ß₧ƒßƒÆß₧£ßƒéß₧äß₧Üß₧Ç card ß₧Üß₧öß₧ƒßƒï table ß₧öß₧ëßƒÆß₧çß₧╕ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧¢ß₧╢ß₧Çßƒï/ß₧öß₧äßƒÆß₧áß₧╢ß₧ë
    ...
    if (window.SHOW_DEBT_SUMMARY) {
        ...
        renderDebtSummary();
        // Scroll ß₧æßƒàß₧Çß₧ôßƒÆß₧¢ßƒéß₧äß₧öß₧äßƒÆß₧áß₧╢ß₧ë
...
/* ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧ÇßƒÆß₧ôß₧╗ß₧äß₧Åß₧╢ß₧Üß₧╢ß₧ä Debt Status Summary Table */
function renderDebtSummary() {
    ...
    // ß₧àßƒÆß₧Üßƒäßƒçß₧Öß₧Çß₧Åßƒéß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧èßƒéß₧¢ß₧Çßƒåß₧ûß₧╗ß₧äß₧ÜßƒÇß₧ô (ß₧ÿß₧╖ß₧ôß₧ÿßƒéß₧ôß₧êß₧ößƒïß₧ÜßƒÇß₧ô Dropout, ß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ Graduated ß₧¼ ß₧öß₧äßƒïß₧òßƒÆß₧èß₧╢ß₧àßƒïß₧Üß₧╜ß₧à)
    const activeStudents = (window.rawStudentsArray || []).filter(s => {
    ...
    const sections = {
        'chinese-fulltime': { name: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (Full-Time Chinese)', today: 0, overdue: 0, debt: 0, delay: 0, warning: 0, amount: 0 },
        'part-time': { name: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (Part-Time)', today: 0, overdue: 0, debt: 0, delay: 0, warning: 0, amount: 0 },
        'trilingual': { name: 'ß₧ÉßƒÆß₧ôß₧╢ß₧Çßƒïßƒúß₧ùß₧╢ß₧ƒß₧╢ (Trilingual)', today: 0, overdue: 0, debt: 0, delay: 0, warning: 0, amount: 0 }
    };
    ...
    activeStudents.forEach(s => {
        ...
        // ß₧ößƒÆß₧Üß₧╛ß₧ößƒÆß₧Üß₧╢ß₧ƒßƒïß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧üß₧╢ß₧äß₧¢ß₧╛
        const statusObj = getPaymentStatus(s);
        const debt = calculateRemainingAmount(s);
        ...
        // ß₧öß₧╝ß₧Çß₧ƒß₧Üß₧╗ß₧öß₧ößƒÆß₧Üß₧╢ß₧Çßƒïß₧ößƒåß₧Äß₧╗ß₧¢ß₧ƒß₧Üß₧╗ß₧ö (Total Debt Amount)
        if (debt > 0) {
    ...
    tbody.innerHTML = Object.entries(sections).map(([id, sec]) => `
        <tr class="text-center">
            ...
            <td class="px-2">
                <div class="debt-count-badge bg-primary bg-opacity-10 text-primary fw-bold" onclick="showDebtDetails('${id}', 'today')" title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒç">
                    ${sec.today} ß₧ôß₧╢ß₧Çßƒï
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-danger bg-opacity-10 text-danger fw-bold" onclick="showDebtDetails('${id}', 'overdue')" title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒç">
                    ${sec.overdue} ß₧ôß₧╢ß₧Çßƒï
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-warning bg-opacity-10 text-warning fw-bold" onclick="showDebtDetails('${id}', 'debt')" title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒç">
                    ${sec.debt} ß₧ôß₧╢ß₧Çßƒï
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-secondary bg-opacity-10 text-secondary fw-bold" onclick="showDebtDetails('${id}', 'delay')" title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒç">
                    ${sec.delay} ß₧ôß₧╢ß₧Çßƒï
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-info bg-opacity-10 text-info fw-bold" onclick="showDebtDetails('${id}', 'warning')" title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧ÿß₧╛ß₧¢ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒç">
                    ${sec.warning} ß₧ôß₧╢ß₧Çßƒï
                </div>
            </td>
    ...
    tfoot.innerHTML = `
        <tr class="text-center align-middle" style="background: linear-gradient(90deg, #1e293b 0%, #334155 100%); color: white; border-top: 3px solid #8a0e5b;">
            <td class="text-start px-4 py-4 fw-bold moul-font" style="font-size: 1.1rem; letter-spacing: 0.5px;">
                <i class="fi fi-rr-stats me-2 text-pink-400"></i>ß₧ƒß₧Üß₧╗ß₧öß₧Üß₧╜ß₧ÿ (Grand Total)
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-white bg-opacity-10 text-white fw-bold" onclick="showDebtDetails('all', 'today')">
                    <span style="font-size: 1.1rem;">${grandTotal.today}</span> <span class="small opacity-75">ß₧ôß₧╢ß₧Çßƒï</span>
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-danger bg-opacity-20 text-white fw-bold" onclick="showDebtDetails('all', 'overdue')">
                    <span style="font-size: 1.1rem;">${grandTotal.overdue}</span> <span class="small opacity-75">ß₧ôß₧╢ß₧Çßƒï</span>
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-warning bg-opacity-20 text-white fw-bold" onclick="showDebtDetails('all', 'debt')">
                    <span style="font-size: 1.1rem;">${grandTotal.debt}</span> <span class="small opacity-75">ß₧ôß₧╢ß₧Çßƒï</span>
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-secondary bg-opacity-20 text-white fw-bold" onclick="showDebtDetails('all', 'delay')">
                    <span style="font-size: 1.1rem;">${grandTotal.delay}</span> <span class="small opacity-75">ß₧ôß₧╢ß₧Çßƒï</span>
                </div>
            </td>
            <td class="px-2">
                <div class="debt-count-badge bg-info bg-opacity-20 text-white fw-bold" onclick="showDebtDetails('all', 'warning')">
                    <span style="font-size: 1.1rem;">${grandTotal.warning}</span> <span class="small opacity-75">ß₧ôß₧╢ß₧Çßƒï</span>
                </div>
            </td>
    ...
    // ß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧Åß₧╢ß₧ÿß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧æß₧╢ßƒåß₧ä ßƒÑ (Legacy support)
    ...
    // ß₧öß₧äßƒÆß₧áß₧╢ß₧ëß₧öß₧ëßƒÆß₧çß₧╕ß₧Üß₧╜ß₧ÿ (Unified List) ß₧ÉßƒÆß₧ÿß₧╕
...
function renderUnifiedDebtList(students) {
    ...
    if (filtered.length === 0) {
        ...
        tbody.innerHTML = `<tr><td colspan="${colspan}" class="text-center py-5 text-muted"><i class="fi fi-rr-inbox fa-2x mb-2 d-block"></i>ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧ôß₧╗ß₧äß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧ôßƒüßƒçß₧æßƒü</td></tr>`;
        return;
    }
    ...
    tbody.innerHTML = filtered.map((s, idx) => {
        ...
        let sectionName = 'ß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä (PT)';
        let sectionClass = 'bg-secondary bg-opacity-10 text-secondary';
        if (isStudentTrilingual(s)) {
            sectionName = 'ß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà (TL)';
            sectionClass = 'bg-info bg-opacity-10 text-info';
        } else if (isStudentChineseFullTime(s)) {
            sectionName = 'ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä (FT)';
        ...
        return `
            <tr class="text-center animate__animated animate__fadeIn unified-debt-row">
                ...
                <td class="text-start">
                    <div class="small fw-bold text-slate-600"><i class="fi fi-rr-id-badge me-2 opacity-100 text-pink-500"></i>${s.teacherName || 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ô'}</div>
                </td>
                <td>
                ...
                <td class="text-start px-3">
                    <div class="remark-pill shadow-sm" 
                         ...
                         title="ß₧àß₧╗ß₧àß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧Çßƒéß₧ƒß₧ÿßƒÆß₧Üß₧╜ß₧¢ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï">
                ...
                <td>
                    <button class="btn btn-sm btn-light border-0 rounded-circle shadow-sm p-2 hover-scale" onclick="viewStudentDetails('${s.key}')" title="ß₧ÿß₧╛ß₧¢ß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Å">
...
window.updateDebtRemark = (key, currentRemark) => {
    Swal.fire({
        title: 'ß₧éßƒÆß₧Üß₧ößƒïß₧éßƒÆß₧Üß₧äß₧Çß₧╢ß₧Üß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï (Manage Remark)',
        text: 'ß₧Çßƒéß₧ƒß₧ÿßƒÆß₧Üß₧╜ß₧¢ ß₧¼ß₧¢ß₧╗ß₧öß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒïß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ôßƒüßƒçßƒû',
        input: 'textarea',
        inputValue: currentRemark || '',
        inputPlaceholder: 'ß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒïß₧óßƒåß₧ûß₧╕ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ß₧çßƒåß₧ûß₧╢ß₧Çßƒï ß₧¼ß₧Çß₧╢ß₧Üß₧ƒß₧ôßƒÆß₧Öß₧╢ß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï...',
        showCancelButton: true,
        showDenyButton: currentRemark ? true : false,
        confirmButtonText: 'ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Ç (Save)',
        denyButtonText: 'ß₧¢ß₧╗ß₧öß₧àßƒüß₧ë (Delete)',
        cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
        ...
        if (result.isConfirmed) {
            ...
            studentsRef.child(key).update({
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'ß₧Üß₧ÇßƒÆß₧ƒß₧╢ß₧æß₧╗ß₧Çß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                    text: 'ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒïß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï!',
                    timer: 1500,
                    showConfirmButton: false,
            ...
            Swal.fire({
                title: 'ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧æßƒü?',
                text: "ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒïß₧ôßƒüßƒçß₧ôß₧╣ß₧äß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧¢ß₧╗ß₧öß₧àßƒüß₧ëß₧ûß₧╕ß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Ö!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#dc3545',
                cancelButtonColor: '#6c757d',
                confirmButtonText: 'ß₧öß₧╢ß₧æ ß₧¢ß₧╗ß₧öß₧àßƒüß₧ë',
                cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
                customClass: { popup: 'rounded-4' }
            }).then((confirmDelete) => {
                if (confirmDelete.isConfirmed) {
                    ...
                    studentsRef.child(key).child('remark').remove().then(() => {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'ß₧öß₧╢ß₧ôß₧¢ß₧╗ß₧öß₧àßƒüß₧ë',
                            text: 'ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒïß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧¢ß₧╗ß₧öß₧èßƒäß₧Öß₧çßƒäß₧éß₧çßƒÉß₧Ö!',
                            timer: 1500,
                            showConfirmButton: false,
                            customClass: { popup: 'rounded-4' }
                        });
...
function renderStatusList(statusId, students) {
    ...
    if (filtered.length === 0) {
        container.innerHTML = '<div class="p-3 text-center text-muted small italic">ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÇßƒÆß₧ôß₧╗ß₧äß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧ôßƒüßƒçß₧æßƒü</div>';
        return;
    }
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-start">
                            <span class="fw-bold text-dark" style="font-size: 0.9rem;">
                                ${s.lastName || ''} ${s.firstName || ''}
                                <span class="ms-1 small opacity-50">${(s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? '≡ƒæª' : '≡ƒæº'}</span>
                            </span>
...
window.exportCurrentDetailedListPDF = () => {
    ...
    const typeNames = {
        'all': 'ß₧éßƒÆß₧Üß₧ößƒïß₧ößƒÆß₧Üß₧ùßƒüß₧æß₧ößƒåß₧Äß₧╗ß₧¢ (All Debt)',
        'today': 'ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç (Today)',
        'overdue': 'ß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï (Overdue)',
        'debt': 'ß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Debt)',
        'delay': 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Ü (Delay)',
        'warning': 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ (Warning)',
        'paid_off': 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧Üß₧╜ß₧à (Paid)',
        'paid_full': 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï (Paid Full)'
    };
    ...
    if (filtered.length === 0) {
        Swal.fire('Info', 'ß₧ÿß₧╖ß₧ôß₧ÿß₧╢ß₧ôß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧èß₧╛ß₧ÿßƒÆß₧öß₧╕ß₧æß₧╢ß₧ëß₧Öß₧Çß₧æßƒü', 'info');
        return;
    }

    // Use default font (supports Unicode including Khmer)
    doc.setFontSize(14);
    doc.text('ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô (Tian Xin International School)', 105, 15, { align: 'center' });
    doc.setFontSize(11);
    doc.text(`ß₧öß₧ëßƒÆß₧çß₧╕ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒßƒû ${typeNames[statusId]}`, 105, 23, { align: 'center' });

    doc.setFontSize(9);
    doc.text(`ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æßƒû ${new Date().toLocaleString('en-GB')}`, 15, 30);
    ...
    const body = filtered.map((s, idx) => [
        ...
        `${s.lastName || ''} ${s.firstName || ''}`,
        s.teacherName || 'N/A',
        isStudentTrilingual(s) ? 'ß₧àßƒåß₧Äßƒçß₧èß₧╣ß₧äß₧æß₧╝ß₧æßƒà' : (isStudentChineseFullTime(s) ? 'ß₧àß₧╖ß₧ôß₧ûßƒüß₧ëß₧ÿßƒëßƒäß₧ä' : 'ß₧ÇßƒÆß₧Üßƒàß₧ÿßƒëßƒäß₧ä'),
    ...
    doc.autoTable({
        head: [['#', 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü', 'ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ', 'ß₧éßƒÆß₧Üß₧╝ß₧öß₧ôßƒÆß₧æß₧╗ß₧Ç', 'ß₧òßƒÆß₧ôßƒéß₧Ç', 'ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û', 'ß₧ÉßƒÆß₧äßƒâß₧öß₧äßƒï', 'ß₧çßƒåß₧ûß₧╢ß₧Çßƒï', 'ß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï']],
        body: body,
        startY: 35,
...
// ==========================================
// ß₧ÿß₧╗ß₧üß₧äß₧╢ß₧Üß₧öß₧äßƒÆß₧Çß₧╛ß₧Åß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧çß₧╢ PDF
// ==========================================
window.generateDebtSummaryPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text('ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô (Tian Xin International School)', 148.5, 20, { align: 'center' });
    doc.setFontSize(14);
    doc.text('ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ƒß₧Üß₧╗ß₧öß₧ößƒåß₧Äß₧╗ß₧¢ & ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧ûß₧öß₧äßƒïß₧ößƒÆß₧Üß₧╢ß₧Çßƒï (Debt Status Summary)', 148.5, 30, { align: 'center' });

    doc.setFont('Battambang', 'normal');
    doc.setFontSize(10);
    doc.text(`ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ: ${new Date().toLocaleDateString('en-GB')}`, 15, 40);
...
window.exportDebtReportPDF = () => {
    ...
    doc.text('ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô (Tian Xin International)', 148.5, 20, { align: 'center' });

    doc.setFont('Moul', 'normal');
    doc.setFontSize(16);
    doc.setTextColor(214, 51, 132); // #d63384
    doc.text('ß₧öß₧ëßƒÆß₧çß₧╕ß₧Üß₧╜ß₧ÿß₧ößƒåß₧Äß₧╗ß₧¢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æß₧╢ßƒåß₧äß₧óß₧ƒßƒï (Unified Master Debt Report)', 148.5, 30, { align: 'center' });

    doc.setFont('Battambang', 'normal');
    doc.setFontSize(10);
    doc.setTextColor(100, 100, 100);
    doc.text(`ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æßƒû ${new Date().toLocaleString('en-GB')}`, 15, 38);
    ...
    const body = students.map((s, idx) => {
        ...
        return [
            ...
            s.displayId || '-',
            `${s.lastName || ''} ${s.firstName || ''}`,
            (s.gender === 'Male' || s.gender === 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ') ? 'ß₧ößƒÆß₧Üß₧╗ß₧ƒ' : 'ß₧ƒßƒÆß₧Üß₧╕',
    ...
    doc.autoTable({
        head: [['#', 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü', 'ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ', 'ß₧ùßƒüß₧æ', 'ß₧ÿßƒëßƒäß₧ä/ß₧£ß₧éßƒÆß₧é', 'ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï', 'ß₧æß₧╣ß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çßƒï', 'ß₧ƒßƒÆß₧Éß₧╢ß₧ôß₧ùß₧╢ß₧û', 'ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒå']],
        body: body,
        startY: 45,
        ...
        didParseCell: function (data) {
            if (data.section === 'body' && data.column.index === 7) {
                ...
                if (statusText.includes('ß₧áß₧╜ß₧ƒ')) data.cell.styles.textColor = [186, 12, 47]; // Red
                else if (statusText.includes('ß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç')) data.cell.styles.textColor = [0, 102, 204]; // Blue
                else if (statusText.includes('ß₧çß₧╖ß₧Åß₧èß₧¢ßƒï')) data.cell.styles.textColor = [0, 153, 153]; // Teal
            }
        }
    });
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        doc.text(`ß₧æßƒåß₧ûßƒÉß₧Üß₧æß₧╕ ${i} ß₧ôßƒâ ${totalPages}`, 148.5, 200, { align: 'center' });
    }
...
window.exportCategorizedDebtReportPDF = () => {
    ...
    const categories = [
        { id: 'today', title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒïß₧ÉßƒÆß₧äßƒâß₧ôßƒüßƒç (Today)', color: [0, 102, 204] },
        { id: 'overdue', title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧áß₧╜ß₧ƒß₧Çßƒåß₧Äß₧Åßƒï (Overdue)', color: [186, 12, 47] },
        { id: 'debt', title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ôßƒàß₧çßƒåß₧ûß₧╢ß₧Çßƒï (Debt)', color: [221, 143, 0] },
        { id: 'delay', title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ûß₧ôßƒÆß₧Öß₧╢ß₧Üß₧ûßƒüß₧¢ (Delay)', color: [90, 90, 90] },
        { id: 'warning', title: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧çß₧╖ß₧Åß₧èß₧¢ßƒïß₧ÉßƒÆß₧äßƒâ (Warning)', color: [0, 153, 153] }
    ];
    ...
    const drawHeader = (doc) => {
        ...
        doc.setFontSize(14);
        doc.setTextColor(51, 51, 51);
        doc.text('ß₧ƒß₧╢ß₧¢ß₧╢ß₧óß₧ôßƒÆß₧Åß₧Üß₧çß₧╢ß₧Åß₧╖ ß₧Æß₧╢ß₧ôß₧ƒßƒèß₧╕ß₧ô (Tian Xin International)', 105, 20, { align: 'center' });

        doc.setFont('Moul', 'normal');
        doc.setFontSize(12);
        doc.setTextColor(214, 51, 132); // #d63384
        doc.text('ß₧Üß₧öß₧╢ß₧Öß₧Çß₧╢ß₧Üß₧Äßƒìß₧ößƒåß₧Äß₧╗ß₧¢ß₧Åß₧╢ß₧ÿß₧ößƒÆß₧Üß₧ùßƒüß₧æ (Categorized Debt Report)', 105, 28, { align: 'center' });

        doc.setFont('Battambang', 'normal');
        doc.setFontSize(9);
        doc.setTextColor(100, 100, 100);
        doc.text(`ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧öß₧äßƒÆß₧Çß₧╛ß₧Åßƒû ${new Date().toLocaleString('en-GB')}`, 15, 34);
    ...
    categories.forEach((cat, index) => {
        ...
        if (filtered.length > 0) {
            ...
            doc.text(`${index + 1}. ${cat.title} - (ß₧àßƒåß₧ôß₧╜ß₧ôßƒû ${filtered.length} ß₧ôß₧╢ß₧Çßƒï)`, 15, currentY + 5);
            ...
            doc.autoTable({
                head: [['#', 'ß₧óß₧ÅßƒÆß₧Åß₧¢ßƒüß₧ü', 'ß₧êßƒÆß₧ÿßƒäßƒçß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ', 'ß₧ùßƒüß₧æ', 'ß₧çßƒåß₧ûß₧╢ß₧Çßƒï', 'ß₧ÉßƒÆß₧äßƒâß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧äßƒï', 'ß₧Çßƒåß₧Äß₧Åßƒïß₧àßƒåß₧Äß₧╢ßƒå']],
                body: body,
                startY: currentY + 8,
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        doc.setFontSize(8);
        doc.setTextColor(150, 150, 150);
        doc.text(`ß₧æßƒåß₧ûßƒÉß₧Üß₧æß₧╕ ${i} ß₧ôßƒâ ${totalPages}`, 105, 290, { align: 'center' });
    }
...
window.markStudentAsPaidOff = (key) => {
    Swal.fire({
        title: 'ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï 100%?',
        text: "ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧æßƒüß₧Éß₧╢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ôßƒüßƒçß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧Üß₧Ößƒêß₧ûßƒüß₧¢ 48 ß₧üßƒé?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#198754',
        cancelButtonColor: '#d33',
        confirmButtonText: 'ß₧öß₧╢ß₧æ/ß₧àß₧╢ß₧ƒ (Yes)',
        cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï (Cancel)',
        customClass: { popup: 'rounded-4' }
    }).then((result) => {
        if (result.isConfirmed) {
            showLoading(true);
            ...
            studentsRef.child(key).once('value').then(snapshot => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                    text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Çßƒåß₧Äß₧Åßƒïß₧Éß₧╢ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï 100% (48 ß₧üßƒé)!',
                    timer: 2000,
                    showConfirmButton: false,
                    customClass: { popup: 'rounded-4' }
                });
...
window.markAsGraduated = (key) => {
    ...
    Swal.fire({
        title: '<h3 class="fw-bold mb-0">ß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ (Graduation)</h3>',
        html: `
            <div class="text-start p-2">
                <p class="text-muted small mb-3">ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒïß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧¢ß₧ÿßƒÆß₧óß₧╖ß₧Åß₧ƒß₧ÿßƒÆß₧Üß₧╢ß₧ößƒïß₧Çß₧╢ß₧Üß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧Üß₧öß₧ƒßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ <b>${s.lastName} ${s.firstName}</b></p>
                <div class="mb-3">
                    <label class="form-label fw-bold small"><i class="fi fi-rr-calendar me-1"></i>ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧öß₧ëßƒÆß₧àß₧ößƒï (Graduation Date)</label>
                    <input type="date" id="gradDate" class="form-control form-control-lg rounded-3" value="${new Date().toISOString().split('T')[0]}">
                </div>
                <div class="mb-0">
                    <label class="form-label fw-bold small"><i class="fi fi-rr-comment-alt me-1"></i>ß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧ÿßƒÆß₧éß₧╢ß₧¢ßƒï (Note/Remark)</label>
                    <textarea id="gradNote" class="form-control rounded-3" rows="3" placeholder="ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧öß₧ôßƒÆß₧Éßƒéß₧ÿ ß₧ößƒÆß₧Üß₧ƒß₧╖ß₧ôß₧öß₧╛ß₧ÿß₧╢ß₧ô..."></textarea>
                </div>
            </div>
        `,
        icon: 'info',
        ...
        confirmButtonColor: '#198754',
        cancelButtonColor: '#6c757d',
        confirmButtonText: '<i class="fi fi-rr-check-circle me-2"></i>ß₧Öß₧¢ßƒïß₧ûßƒÆß₧Üß₧ÿß₧öß₧ëßƒÆß₧àß₧ößƒï',
        cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
        customClass: {
        ...
        preConfirm: () => {
            ...
            if (!date) {
                Swal.showValidationMessage('ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ!');
                return false;
            }
            return { date, note };
        }
        ...
        if (result.isConfirmed) {
            ...
            if (note) {
                ...
                updates.remark = (oldRemark ? oldRemark + '\n' : '') + `[ß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ ${date}]: ` + note;
            }
            ...
            studentsRef.child(key).update(updates).then(() => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                    text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Çßƒåß₧Äß₧Åßƒïß₧Éß₧╢ß₧öß₧╢ß₧ôß₧öß₧ëßƒÆß₧àß₧ößƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢ß₧Üß₧╜ß₧àß₧Üß₧╢ß₧¢ßƒï!',
                    timer: 2000,
                    showConfirmButton: false,
                    customClass: { popup: 'rounded-4' }
                });
...
window.markAsDropout = (key) => {
    ...
    if (!s) {
        Swal.fire({
            icon: 'error',
            title: 'ß₧Çßƒåß₧áß₧╗ß₧ƒ (Error)',
            text: 'ß₧ÿß₧╖ß₧ôß₧óß₧╢ß₧àß₧Üß₧Çß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧æßƒü ß₧ƒß₧╝ß₧ÿß₧ûßƒÆß₧Öß₧╢ß₧Öß₧╢ß₧ÿß₧ÿßƒÆß₧Åß₧äß₧æßƒÇß₧Å!'
        });
        return;
    }
    ...
    Swal.fire({
        title: 'ß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢?',
        text: `ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧çß₧╢ß₧àß₧äßƒïß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ ${s.lastName || ''} ${s.firstName || ''} ß₧çß₧╢ "ß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢" ß₧ÿßƒéß₧ôß₧æßƒü?`,
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#dc3545',
        cancelButtonColor: '#6c757d',
        confirmButtonText: 'ß₧öß₧╢ß₧æ/ß₧àß₧╢ß₧ƒ ß₧àß₧äßƒïß₧ößƒäßƒçß₧öß₧äßƒï',
        cancelButtonText: 'ß₧ÅßƒÆß₧Üß₧íß₧ößƒïß₧ÇßƒÆß₧Üßƒäß₧Ö (Back)',
        customClass: { popup: 'rounded-4' }
    }).then((result) => {
        if (result.isConfirmed) {
            // Show detailed form
            Swal.fire({
                title: '<h3 class="fw-bold mb-0 text-danger">ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧ößƒäßƒçß₧öß₧äßƒï (Dropout Info)</h3>',
                html: `
                    <div class="text-start p-2">
                        <p class="text-muted small mb-3">ß₧ƒß₧╝ß₧ÿß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒïß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æ ß₧ôß₧╖ß₧äß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ß₧êß₧ößƒïß₧Üß₧öß₧ƒßƒï <b>${s.lastName || ''} ${s.firstName || ''}</b></p>
                        <div class="mb-3">
                            <label class="form-label fw-bold small"><i class="fi fi-rr-calendar me-1"></i>ß₧Çß₧╢ß₧¢ß₧öß₧Üß₧╖ß₧àßƒÆß₧åßƒüß₧æß₧êß₧ößƒï (Dropout Date)</label>
                            <input type="date" id="dropoutDate" class="form-control form-control-lg rounded-3" value="${new Date().toISOString().split('T')[0]}">
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-bold small"><i class="fi fi-rr-comment-alt me-1"></i>ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ (Reason/Note)</label>
                            <textarea id="dropoutNote" class="form-control rounded-3" rows="3" placeholder="ß₧öß₧ëßƒÆß₧àß₧╝ß₧¢ß₧ÿß₧╝ß₧¢ß₧áßƒüß₧Åß₧╗ß₧ôßƒâß₧Çß₧╢ß₧Üß₧êß₧ößƒï..."></textarea>
                        </div>
                    </div>
                `,
                icon: 'info',
                ...
                confirmButtonColor: '#dc3545',
                cancelButtonColor: '#6c757d',
                confirmButtonText: '<i class="fi fi-rr-check-circle me-2"></i>ß₧Öß₧¢ßƒïß₧ûßƒÆß₧Üß₧ÿß₧ößƒäßƒçß₧öß₧äßƒï',
                cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï (Cancel)',
                customClass: { popup: 'rounded-4' },
                preConfirm: () => {
...
function processDropoutAction(key, s, data) {
    ...
    studentsRef.child(key).update(updates).then(() => {
        ...
        Swal.fire({
            icon: 'success',
            title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö',
            text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Çßƒåß₧Äß₧Åßƒïß₧çß₧╢ß₧ößƒäßƒçß₧öß₧äßƒïß₧Çß₧╢ß₧Üß₧ƒß₧╖ß₧ÇßƒÆß₧ƒß₧╢!',
            timer: 2000,
            showConfirmButton: false,
            customClass: { popup: 'rounded-4' }
        });
...
window.markAsPaidOff = (key) => {
    ...
    if (!s) return showAlert("ß₧Üß₧Çß₧ÿß₧╖ß₧ôß₧âß₧╛ß₧ëß₧æß₧╖ß₧ôßƒÆß₧ôß₧ôßƒÉß₧Öß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ", "danger");

    Swal.fire({
        title: 'ß₧öß₧ëßƒÆß₧çß₧╢ß₧Çßƒïß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï?',
        text: `ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧çß₧╢ß₧àß₧äßƒïß₧Çßƒåß₧Äß₧Åßƒïß₧ƒß₧╖ß₧ƒßƒÆß₧ƒ ${s.lastName || ''} ${s.firstName || ''} ß₧Éß₧╢ß₧öß₧╢ß₧ô "ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï" ß₧ÿßƒéß₧ôß₧æßƒü? ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ôß₧╣ß₧äß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧ößƒÆß₧Åß₧╝ß₧Üß₧æßƒàß₧Çß₧╢ß₧ôßƒïß₧öß₧ëßƒÆß₧çß₧╕ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïßƒö`,
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#198754',
        cancelButtonColor: '#6c757d',
        confirmButtonText: 'ß₧öß₧╢ß₧æ/ß₧àß₧╢ß₧ƒ ß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒï',
        cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
        customClass: { popup: 'rounded-4' }
    }).then((result) => {
        if (result.isConfirmed) {
            ...
            studentsRef.child(key).update(updates).then(() => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                    text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧Çßƒåß₧Äß₧Åßƒïß₧Éß₧╢ß₧öß₧╢ß₧ôß₧öß₧äßƒïß₧òßƒÆß₧Åß₧╢ß₧àßƒïß₧Üß₧╝ß₧àß₧Üß₧╢ß₧¢ßƒï!',
                    timer: 2000,
                    showConfirmButton: false,
                    customClass: { popup: 'rounded-4' }
                });
...
window.reEnrollStudent = (key) => {
    Swal.fire({
        title: 'ß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë?',
        text: "ß₧Åß₧╛ß₧óßƒÆß₧ôß₧Çß₧ößƒÆß₧Üß₧╢ß₧Çß₧èß₧æßƒüß₧Éß₧╢ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ôßƒüßƒçß₧öß₧╢ß₧ôß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#198754',
        cancelButtonColor: '#d33',
        confirmButtonText: 'ß₧öß₧╢ß₧æ/ß₧àß₧╢ß₧ƒ',
        cancelButtonText: 'ß₧ößƒäßƒçß₧öß₧äßƒï',
        ...
        if (result.isConfirmed) {
            ...
            studentsRef.child(key).update(updates).then(() => {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'ß₧çßƒäß₧éß₧çßƒÉß₧Ö',
                    text: 'ß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÅßƒÆß₧Üß₧╝ß₧£ß₧öß₧╢ß₧ôß₧èß₧╢ß₧Çßƒïß₧▒ßƒÆß₧Öß₧àß₧╝ß₧¢ß₧ÜßƒÇß₧ôß₧£ß₧╖ß₧ë!',
                    timer: 1500,
                    showConfirmButton: false,
                    customClass: { popup: 'rounded-4' }
                });
...
window.printLeaveRequest = function () {
    ...
    if (!name) {
        return showAlert('ß₧ƒß₧╝ß₧ÿß₧çßƒÆß₧Üß₧╛ß₧ƒß₧Üß₧╛ß₧ƒß₧ƒß₧╖ß₧ƒßƒÆß₧ƒß₧ÿßƒÆß₧ôß₧╢ß₧Çßƒïß₧çß₧╢ß₧ÿß₧╗ß₧ôß₧ƒß₧╖ß₧ô (Please select a student first)', 'warning');
    }

    // Format dates with Khmer month names
    const KHMER_MONTHS_NAMES = ["ß₧ÿß₧Çß₧Üß₧╢", "ß₧Çß₧╗ß₧ÿßƒÆß₧ùßƒê", "ß₧ÿß₧╕ß₧ôß₧╢", "ß₧ÿßƒüß₧ƒß₧╢", "ß₧ºß₧ƒß₧ùß₧╢", "ß₧ÿß₧╖ß₧Éß₧╗ß₧ôß₧╢", "ß₧Çß₧ÇßƒÆß₧Çß₧èß₧╢", "ß₧ƒß₧╕ß₧áß₧╢", "ß₧Çß₧ëßƒÆß₧ëß₧╢", "ß₧Åß₧╗ß₧¢ß₧╢", "ß₧£ß₧╖ß₧àßƒÆß₧åß₧╖ß₧Çß₧╢", "ß₧ÆßƒÆß₧ôß₧╝"];
    ...
    printWindow.document.write('<html><head><title>ß₧¢ß₧╖ß₧üß₧╖ß₧Åß₧ƒß₧╗ßƒåß₧àßƒÆß₧öß₧╢ß₧ößƒï - ' + name + '</title>');
